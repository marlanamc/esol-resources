...
const SEARCH_QUERIES: Record<string, string> = {
  ...
  "Construction worker": "yellow hard hat safety vest construction site daytime",
  "Office assistant": "office desk computer keyboard files organized bright",
  "Administrative assistant": "filing cabinet labeled folders office desk professional",
  "Secretary": "desk calendar notepad landline phone office typing",
  "Busser": "restaurant table clearing stacked plates dining room busy",
  "Cook": "chef hands chopping vegetables cutting board kitchen stainless",
  "Prep Cook": "commercial kitchen prep station cutting board knives ingredients",
  "Custodian": "janitor cart mop bucket commercial hallway tiles clean",
  "Housekeeper": "hotel room bed making housekeeping uniform trolley",
  "Landscaper": "riding lawn mower green suburban lawn sunny residential",
  "Salesperson": "retail clothing rack customer shopping store aisle bright",
  "Business owner": "small storefront open sign owner apron sidewalk daytime",
  ...
  "Experience": "resume work history document magnifying glass desk macro",
  "Hired": "new employee badge handshake office welcome desk bright",
  "Fired": "cardboard box desk belongings office leaving hallway sad",
  "Laid off": "factory closed sign padlock chain industrial exterior gloomy",
  "Employee": "employee id badge lanyard blank portrait office macro",
  "Paycheck": "paycheck stub paper envelope macro desk isolated",
  "Employer": "company headquarters glass building sign exterior daytime",
  "Taxes": "irs tax forms 1040 stack calculator pen desk april",
  "Vacation": "suitcase passport beach hat sunny travel flat lay",
  "Sick leave": "medical certificate doctor note sick day envelope desk",
