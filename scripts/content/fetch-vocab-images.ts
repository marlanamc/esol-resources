...
const SEARCH_QUERIES: Record<string, string> = {
  ...
  "Raise": "dollar bills money fan payment professional",
  "Break": "coffee cup table rest break workplace",
  ...
  "Resume": "paper document pen desk professional close up",
  "Application": "form paper clipboard pen desk close up",
  ...
  "Manager": "manager clipboard office team meeting professional workplace",
  ...
  "Mortgage": "home loan papers pen keys desk signing flat lay",
  ...
  "Gas": "gas stove blue flame burner kitchen cooking home",
  "Electric": "residential electric meter home exterior close up",
  "Water": "kitchen faucet water running clear simple macro",
  "Electricity": "white light switch wall standard close up macro",
  "Real Estate": "for sale sign front yard suburban house sunny day",
  "Home": "cozy living room sofa lamp warm family evening interior",
  "Condominium": "modern condo building balconies urban residential daytime",
  "Unit": "apartment door number plate hallway interior residential",
  "Fee": "invoice service fee line items envelope desk macro",
  "Security deposit": "stack cash envelope keys apartment desk first month",
  "Laundry": "laundry basket folded towels washing machine home bright",
  "Down payment": "envelope cash house keys purchase paperwork desk",
  "Leak": "water stain ceiling bucket catching drip home damage",
  "Broken Window": "cracked house window glass damage frame exterior",
  "Clogged Toilet": "plunger white toilet bathroom tile residential",
  "Complaint": "tenant complaint form clipboard pen apartment office desk",
  ...
  "Hall": "narrow home hallway interior doors hardwood floor bright",
  "Chimney": "brick chimney roof sky residential house exterior",
  "Lock": "brass door deadbolt lock keyhole close up macro",
  "Porch": "front porch wooden steps rocking chair house entrance day",
  "Driveway": "concrete driveway suburban garage two cars residential",
  "Garden": "backyard vegetable garden raised beds fence sunny",
  ...
  "End table": "small wooden side table sofa lamp living room corner",
  "Coffee table": "low wooden coffee table living room rug magazines simple",
  "Painting": "framed wall art painting living room above sofa interior",
  "Rug": "woven area rug living room floor sofa partial view interior",
  "Carpet": "neutral wall to wall carpet empty room corner texture",
  "Curtain": "window curtains sheer daylight living room fabric folds",
  "Bedtable": "wooden nightstand bedside lamp alarm clock bedroom simple",
  "Cabinet": "white kitchen wall cabinets handles bright modern empty",
  "Armchair": "single upholstered armchair living room window natural light",
  "Fireplace": "stone fireplace living room mantel logs interior cozy",
  "Homemaker": "family home cooking meal kitchen bright warm interior",
  "Mechanic": "mechanic tools wrench socket set workshop bench close up",
  "Nurse": "nurse scrubs stethoscope hospital hallway professional",
  "Dentist": "dental mirror pick tool tray close up clinic bright",
  "Painter": "paint roller paint tray wall interior room bright",
  "Plumber": "pipe wrench copper pipe fitting plumbing close up",
  "Electrician": "electrical panel circuit breaker wiring professional close up",
  "Cashier": "cashier checkout counter barcode scanner register bright store",
  "Chef": "chef knife cutting board professional kitchen stainless steel",
  "Driver": "steering wheel dashboard delivery truck cab professional",
  "Firefighter": "firefighter helmet gear bright isolated white background",
  "Police Officer": "police badge uniform professional isolated bright background",
  "Construction Worker": "yellow hard hat safety helmet isolated white studio",
  "Construction worker": "hard hat tool belt safety vest construction site bright",
  "Office assistant": "office desk computer organized files professional workspace bright",
  "Administrative assistant": "organized desk calendar binder planner professional office bright",
  "Secretary": "phone notepad desk calendar office organized professional",
  "Busser": "stacked restaurant plates tray clearing table dining room",
  "Cook": "hands chopping vegetables cutting board commercial kitchen",
  "Prep Cook": "prep station cutting board knife mise en place commercial kitchen",
  "Custodian": "mop bucket cleaning cart commercial hallway professional",
  "Housekeeper": "housekeeping cart cleaning supplies hotel hallway professional",
  "Landscaper": "lawn mower green suburban lawn sunny residential outdoor",
  "Salesperson": "retail store shelf product customer assistance professional",
  "Business owner": "small business open sign storefront window professional",
  "Farmer": "farm field tractor crop row outdoor daytime agricultural",
  "Janitor": "mop bucket cleaning supplies professional hallway",
  "Receptionist": "office front desk telephone computer professional welcoming",
  "Pharmacist": "pharmacy prescription pill bottles medicine counter professional",
  "Doctor": "stethoscope medical clipboard doctor office professional bright",
  "Waiter": "waiter serving tray isolated white background empty",
  "Baker": "rolling pin flour kitchen tools isolated flat lay macro",
  "Pay": "dollar bills hand payment cash close up",
  "Salary": "dollar bills money fan isolated white background",
  "Benefits": "health insurance document pen desk bright professional",
  "Full-time": "office worker desk computer professional daytime bright",
  "Part-time": "clock hours work schedule desk notebook",
  "Boss": "office meeting professional leadership workplace team",
  "Interview": "two people sitting across desk handshake professional office",
  "Experience": "professional resume paper pen desk bright close up",
  "Hired": "handshake office welcome professional bright desk",
  "Fired": "cardboard box office belongings desk departure",
  "Laid off": "closed sign door business exterior window",
  "Employee": "worker name badge lanyard office professional",
  "Paycheck": "envelope check payment paper desk close up",
  "Employer": "professional office building entrance bright exterior",
  "Taxes": "tax form calculator pen desk paper",
  "Vacation": "suitcase travel passport sunny bright",
  "Sick leave": "thermometer tissue medicine rest bed sick",
  ...
  "Skill": "tools workshop craft hands working professional",
  "Strength": "person lifting box moving strong workplace",
  "Teamwork": "group of people working together office table",
  "Problem-Solving": "person thinking whiteboard notes planning office",
  "Communication": "two people talking conversation office bright",
  "Leadership": "person presenting speaking group meeting professional",
  "Creative": "colorful art supplies paint brushes desk bright",
  "Flexible": "person multitasking desk laptop phone notes",
  "Organized": "clean desk planner calendar pen organized neat",
  "Dependable": "handshake agreement professional office trust",
  "Honest": "two people open conversation eye contact bright",
  "Hard-Working": "person focused working desk laptop professional",
  "Respectful": "two people greeting handshake smile professional",
  ...
  "Neck": "human neck profile close up skin collarbone natural light",
  "Feet": "bare feet standing grass park summer relaxed person",
  ...
  "Backache": "person hands lower back pain sitting chair office stretch",
  "Toothache": "person cheek hand jaw pain dental waiting room",
  "Chills": "person wrapped blanket shivering hot tea cold winter indoor",
  "Sweats": "athletic towel sweat brow gym workout water bottle macro",
  "Fatigue": "person yawning sofa couch tired afternoon living room",
  "Dizziness": "person sitting bench head hand dizzy blurred motion",
  "Itch": "mosquito bite arm skin scratch close up outdoor summer",
  "Rash": "skin irritation red patch forearm medical close up",
  "Swelling": "ankle foot swollen ice pack elevation couch injury",
  "Nausea": "person holding stomach nauseated bathroom sink morning sick",
  "Stress": "overwhelmed person hands head desk papers laptop office",
  ...
  "Food": "balanced dinner plate vegetables protein grain fork wooden table",
  "Habits": "daily habit tracker habit paper checkmark list isolated desk",
};

/** Lowercase term → query; first key in `SEARCH_QUERIES` wins on collisions. Exact `SEARCH_QUERIES[term]` is always checked first in `buildSearchQuery`. */
const SEARCH_QUERIES_LOWER = new Map<string, string>();
for (const [key, value] of Object.entries(SEARCH_QUERIES)) {
  const lower = key.toLowerCase();
  if (!SEARCH_QUERIES_LOWER.has(lower)) SEARCH_QUERIES_LOWER.set(lower, value);
}
...
export function buildSearchQuery(term: string, category: string): string | null {
  ...
  const explicit = SEARCH_QUERIES[term] ?? SEARCH_QUERIES_LOWER.get(term.toLowerCase());
