...
export const TIMELINE_CONTEXT_QUESTIONS: ContextTenseQuestion[] = [
  ...
  },
  {
    id: "ctx-perf-02",
    type: "context-tense-picker",
    scenario: "The meeting ___ (finish) by the time I arrived. Everyone was gone.",
    blankVerb: "finish",
    realLifeDialogue: {
      lineA: 'A: "Did you make it to the meeting?"',
      lineB: 'B: "No — it had already finished by the time I got there."',
    },
    options: [
      {
        tenseName: "Past Simple",
        conjugatedVerb: "finished",
        elements: buildCanonicalTimelineElements("pastSimple", "ctx-perf-02-a", [{ position: 40 }]),
        isCorrect: false,
      },
      {
        tenseName: "Present Perfect",
        conjugatedVerb: "has finished",
        elements: buildCanonicalTimelineElements("presentPerfect", "ctx-perf-02-b"),
        isCorrect: false,
      },
      {
        tenseName: "Past Perfect",
        conjugatedVerb: "had finished",
        elements: buildCanonicalTimelineElements("pastPerfect", "ctx-perf-02-c", [{ position: 35 }, { position: 55 }]),
        isCorrect: true,
      },
    ],
    contextClues: ["by the time I arrived", "Everyone was gone"],
    explanation:
      '"By the time I arrived" sets a past reference point. The meeting ending happened before that arrival — Past Perfect marks the earlier of two past events. "Finished" (Past Simple) blurs the order; "has finished" connects to the present instead.',
    difficulty: 2,
    tenseCategory: "perfect",
  },
  // ============================================================
  ...
  // ============================================================
  {
    id: "ctx-ppc-01",
    type: "context-tense-picker",
    scenario: "She looks exhausted! How long ___ (study) for this exam?",
    blankVerb: "study",
    realLifeDialogue: {
      lineA: 'A: "How long has she been studying?"',
      lineB: 'B: "Since seven this morning — she can\'t stop now."',
    },
    options: [
      {
        tenseName: "Present Continuous",
        conjugatedVerb: "is she studying",
        elements: buildCanonicalTimelineElements("presentContinuous", "ctx-ppc-01-a"),
        isCorrect: false,
      },
      {
        tenseName: "Present Perfect Continuous",
        conjugatedVerb: "has she been studying",
        elements: buildCanonicalTimelineElements("presentPerfectContinuous", "ctx-ppc-01-b", [{ position: 50 }]),
        isCorrect: true,
      },
      {
        tenseName: "Past Simple",
        conjugatedVerb: "did she study",
        elements: buildCanonicalTimelineElements("pastSimple", "ctx-ppc-01-c", [{ position: 40 }]),
        isCorrect: false,
      },
    ],
    contextClues: ["How long", "She looks exhausted"],
    explanation:
