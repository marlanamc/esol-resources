...
export const GROUP_0A: GerundInfinitiveGroup = {
  ...
  pattern: 'A GERUND is a verb + -ing used as a NOUN. It names an activity or action. Examples: Swimming is fun. I love cooking. Thanks for helping.',
...
export const GROUP_0B: GerundInfinitiveGroup = {
  ...
  pattern: 'An INFINITIVE is "to + verb" (to go, to eat, to learn). It often shows PURPOSE or FUTURE intention. Examples: I want to learn. It\'s easy to understand.',
...
export const GROUP_1: GerundInfinitiveGroup = {
  ...
  pattern: 'After a preposition (in, at, for, about, of, without, before, after), ALWAYS use the gerund (-ing form)',
...
export const GROUP_1B: GerundInfinitiveGroup = {
  ...
  pattern: 'Adjectives pair with FIXED prepositions. No rule—memorize the phrase! afraid of, worried about, proud of, responsible for, interested in, good at',
...
export const GROUP_1D: GerundInfinitiveGroup = {
  ...
  pattern: 'Now put it all together! Choose the correct PREPOSITION and the correct VERB FORM. Remember: after prepositions, always use the gerund (-ing form).',
  patternExample: 'interested in learning',
...
export const GROUP_5: GerundInfinitiveGroup = {
  ...
  pattern: 'When a verb is the SUBJECT of a sentence, use the gerund (-ing form). The gerund acts like a noun.',
  patternExample: 'Swimming is fun',
  colorClass: 'bg-purple-100 border-purple-300 text-purple-900',
  difficulty: 1,
