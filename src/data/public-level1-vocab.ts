...
const RAW_LEVEL1_UNITS: RawUnit[] = [
  ...
  },
  {
    ...
    categories: [
      ...
      { label: "Classroom", terms: [
        ...
        { term: "Chair", englishDefinition: "A seat you sit on in class.", spanishDefinition: "Un asiento separado para una persona, típicamente con un respaldo y cuatro patas.", example: "There are twenty chairs in the classroom for the students.", fillBlankSentence: "Please sit in your _____ and open your book." },
        ...
        { term: "Partner", englishDefinition: "A student you work with in class.", spanishDefinition: "Una persona que participa en una tarea con otra.", example: "Please work with a partner to practice the conversation on page five.", fillBlankSentence: "Work with a _____ to practice the dialogue." },
        { term: "Group", englishDefinition: "A team of students working together in class.", spanishDefinition: "Un número de personas o cosas que se encuentran cerca unas de otras o se consideran una unidad.", example: "We finished our project quickly because we worked well as a group.", fillBlankSentence: "Please work in a _____ of three people." },
      ] },
  ...
  },
  {
    ...
    categories: [
      ...
      { label: "Community Places", terms: ["Doctor's office", "Dentist's office", { term: "Hospital", isConcrete: true }, { term: "Hotel", isConcrete: true }, { term: "House", isConcrete: true }, { term: "Park", isConcrete: true }, { term: "Playground", isConcrete: true }, { term: "Supermarket", isConcrete: true }, { term: "Bank", isConcrete: true }, { term: "Library", isConcrete: true }, { term: "Post Office", isConcrete: true }, { term: "Fire Department", englishDefinition: "A building where firefighters work to stop fires in the community.", isConcrete: true }, { term: "Police Station", isConcrete: true }, "RMV", { term: "Bus Stop", isConcrete: true }, "Station", { term: "Public Transportation", englishDefinition: "Buses and trains you ride to go to different places in the community." }, "City Hall", "Clinic", { term: "School", isConcrete: true }, { term: "Museum", isConcrete: true }, { term: "Restaurant", isConcrete: true }, { term: "Store", isConcrete: true }, { term: "Pharmacy", isConcrete: true }, { term: "Gym", isConcrete: true }, { term: "Airport", isConcrete: true }, { term: "Laundromat", isConcrete: true }] },
  ...
  },
  {
    ...
    categories: [
      { label: "Housing & Rental", terms: [
        ...
        "Broken Window",
        "Clogged Toilet",
        { term: "Complaint", englishDefinition: "A message or letter about a problem in your apartment or house." },
        "House",
        "Home",
        "Apartment",
        "Condominium",
        ...
        { term: "Security deposit", englishDefinition: "Money you pay before moving into a new apartment or house." },
        { term: "Laundry", englishDefinition: "Dirty or clean clothes you wash in your house or apartment." },
        "Mortgage",
      ...
      { label: "Domestic Things", terms: [
        ...
        "Light",
        { term: "Painting", englishDefinition: "A picture made with paint to hang on a wall in your house." },
        "Rug",
        "Carpet",
        ...
        "Closet",
        { term: "Bedtable", englishDefinition: "A small table next to your bed in the bedroom." },
        { term: "Car", englishDefinition: "A machine with four wheels that you park at your house." },
        { term: "Chair", englishDefinition: "A piece of furniture you sit on in your house.", isConcrete: true },
        ...
        { term: "Oven", englishDefinition: "A hot space inside a stove used to cook food in the kitchen.", isConcrete: true },
        "Counter",
        "Cabinet",
        ...
        { term: "TV", englishDefinition: "An electronic screen to watch shows and movies in your living room.", isConcrete: true },
        "Fireplace",
  ...
  },
  {
    ...
    categories: [
      ...
      { label: "Exercise", terms: ["Muscles", { term: "Weight", englishDefinition: "Heavy objects you lift during exercise to build strength." }, "Heart"] },
    ],
  },
  {
    slug: "unit-9",
    ...
    categories: [
      ...
      { label: "Grains & Breakfast", terms: ["Cereal", { term: "Bread", isConcrete: true }, "Toast", "Nuts", { term: "Walnuts", englishDefinition: "wrinkled brown nuts with a hard shell, eaten as a snack or in baking" }, { term: "Peanuts", englishDefinition: "Small seeds you eat as a snack or in peanut butter." }, { term: "Almonds", englishDefinition: "long light-brown nuts people eat" }] },
      ...
      { label: "Prepared Foods", terms: [
        ...
        { term: "Hamburger", englishDefinition: "A round bun filled with meat and vegetables that you eat." },
      ...
      { label: "Containers", terms: [
        ...
        { term: "Bag", englishDefinition: "A paper or plastic container to carry food from the store." },
        { term: "Box", englishDefinition: "A stiff cardboard container used to hold or pack food." },
        { term: "Package", englishDefinition: "A box or bag that has food or products inside." }
      ] },
