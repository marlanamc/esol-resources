  ...
  },
  {
    ...
    categories: [
      { label: "Days and Months", terms: [
        ...
        { term: "September", englishDefinition: "the ninth month of the year, after August and before October", spanishDefinition: "El noveno mes del año, cuando comienzan muchas escuelas.", example: "The fall season begins in September.", fillBlankSentence: "School starts in _____ in the United States." },
