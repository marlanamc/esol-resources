...
const RAW_LEVEL1_UNITS: RawUnit[] = [
  {
    ...
    categories: [
      { label: "Personal Information", terms: [
        ...
        { term: "City", englishDefinition: "a large urban area with its own government, businesses, and neighborhoods", spanishDefinition: "ciudad", example: "I live in the city of Boston.", fillBlankSentence: "I live in the _____ of Boston." },
        ...
        { term: "Address", englishDefinition: "the specific street, city, and state where you live or get mail", spanishDefinition: "dirección", example: "Please write your address on the form.", fillBlankSentence: "My _____ is 45 Oak Street, Apartment 2." },
        { term: "Street", englishDefinition: "a named road in a city or town, often with buildings on each side", spanishDefinition: "calle", example: "Our apartment is on Main Street.", fillBlankSentence: "My apartment is on Oak _____." },
        ...
        { term: "State", englishDefinition: "a large area within a country with its own government, like Texas or California", spanishDefinition: "estado", example: "Massachusetts is the state where I live.", fillBlankSentence: "I live in the _____ of Massachusetts." },
        ...
        { term: "Birthday", englishDefinition: "the specific date you were born, celebrated once each year", spanishDefinition: "cumpleaños", example: "My birthday is in July.", fillBlankSentence: "When is your _____?" },
        { term: "Years old", englishDefinition: "the way to say how old someone is, as in \"I am 35 years old\"", spanishDefinition: "años", example: "I am twenty-five years old.", fillBlankSentence: "I am twenty-five _____." },
        { term: "Single", englishDefinition: "a person who is not married", spanishDefinition: "soltero o soltera; no casado", example: "She is single.", fillBlankSentence: "He has never been married. He is _____." },
      ...
      { label: "Time of Day", terms: [
        { term: "Morning", englishDefinition: "the early part of the day before noon", spanishDefinition: "la mañana; la parte temprana del día antes del mediodía", example: "I study English in the morning.", fillBlankSentence: "Good _____! Did you sleep well?", isConcrete: true },
        { term: "Afternoon", englishDefinition: "the part of the day after noon and before evening", spanishDefinition: "la tarde; la parte del día después del mediodía", example: "We have class in the afternoon.", fillBlankSentence: "It is 2:00 in the _____.", isConcrete: true },
        { term: "Evening", englishDefinition: "the part of the day from about 6 p.m. until bedtime", spanishDefinition: "la tarde-noche; la parte final del día antes de dormir", example: "I cook dinner in the evening.", fillBlankSentence: "We eat dinner at 7:00 in the _____.", isConcrete: true },
        { term: "Night", englishDefinition: "the time after sunset and before sunrise, when it is dark outside", spanishDefinition: "la noche; la parte oscura del día", example: "The children sleep at night.", fillBlankSentence: "Good _____! See you tomorrow.", isConcrete: true },
      ] },
      { label: "People", terms: [
        { term: "Man", englishDefinition: "an adult male person", spanishDefinition: "un hombre; una persona adulta de sexo masculino", example: "The man is my teacher.", fillBlankSentence: "That _____ over there is my teacher.", isConcrete: true },
        { term: "Men", englishDefinition: "more than one adult male person", spanishDefinition: "hombres; más de un hombre", example: "The men are waiting outside.", fillBlankSentence: "The _____ in this class are from Mexico.", isConcrete: true },
        { term: "Woman", englishDefinition: "an adult female person", spanishDefinition: "una mujer; una persona adulta de sexo femenino", example: "The woman is my neighbor.", fillBlankSentence: "That _____ at the front desk is my neighbor.", isConcrete: true },
        { term: "Women", englishDefinition: "more than one adult female person", spanishDefinition: "mujeres; más de una mujer", example: "The women are in the office.", fillBlankSentence: "The _____ are discussing the project.", isConcrete: true },
      ] },
      { label: "Pronouns", terms: [
        ...
        { term: "He", englishDefinition: "used to refer to one male person already mentioned or known", spanishDefinition: "él; la palabra que se usa para un hombre o niño", example: "He is my brother.", fillBlankSentence: "Carlos is my friend. _____ is from Mexico." },
        { term: "She", englishDefinition: "used to refer to one female person already mentioned or known", spanishDefinition: "ella; la palabra que se usa para una mujer o niña", example: "She is my friend.", fillBlankSentence: "Maria is my teacher. _____ is very kind." },
        { term: "It", englishDefinition: "used to replace the name of one thing or animal already mentioned", spanishDefinition: "eso o ello; la palabra que se usa para una cosa, animal o idea", example: "It is my book.", fillBlankSentence: "_____ is a nice day today." },
        ...
        { term: "They", englishDefinition: "used to refer to a group of people or things not including the speaker", spanishDefinition: "ellos o ellas; la palabra para otras personas o cosas", example: "They are my classmates.", fillBlankSentence: "The students finished early. _____ went home." },
      ] },
      ...
      { label: "Numbers", terms: [
        { term: "One", englishDefinition: "the number 1", spanishDefinition: "uno; el número 1", example: "I have one pencil.", fillBlankSentence: "There is _____ person in the office.", isConcrete: true },
        { term: "Two", englishDefinition: "the number 2", spanishDefinition: "dos; el número 2", example: "She has two children.", fillBlankSentence: "I have a left hand and a right hand. That is _____ hands.", isConcrete: true },
        { term: "Three", englishDefinition: "the number 3", spanishDefinition: "tres; el número 3", example: "We need three chairs.", fillBlankSentence: "Red, yellow, and blue. That is _____ colors.", isConcrete: true },
        { term: "Four", englishDefinition: "the number 4", spanishDefinition: "cuatro; el número 4", example: "There are four books on the desk.", fillBlankSentence: "A car has _____ wheels.", isConcrete: true },
        { term: "Five", englishDefinition: "the number 5", spanishDefinition: "cinco; el número 5", example: "Class starts in five minutes.", fillBlankSentence: "I have _____ fingers on one hand.", isConcrete: true },
        { term: "Six", englishDefinition: "the number 6", spanishDefinition: "seis; el número 6", example: "I work six days a week.", fillBlankSentence: "I work Monday to Saturday. That is _____ days.", isConcrete: true },
        { term: "Seven", englishDefinition: "the number 7", spanishDefinition: "siete; el número 7", example: "My son is seven years old.", fillBlankSentence: "There are _____ days in a week.", isConcrete: true },
        { term: "Eight", englishDefinition: "the number 8", spanishDefinition: "ocho; el número 8", example: "There are eight students here.", fillBlankSentence: "A spider has _____ legs.", isConcrete: true },
        { term: "Nine", englishDefinition: "the number 9", spanishDefinition: "nueve; el número 9", example: "The bus comes at nine.", fillBlankSentence: "A woman is pregnant for _____ months.", isConcrete: true },
        { term: "Ten", englishDefinition: "the number 10", spanishDefinition: "diez; el número 10", example: "I have ten dollars.", fillBlankSentence: "I have _____ fingers on both hands.", isConcrete: true },
      ] },
      { label: "Classroom", terms: [
        ...
        { term: "Workbook", englishDefinition: "a practice book with exercises and questions", spanishDefinition: "cuaderno de ejercicios; libro con práctica y preguntas", example: "Finish page five in the workbook.", fillBlankSentence: "Complete the exercises in the _____.", isConcrete: true },
        { term: "Board", englishDefinition: "a large flat surface on the classroom wall where the teacher writes for students to see", spanishDefinition: "pizarra o tablero; la superficie grande donde escribe el maestro", example: "The answer is on the board.", fillBlankSentence: "The teacher writes on the _____ with a marker.", isConcrete: true },
      ] },
      { label: "Other", terms: [
        { term: "Food", englishDefinition: "any solid or liquid people eat to get energy and nutrition", spanishDefinition: "comida; cosas que la gente come", example: "My favorite food is rice.", fillBlankSentence: "Pizza is my favorite _____." },
        { term: "Favorite", englishDefinition: "the one you like best", spanishDefinition: "favorito o favorita; lo que más te gusta", example: "Blue is my favorite color.", fillBlankSentence: "What is your _____ sport?" },
        { term: "Old", englishDefinition: "having existed for a long time; not new or recent", spanishDefinition: "viejo o mayor; con muchos años o no nuevo", example: "My grandfather is old.", fillBlankSentence: "This car is 20 years _____." },
      ] },
    ],
  },
  {
    ...
    categories: [
      { label: "Days and Months", terms: [
        { term: "Sunday", englishDefinition: "the first day of the week, between Saturday and Monday", spanishDefinition: "El primer día de la semana, a menudo un día de descanso o tiempo en familia.", example: "On Sunday, I go grocery shopping for the whole week.", fillBlankSentence: "The first day of the week is _____." },
        { term: "Monday", englishDefinition: "the second day of the week, the first day of the work week", spanishDefinition: "El segundo día de la semana y el comienzo de la semana laboral tradicional.", example: "I start my work shift early every Monday morning.", fillBlankSentence: "School starts again on _____ after the weekend." },
        { term: "Tuesday", englishDefinition: "the third day of the week, between Monday and Wednesday", spanishDefinition: "El tercer día de la semana, siguiendo al lunes.", example: "Our English class meets every Tuesday evening.", fillBlankSentence: "_____ is the day after Monday." },
        { term: "Wednesday", englishDefinition: "the fourth day of the week, between Tuesday and Thursday", spanishDefinition: "El cuarto día de la semana, a menudo llamado el medio de la semana.", example: "I have a meeting with my supervisor on Wednesday.", fillBlankSentence: "_____ is in the middle of the work week." },
        { term: "Thursday", englishDefinition: "the fifth day of the week, between Wednesday and Friday", spanishDefinition: "El quinto día de la semana, que ocurre entre el miércoles y el viernes.", example: "The trash is collected on Thursday mornings.", fillBlankSentence: "_____ comes right before Friday." },
        { term: "Friday", englishDefinition: "the sixth day of the week, between Thursday and Saturday", spanishDefinition: "El sexto día de la semana, a menudo el último día de trabajo para muchas personas.", example: "I usually get my paycheck on Friday afternoon.", fillBlankSentence: "The last work day of the week is _____." },
        { term: "Saturday", englishDefinition: "the seventh day of the week, between Friday and Sunday", spanishDefinition: "El séptimo día de la semana y parte del fin de semana.", example: "On Saturday, I take my children to the park.", fillBlankSentence: "_____ and Sunday make up the weekend." },
        { term: "January", englishDefinition: "the first month of the year, after December and before February", spanishDefinition: "El primer mes del año, que comienza el día de Año Nuevo.", example: "The weather is very cold in Massachusetts in January.", fillBlankSentence: "The new year begins in _____." },
        { term: "February", englishDefinition: "the second month of the year, after January and before March", spanishDefinition: "El segundo mes del año, conocido por ser el mes más corto.", example: "Valentine's Day is a holiday in February.", fillBlankSentence: "_____ is the shortest month of the year." },
        { term: "March", englishDefinition: "the third month of the year, between February and April", spanishDefinition: "El tercer mes del año, cuando comienza la temporada de primavera.", example: "The weather starts to get warmer in March.", fillBlankSentence: "Spring begins in _____." },
        { term: "April", englishDefinition: "the fourth month of the year, between March and May", spanishDefinition: "El cuarto mes del año, a menudo asociado con la lluvia y los impuestos.", example: "Federal income taxes are due in April.", fillBlankSentence: "Tax forms are due in _____." },
        { term: "May", englishDefinition: "the fifth month of the year, between April and June", spanishDefinition: "El quinto mes del año, conocido por muchas flores y el Día de la Madre.", example: "We celebrate Mother's Day on the second Sunday of May.", fillBlankSentence: "Mother's Day is celebrated in _____." },
        { term: "June", englishDefinition: "the sixth month of the year, after May and before July", spanishDefinition: "El sexto mes del año, cuando comienza la temporada de verano.", example: "Many students graduate from school in June.", fillBlankSentence: "Summer begins in the month of _____." },
        { term: "July", englishDefinition: "the seventh month of the year, between June and August", spanishDefinition: "El séptimo mes del año, cuando se celebra el Día de la Independencia.", example: "Independence Day is on July 4th in the United States.", fillBlankSentence: "Independence Day is on the 4th of _____." },
        { term: "August", englishDefinition: "the eighth month of the year, after July and before September", spanishDefinition: "El octavo mes del año y el último mes completo de verano.", example: "Many families go on vacation in August.", fillBlankSentence: "_____ is the last full month of summer." },
        { term: "September", englishDefinition: "the ninth month of the year, after August and before October", spanishDefinition: "El noveno mes del año, cuando comienzan muchas escuelas.", example: "School starts in September in Boston.", fillBlankSentence: "School starts in _____ in Boston." },
        { term: "October", englishDefinition: "the tenth month of the year, after September and before November", spanishDefinition: "El décimo mes del año, conocido por los colores de otoño y Halloween.", example: "The leaves change color in October.", fillBlankSentence: "Halloween is celebrated in the month of _____." },
        { term: "November", englishDefinition: "the eleventh month of the year, between October and December", spanishDefinition: "El undécimo mes del año, cuando se celebra el Día de Acción de Gracias.", example: "We eat a large dinner on Thanksgiving in November.", fillBlankSentence: "Thanksgiving is in _____." },
        { term: "December", englishDefinition: "the twelfth and last month of the year, after November", spanishDefinition: "El duodécimo y último mes del año, cuando comienza el invierno.", example: "December is the month when we celebrate Christmas.", fillBlankSentence: "The year ends in the month of _____." },
        ...
        { term: "Month", englishDefinition: "One of the twelve named divisions of a year, lasting 28–31 days.", spanishDefinition: "Un período de unas cuatro semanas; hay doce meses en un año.", example: "Rent is due on the first day of every month.", fillBlankSentence: "February is the shortest _____ of the year." },
        ...
        { term: "Next", englishDefinition: "immediately following this one in order or time", spanishDefinition: "Viniendo inmediatamente después de este tiempo o evento.", example: "We will visit our family next month.", fillBlankSentence: "We will have a test _____ Monday." },
      ] },
      { label: "Routines", terms: [
        { term: "Time", englishDefinition: "the system of measuring days, hours, and minutes; when something happens", spanishDefinition: "La medida de horas y minutos; se usa para saber cuándo sucede algo.", example: "It is important to be on time for your work shift.", fillBlankSentence: "What _____ does the bus come?" },
        { term: "Schedule", englishDefinition: "A list showing when events, tasks, or appointments will happen.", spanishDefinition: "Un plan que muestra cuándo sucederán las actividades o los turnos de trabajo.", example: "My work schedule changes every two weeks.", fillBlankSentence: "My work _____ changes every two weeks." },
        { term: "Calendar", englishDefinition: "A chart or book used to track days, weeks, and months of the year.", spanishDefinition: "Una tabla o libro utilizado para realizar un seguimiento de los días, semanas y meses del año.", example: "I marked the parent-teacher meeting on my calendar.", fillBlankSentence: "I wrote the appointment on my _____.", isConcrete: true },
        { term: "Appointment", englishDefinition: "A set time to meet someone, such as a doctor, dentist, or office.", spanishDefinition: "Un arreglo formal para reunirse con alguien a una hora específica, como un médico o abogado.", example: "I have a medical appointment for my daughter at 3:00 PM.", fillBlankSentence: "I need to make an _____ with my doctor." },
        { term: "Half", englishDefinition: "One of two equal parts of something; also 30 minutes of an hour.", spanishDefinition: "Una de dos partes iguales de algo; treinta minutos de una hora.", example: "The English class starts at half past six.", fillBlankSentence: "The meeting starts at _____ past nine." },
        ...
        { term: "Minute", englishDefinition: "A unit of time equal to sixty seconds; sixty minutes make one hour.", spanishDefinition: "Una unidad corta de tiempo; hay sesenta minutos en una hora.", example: "Please wait one minute while I find my identification.", fillBlankSentence: "Please wait one _____ — I am almost ready." },
        ...
        { term: "Dinner", englishDefinition: "The main meal of the day, usually eaten in the evening.", spanishDefinition: "La comida principal del día, generalmente consumida por la noche con la familia.", example: "Our family eats dinner together after I get home from work.", fillBlankSentence: "Our family eats _____ together at 7 p.m." },
        { term: "Shower", englishDefinition: "Standing under a stream of water to clean your whole body.", spanishDefinition: "Limpiar tu cuerpo con un chorro de agua.", example: "I take a shower every morning to wake up before school.", fillBlankSentence: "I take a _____ every morning before school." },
        { term: "O'clock", englishDefinition: "A word used after a number to state the exact hour, e.g., three o'clock.", spanishDefinition: "Se usa con números del uno al doce para decir la hora exacta.", example: "My work shift begins at exactly eight o'clock.", fillBlankSentence: "Class starts at eight _____." },
      ] },
      { label: "Family", terms: [
        { term: "Father", englishDefinition: "A male parent; can also be called dad or papa.", spanishDefinition: "padre", example: "My father works as a mechanic in my home country.", fillBlankSentence: "My _____ is my mother's husband.", isConcrete: true },
        { term: "Mother", englishDefinition: "A female parent; can also be called mom or mama.", spanishDefinition: "madre", example: "My mother is visiting us for two weeks next month.", fillBlankSentence: "My _____ gave birth to me and my sister.", isConcrete: true },
        { term: "Sister", englishDefinition: "A female person who has the same parents as another person.", spanishDefinition: "hermana", example: "My sister lives in New York and works at a hospital.", fillBlankSentence: "I have one brother and one _____.", isConcrete: true },
        { term: "Brother", englishDefinition: "A male person who has the same parents as another person.", spanishDefinition: "hermano", example: "My brother is looking for a new job in construction.", fillBlankSentence: "I have one sister and one _____.", isConcrete: true },
        { term: "Son", englishDefinition: "A male child of a parent.", spanishDefinition: "hijo", example: "My son is in the first grade at the local elementary school.", fillBlankSentence: "He is my _____. I am his father.", isConcrete: true },
        { term: "Daughter", englishDefinition: "A female child of a parent.", spanishDefinition: "hija", example: "My daughter wants to study nursing when she finishes high school.", fillBlankSentence: "She is my _____. I am her mother.", isConcrete: true },
        { term: "Cousin", englishDefinition: "The child of your aunt or uncle.", spanishDefinition: "primo o prima", example: "My cousin and I live in the same apartment building.", fillBlankSentence: "My _____ is my aunt's child.", isConcrete: true },
        { term: "Uncle", englishDefinition: "The brother of your mother or father, or the husband of your aunt.", spanishDefinition: "tío", example: "My uncle helped me find my first job in the United States.", fillBlankSentence: "My _____ is my mother's brother.", isConcrete: true },
        { term: "Aunt", englishDefinition: "The sister of your mother or father, or the wife of your uncle.", spanishDefinition: "tía", example: "My aunt takes care of my children while I am at work.", fillBlankSentence: "My _____ is my father's sister.", isConcrete: true },
        { term: "Niece", englishDefinition: "The daughter of your brother or sister.", spanishDefinition: "sobrina", example: "My niece is graduating from high school this June.", fillBlankSentence: "My _____ is my sister's daughter.", isConcrete: true },
        { term: "Nephew", englishDefinition: "The son of your brother or sister.", spanishDefinition: "sobrino", example: "My nephew is learning English at the community center.", fillBlankSentence: "My _____ is my brother's son.", isConcrete: true },
        { term: "Grandmother", englishDefinition: "The mother of your father or mother.", spanishDefinition: "abuela", example: "My grandmother lives with us and helps with the cooking.", fillBlankSentence: "My _____ is my mother's mother.", isConcrete: true },
        { term: "Grandfather", englishDefinition: "The father of your father or mother.", spanishDefinition: "abuelo", example: "My grandfather tells beautiful stories about his life in the mountains.", fillBlankSentence: "My _____ is my father's father.", isConcrete: true },
        { term: "Husband", englishDefinition: "A married man; the male partner in a marriage.", spanishDefinition: "esposo", example: "My husband works a late shift at the warehouse.", fillBlankSentence: "She loves her _____. They got married in 2010.", isConcrete: true },
        { term: "Wife", englishDefinition: "A married woman; the female partner in a marriage.", spanishDefinition: "esposa", example: "His wife is a teacher at the adult education center.", fillBlankSentence: "He loves his _____. They got married in 2015.", isConcrete: true },
        ...
        { term: "Child", englishDefinition: "A person who is not yet an adult; a boy or girl.", spanishDefinition: "niño o niña", example: "I have one child in elementary school and one in high school.", fillBlankSentence: "She has one _____. His name is Carlos." },
        { term: "Children", englishDefinition: "More than one child; plural of child.", spanishDefinition: "niños", example: "The children are playing in the backyard after school.", fillBlankSentence: "How many _____ do you have?" },
        ...
        { term: "Members", englishDefinition: "People who belong to a group, such as a family or club.", spanishDefinition: "miembros", example: "There are six members in our household.", fillBlankSentence: "All _____ of the family came to the party." },
        { term: "Relationship", englishDefinition: "How two people are connected, such as family, friends, or partners.", spanishDefinition: "relación", example: "It is important to have a good relationship with your supervisor at work.", fillBlankSentence: "She has a good _____ with her coworkers." },
      ] },
      { label: "Classroom", terms: [
        { term: "Paper", englishDefinition: "Thin flat sheets used for writing, drawing, or printing.", spanishDefinition: "Un material delgado producido en hojas y utilizado para escribir o dibujar.", example: "Please write your name and the date at the top of the paper.", fillBlankSentence: "Please take out a piece of _____ to write on.", isConcrete: true },
        { term: "Book", englishDefinition: "many pages bound together, used for reading or writing", spanishDefinition: "Un trabajo escrito o impreso que consiste en páginas pegadas o cosidas juntas.", example: "I like to read a book in English for twenty minutes every night.", fillBlankSentence: "I borrowed a _____ from the library to read at home.", isConcrete: true },
        { term: "Pen", englishDefinition: "A tool you hold to write using ink.", spanishDefinition: "Un instrumento para escribir o dibujar con tinta.", example: "Can I borrow a pen to sign this registration form?", fillBlankSentence: "Can I borrow your _____ to sign this form.", isConcrete: true },
        { term: "Notebook", englishDefinition: "A book with blank or ruled pages for writing notes in.", spanishDefinition: "Un libro con páginas en blanco o rayadas para escribir notas.", example: "I write new vocabulary words in my notebook during every class.", fillBlankSentence: "I write new vocabulary words in my blank _____ every day.", isConcrete: true },
        { term: "Textbook", englishDefinition: "A book students use to study a specific subject, like math or science.", spanishDefinition: "Un libro utilizado como un trabajo estándar para el estudio de un tema en particular.", example: "The English textbook has many helpful grammar exercises.", fillBlankSentence: "The English _____ we use in class has 20 chapters.", isConcrete: true },
        { term: "Workbook", englishDefinition: "A book with lessons and practice exercises for students.", spanishDefinition: "Un libro del estudiante que contiene instrucciones y ejercicios.", example: "We need to complete page ten in the workbook for homework tonight.", fillBlankSentence: "The _____ has practice exercises to complete for homework.", isConcrete: true },
        { term: "Pencil sharpener", englishDefinition: "A small tool that makes a pencil tip sharp for writing.", spanishDefinition: "Un dispositivo para afilar un lápiz afeitando su superficie de madera.", example: "My pencil is dull, so I need to use the pencil sharpener in the back of the room.", fillBlankSentence: "My pencil broke, so I used the _____.", isConcrete: true },
        { term: "Board", englishDefinition: "A large flat surface on a classroom wall for writing or drawing.", spanishDefinition: "Una superficie grande en un aula en la que el profesor escribe.", example: "The teacher wrote the homework assignment on the board.", fillBlankSentence: "The teacher wrote the new words on the _____.", isConcrete: true },
        { term: "Marker", englishDefinition: "A thick-tipped pen used to write on whiteboards or paper.", spanishDefinition: "Un bolígrafo de punta de fieltro con una punta ancha, utilizado para escribir en una pizarra blanca.", example: "The teacher used a blue marker to explain the new verb tenses.", fillBlankSentence: "She used a red _____ to write on the whiteboard.", isConcrete: true },
        { term: "Eraser", englishDefinition: "A rubber tool that removes pencil or marker marks from paper.", spanishDefinition: "Un objeto, típicamente una pieza de goma blanda, utilizada para eliminar marcas hechas por un lápiz o marcador.", example: "I made a mistake in my notebook and needed an eraser to fix it.", fillBlankSentence: "He used the _____ to remove the mistake from the board." },
        ...
        { term: "Chair", englishDefinition: "A seat with a back, for one person to sit on.", spanishDefinition: "Un asiento separado para una persona, típicamente con un respaldo y cuatro patas.", example: "There are twenty chairs in the classroom for the students.", fillBlankSentence: "Please sit in your _____ and open your book." },
        { term: "Teacher", englishDefinition: "A person whose job is to teach a subject in a school or class.", spanishDefinition: "Una persona que proporciona educación a los estudiantes.", example: "Our teacher explained the new vocabulary words clearly to everyone.", fillBlankSentence: "The _____ explains the grammar lesson every day." },
        ...
        { term: "Partner", englishDefinition: "Someone you work with on a task or activity.", spanishDefinition: "Una persona que participa en una tarea con otra.", example: "Please work with a partner to practice the conversation on page five.", fillBlankSentence: "Work with a _____ to practice the dialogue." },
        { term: "Group", englishDefinition: "Two or more people working together on a task.", spanishDefinition: "Un número de personas o cosas que se encuentran cerca unas de otras o se consideran una unidad.", example: "We finished our project quickly because we worked well as a group.", fillBlankSentence: "Please work in a _____ of three people." },
      ] },
      { label: "Descriptions (Physical)", terms: [
        { term: "Hair", englishDefinition: "The thin strands that grow on a person's head and body.", spanishDefinition: "La masa de hilos delgados que crece en la cabeza de una persona; el cabello.", example: "She has long, black hair and usually wears it in a ponytail.", fillBlankSentence: "He has short, brown _____." },
        { term: "Eyes", englishDefinition: "The two parts of your face you use to see.", spanishDefinition: "Los dos órganos de la cara que las personas usan para ver; los ojos.", example: "He has beautiful green eyes that sparkle when he smiles.", fillBlankSentence: "She has big, blue _____." },
      ] },
      { label: "Adjectives", terms: [
        { term: "Short", englishDefinition: "Not long or tall; less than average in length or height.", spanishDefinition: "Midiendo una pequeña distancia de un extremo a otro; no largo ni alto.", example: "He decided to cut his hair short for the summer.", fillBlankSentence: "He is not tall. He is _____." },
        { term: "Long", englishDefinition: "More than average in length; going far from one end to the other.", spanishDefinition: "Midiendo una gran distancia de un extremo a otro; largo.", example: "She has long hair that reaches down to her waist.", fillBlankSentence: "Her hair is not short. It is very _____." },
        { term: "Straight", englishDefinition: "Not curved or bent; going in one direction without turning.", spanishDefinition: "Moviéndose o continuando en una dirección sin curvarse ni doblarse; lacio o derecho.", example: "She has straight hair that is very easy to brush.", fillBlankSentence: "Her hair is not curly. It is _____." },
        ...
        { term: "Curly", englishDefinition: "Having tight, round loops or spirals; not straight or wavy.", spanishDefinition: "Formando o lleno de rizos; ni lacio ni ondulado.", example: "He was born with very curly hair that is hard to manage.", fillBlankSentence: "Her hair has many small curls. It is very _____." },
        ...
        { term: "Tall", englishDefinition: "Higher than average in height; used to describe people or things.", spanishDefinition: "De gran altura o superior a la media; alto.", example: "My older brother is very tall and plays basketball on weekends.", fillBlankSentence: "He is not short. He is very _____." },
        { term: "Young", englishDefinition: "Not old; at an early stage of life.", spanishDefinition: "Habiendo vivido o existido por poco tiempo; joven.", example: "The young children are learning to speak two languages.", fillBlankSentence: "The baby is very _____. She is only two months old." },
        { term: "Old", englishDefinition: "Not young; having lived or existed for many years.", spanishDefinition: "Habiendo vivido o existido por mucho tiempo; viejo o mayor.", example: "The old library building is being renovated this year.", fillBlankSentence: "She is not young. She is very _____." },
        ...
        { term: "Heavy", englishDefinition: "Weighing a lot; used to describe a person with a large body.", spanishDefinition: "De gran peso; difícil de levantar o mover; pesado.", example: "I have to lift heavy boxes at my job in the warehouse.", fillBlankSentence: "The suitcase is too _____ to carry." },
      ] },
    ],
  },
  {
    ...
    categories: [
      ...
      { label: "Community Places", terms: ["Doctor's office", "Dentist's office", { term: "Hospital", isConcrete: true }, { term: "Hotel", isConcrete: true }, { term: "House", isConcrete: true }, { term: "Park", isConcrete: true }, { term: "Playground", isConcrete: true }, { term: "Supermarket", isConcrete: true }, { term: "Bank", isConcrete: true }, { term: "Library", isConcrete: true }, { term: "Post Office", isConcrete: true }, { term: "Fire Department", englishDefinition: "The city service that sends firefighters to fight fires and emergencies.", isConcrete: true }, { term: "Police Station", isConcrete: true }, "RMV", { term: "Bus Stop", isConcrete: true }, "Station", { term: "Public Transportation", englishDefinition: "Shared vehicles like buses, trains, and subways that anyone can pay to use." }, "City Hall", "Clinic", { term: "School", isConcrete: true }, { term: "Museum", isConcrete: true }, { term: "Restaurant", isConcrete: true }, { term: "Store", isConcrete: true }, { term: "Pharmacy", isConcrete: true }, { term: "Gym", isConcrete: true }, { term: "Airport", isConcrete: true }, { term: "Laundromat", isConcrete: true }] },
  ...
  },
  {
    ...
    categories: [
      { label: "Clothing", terms: [{ term: "Shirt", isConcrete: true }, { term: "Suit", englishDefinition: "matching formal clothing people wear to work or events", isConcrete: true }, { term: "Sweater", isConcrete: true }, { term: "Cap", isConcrete: true }, { term: "Dress", isConcrete: true }, { term: "Socks", isConcrete: true }, { term: "Hat", isConcrete: true }, { term: "Shoes", isConcrete: true }, { term: "Sneakers", isConcrete: true }, { term: "Blouse", isConcrete: true }, { term: "Coat", isConcrete: true }, { term: "Skirt", isConcrete: true }, { term: "Belt", isConcrete: true }, { term: "Pants", isConcrete: true }, { term: "Shorts", isConcrete: true }] },
      { label: "Products", terms: ["Electronics", { term: "Computer", isConcrete: true }, { term: "Car", englishDefinition: "A vehicle with four wheels that people drive on roads.", isConcrete: true }, { term: "Cellphone", isConcrete: true }] },
      { label: "Shopping & Finance", terms: ["Tax", "Price", "Cash", "Credit Card", "Debit Card", "Check", "Money Order", "ATM", "Withdraw", "Deposit", "Online", "Refund", { term: "Receipt", englishDefinition: "a store paper that shows what you bought" }, { term: "Signature", englishDefinition: "Your name written by hand, used to approve a document or form." }, { term: "Return", englishDefinition: "To bring a purchased item back to the store for a refund." }, { term: "Exchange", englishDefinition: "To give back one item to a store and get a different one." }] },
  ...
  },
  {
    ...
    categories: [
      { label: "Housing & Rental", terms: [
        "Landlord",
        { term: "Manager", englishDefinition: "The person in charge of a store, office, or workplace." },
        "Agent",
        "Real Estate",
        "Tenant",
        "Leak",
        "Broken Window",
        "Clogged Toilet",
        { term: "Complaint", englishDefinition: "A statement that something is wrong or unsatisfactory." },
        "House",
        "Home",
        "Apartment",
        "Condominium",
        "Unit",
        { term: "Rent", englishDefinition: "money you pay every month to live in a home" },
        "Lease",
        { term: "Fee", englishDefinition: "Money charged for a service, such as a late payment or pet fee." },
        { term: "Security deposit", englishDefinition: "money paid before moving in, returned when you leave if no damage" },
        { term: "Laundry", englishDefinition: "clothes and linens that need washing, or that have just been washed" },
        "Mortgage",
        { term: "Down payment", englishDefinition: "a large payment you make first when buying a home or car" },
        "Utilities",
        { term: "Gas", englishDefinition: "natural gas used for heating or cooking in a home" },
        { term: "Water", englishDefinition: "the home utility that supplies running water; you pay a monthly bill" },
        "Electric",
        "Heat"
      ] },
      { label: "Parts of House", terms: [
        "Room",
        { term: "Bathroom", isConcrete: true },
        { term: "Kitchen", isConcrete: true },
        { term: "Bedroom", isConcrete: true },
        { term: "Living room", isConcrete: true },
        "Hall",
        { term: "Floor", englishDefinition: "the part of a room that you walk on" },
        "Basement",
        "Attic",
        "Roof",
        { term: "Chimney", englishDefinition: "the part of a house that carries smoke outside" },
        { term: "Door", englishDefinition: "the house part you open to go in or out", isConcrete: true },
        "Front",
        "Back",
        "Lock",
        { term: "Stairs", englishDefinition: "house steps that go up or down", isConcrete: true },
        "Porch",
        "Deck",
        { term: "Garage", isConcrete: true },
        "Driveway",
        "Yard",
        { term: "Garden", isConcrete: true }
      ] },
      { label: "Domestic Things", terms: [
        { term: "Window", englishDefinition: "a house opening with glass in the wall", isConcrete: true },
        { term: "End table", englishDefinition: "a small home table next to a sofa or chair" },
        { term: "Coffee table", englishDefinition: "a low home table in front of a sofa" },
        { term: "Plant", englishDefinition: "a living thing with roots and leaves grown indoors for decoration" },
        { term: "Lamp", englishDefinition: "a small electric light that sits on a table or floor", isConcrete: true },
        "Light",
        { term: "Painting", englishDefinition: "a picture made with paint, hung on a wall" },
        "Rug",
        "Carpet",
        { term: "Bathtub", englishDefinition: "a large container in the bathroom where you sit and wash your body" },
        "Sink",
        { term: "Toilet", isConcrete: true },
        "Curtain",
        { term: "Bed", englishDefinition: "the bedroom furniture where you sleep", isConcrete: true },
        "Closet",
        { term: "Bedtable", englishDefinition: "a small table beside a bed, used for a lamp or alarm clock" },
        { term: "Car", englishDefinition: "a four-wheeled motor vehicle used to travel on roads" },
        { term: "Chair", englishDefinition: "a seat with a back, for one person to sit on", isConcrete: true },
        { term: "Refrigerator", englishDefinition: "a kitchen machine that keeps food cold", isConcrete: true },
        { term: "Microwave", englishDefinition: "a kitchen machine that heats food quickly", isConcrete: true },
        { term: "Oven", englishDefinition: "the enclosed heated space inside a stove used to bake or roast food", isConcrete: true },
        "Counter",
        "Cabinet",
        { term: "Sofa", englishDefinition: "a soft living room seat for several people", isConcrete: true },
        { term: "Armchair", englishDefinition: "a living room chair with arms for one person" },
        { term: "TV", englishDefinition: "an electronic screen used to watch shows, news, and movies", isConcrete: true },
        "Fireplace",
        { term: "Washer", englishDefinition: "a machine that cleans clothes using water and detergent" },
        { term: "Dryer", englishDefinition: "a machine that removes water from wet clothes using heat and air" }
      ] },
  ...
  },
  {
    ...
    categories: [
      { label: "Occupations", terms: ["Homemaker", "Mechanic", "Office assistant", "Administrative assistant", "Secretary", { term: "Receptionist", englishDefinition: "a worker who welcomes people and answers phones" }, { term: "Manager", englishDefinition: "a worker who is in charge of other workers" }, { term: "Server", englishDefinition: "a restaurant worker who brings food to customers" }, "Busser", "Cook", "Prep Cook", "Chef", { term: "Dishwasher", englishDefinition: "a kitchen worker or machine that washes plates, cups, and utensils" }, "Host", "Custodian", "Cashier", "Principal", { term: "Doctor", englishDefinition: "a medical worker who treats sick people" }, "Nurse", { term: "Dentist", englishDefinition: "a medical professional who examines, cleans, and repairs teeth" }, "Teacher", "Painter", "Plumber", "Electrician", "Construction worker", "Housekeeper", "Driver", "Landscaper", { term: "Salesperson", englishDefinition: "a worker who helps customers choose and buy products" }, "Business owner"] },
      { label: "Workforce Terminology", terms: ["Pay", "Salary", "Benefits", "Full-time", "Part-time", "Title", "Experience", "Break", "Hired", "Fired", "Laid off", { term: "Job", englishDefinition: "work you do to earn money" }, "Employee", "Paycheck", "Uniform", "Boss", "Interview", "Employer", "Taxes", "Application", { term: "Schedule", englishDefinition: "a plan listing when events, tasks, or shifts happen" }, "Vacation", "Sick leave", "Insurance", "Resume", "Raise"] },
  ...
  },
  {
    ...
    categories: [
      { label: "Body Parts", terms: [{ term: "Head", isConcrete: true }, { term: "Arms", isConcrete: true }, "Chest", { term: "Hands", isConcrete: true }, { term: "Stomach", isConcrete: true }, { term: "Back", englishDefinition: "the body part behind your chest and stomach", isConcrete: true }, { term: "Fingers", isConcrete: true }, { term: "Legs", isConcrete: true }, { term: "Foot", isConcrete: true }, { term: "Feet", isConcrete: true }, { term: "Toes", englishDefinition: "the small body parts on your feet", isConcrete: true }, { term: "Neck", isConcrete: true }, { term: "Eyes", englishDefinition: "the body parts you use to see", isConcrete: true }, { term: "Ears", isConcrete: true }, { term: "Mouth", englishDefinition: "the body opening you use to eat and speak", isConcrete: true }, { term: "Nose", isConcrete: true }, { term: "Tooth", isConcrete: true }, { term: "Teeth", englishDefinition: "the hard white parts in your mouth", isConcrete: true }, { term: "Throat", englishDefinition: "the tube inside your neck that carries food and air" }] },
      { label: "Symptoms", terms: ["Pain", "Cut", { term: "Dry cough", englishDefinition: "a cough with no phlegm or liquid; your throat feels scratchy" }, "Fever", "Headache", "Runny nose", "Sore Throat", "Sneezing", "Backache", "Toothache", "Chills", "Sweats", "Fatigue", "Dizziness", "Itch", "Rash", "Swelling", "Nausea", "Stress"] },
      ...
      { label: "Other Medical", terms: [{ term: "Appointment", englishDefinition: "a scheduled time to meet someone, such as a doctor or employer" }, "Checkup", { term: "Insurance", englishDefinition: "a plan you pay into that covers medical, car, or other costs" }, "Physical", "Surgery"] },
      { label: "Exercise", terms: ["Muscles", { term: "Weight", englishDefinition: "how heavy a person or thing is, measured in pounds or kilograms" }, "Heart"] },
    ],
  },
  {
    slug: "unit-9",
    ...
    categories: [
      ...
      { label: "Grains & Breakfast", terms: ["Cereal", { term: "Bread", isConcrete: true }, "Toast", "Nuts", { term: "Walnuts", englishDefinition: "wrinkled brown nuts with a hard shell, eaten as a snack or in baking" }, { term: "Peanuts", englishDefinition: "small tan nuts that grow underground; used in peanut butter" }, { term: "Almonds", englishDefinition: "long light-brown nuts people eat" }] },
      ...
      { label: "Meats & Proteins", terms: [{ term: "Chicken", isConcrete: true }, { term: "Beef", isConcrete: true }, "Pork", "Turkey", { term: "Fish", isConcrete: true }, { term: "Tuna", englishDefinition: "a large ocean fish, often sold canned and used in sandwiches or salads" }] },
      { label: "Staples", terms: [{ term: "Rice", isConcrete: true }, { term: "Beans", isConcrete: true }, { term: "Soup", isConcrete: true }] },
      { label: "Vegetables", terms: [
        { term: "Tomatoes", englishDefinition: "round red fruit with soft flesh, used raw in salads or cooked in sauces", isConcrete: true },
        { term: "Carrots", englishDefinition: "long, firm orange vegetables that grow underground", isConcrete: true },
        { term: "Avocados", englishDefinition: "soft green fruit often used in salads or guacamole" },
        { term: "Broccoli", englishDefinition: "a dark green vegetable with a thick stalk and tightly packed flower tops" },
        { term: "Cucumber", englishDefinition: "a long green vegetable with a lot of water" },
        { term: "Corn", englishDefinition: "a tall plant that produces large ears of yellow kernels eaten as a vegetable", isConcrete: true },
        { term: "Celery", englishDefinition: "a long green vegetable with crisp sticks" },
        { term: "Lettuce", englishDefinition: "a leafy green vegetable used in salads" },
        { term: "Spinach", englishDefinition: "small dark green leaves eaten raw in salads or cooked as a side dish" },
        { term: "Salad", englishDefinition: "a cold dish of raw vegetables, often with dressing" },
      ] },
      { label: "Condiments & Seasoning", terms: ["Oil", "Salt", "Pepper", "Garlic", { term: "Ketchup", englishDefinition: "a thick red sauce made from tomatoes, used on burgers and fries" }, "Mustard", "Jam", "Jelly", "Peanut butter"] },
      { label: "Fruits", terms: [
        { term: "Apples", englishDefinition: "round fruits with red, green, or yellow skin", isConcrete: true },
        { term: "Oranges", englishDefinition: "round orange fruits full of juice", isConcrete: true },
        { term: "Bananas", englishDefinition: "long curved yellow fruits with a soft, sweet inside", isConcrete: true },
        { term: "Pears", englishDefinition: "sweet fruits with a narrow top and round bottom", isConcrete: true },
        { term: "Watermelon", englishDefinition: "a large round fruit with green skin and sweet red flesh inside", isConcrete: true },
        { term: "Melon", englishDefinition: "a large round fruit with sweet soft flesh and a hard green or orange skin" },
        { term: "Strawberry", englishDefinition: "a small red fruit with seeds on the outside" },
        { term: "Pineapple", englishDefinition: "a large tropical fruit with spiky brown skin and sweet yellow flesh inside", isConcrete: true },
        { term: "Blueberry", englishDefinition: "a small round blue fruit" },
      ] },
      { label: "Prepared Foods", terms: [
        { term: "French Fries", englishDefinition: "fried potato pieces people eat hot" },
        { term: "Hamburger", englishDefinition: "a round bun filled with a cooked ground beef patty" },
        { term: "Pasta", englishDefinition: "an Italian food made from flour and water, shaped into noodles or tubes" },
        { term: "Sandwich", englishDefinition: "food with meat, cheese, or other food between bread" },
        { term: "Crackers", englishDefinition: "thin, flat, crispy baked snacks made from flour" },
      ] },
      ...
      { label: "Drinks", terms: [
        { term: "Bottled water", englishDefinition: "water sold in a bottle" },
        { term: "Juice", englishDefinition: "a drink made by pressing liquid from fruit or vegetables", isConcrete: true },
        { term: "Soda", englishDefinition: "a sweet cold drink with bubbles" },
      ] },
      { label: "Containers", terms: [
        { term: "Can", englishDefinition: "a metal container for food or drink" },
        { term: "Jar", englishDefinition: "a glass food container with a lid" },
        { term: "Bag", englishDefinition: "a flexible container made of plastic, paper, or cloth for carrying or storing things" },
        { term: "Box", englishDefinition: "a stiff rectangular container made from cardboard or wood" },
        { term: "Package", englishDefinition: "a sealed bag, box, or wrapper containing a product for sale" }
      ] },
...
"In": { en: "inside something or in a place" },
...
"Rug": { en: "a thick fabric mat placed on a floor" },
...
const CURATED_FILL_BLANK_SENTENCES: Record<string, string> = {
  ...
  "September": "School starts in _____ in Boston.",
