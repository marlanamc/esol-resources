...
const RAW_LEVEL1_UNITS: RawUnit[] = [
  {
    ...
    categories: [
      ...
      { label: "Classroom", terms: [
        { term: "Paper", englishDefinition: "thin material used for writing or printing", spanishDefinition: "papel; material delgado que se usa para escribir o imprimir", example: "Write your answer on the paper.", fillBlankSentence: "Please give me a piece of _____.", isConcrete: true },
        { term: "Book", englishDefinition: "something with pages that you read", spanishDefinition: "un libro; algo con páginas que lees", example: "Open your book to page three.", fillBlankSentence: "I borrowed a _____ from the library to read at home.", isConcrete: true },
        { term: "Pen", englishDefinition: "a tool used for writing with ink", spanishDefinition: "bolígrafo o pluma; un objeto para escribir con tinta", example: "Please use a pen.", fillBlankSentence: "I write with a _____.", isConcrete: true },
  ...
  },
  {
    ...
    categories: [
      ...
      { label: "Classroom", terms: [
        { term: "Paper", englishDefinition: "A thin material produced in sheets and used for writing, printing, or drawing.", spanishDefinition: "Un material delgado producido en hojas y utilizado para escribir, imprimir o dibujar.", example: "Please write your name and the date at the top of the paper.", fillBlankSentence: "Please take out a piece of _____ to write on.", isConcrete: true },
        ...
        { term: "Pen", englishDefinition: "An instrument for writing or drawing with ink.", spanishDefinition: "Un instrumento para escribir o dibujar con tinta.", example: "Can I borrow a pen to sign this registration form?", fillBlankSentence: "Can I borrow your _____ to sign this form.", isConcrete: true },
