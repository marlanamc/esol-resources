...
const RAW_LEVEL1_UNITS: RawUnit[] = [
  {
    ...
    categories: [
      ...
      { label: "Time of Day", terms: [
        ...
        { term: "Evening", englishDefinition: "the later part of the day before night", spanishDefinition: "la tarde-noche; la parte final del día antes de dormir", example: "I cook dinner in the evening.", fillBlankSentence: "We eat dinner at 7:00 in the _____.", isConcrete: true },
        { term: "Night", englishDefinition: "the dark part of the day when people usually sleep", spanishDefinition: "la noche; la parte oscura del día", example: "The children sleep at night.", fillBlankSentence: "Good _____! See you tomorrow.", isConcrete: true },
      ] },
      { label: "People", terms: [
      ...
      { label: "Classroom", terms: [
        ...
        { term: "Book", englishDefinition: "something you read with many pages", spanishDefinition: "un libro; algo con páginas que lees", example: "Open your book to page three.", fillBlankSentence: "I borrowed a _____ from the library to read at home.", isConcrete: true },
        { term: "Pen", englishDefinition: "a classroom tool you write with ink", spanishDefinition: "bolígrafo o pluma; un objeto para escribir con tinta", example: "Please use a pen.", fillBlankSentence: "I write with a _____.", isConcrete: true },
        ...
        { term: "Textbook", englishDefinition: "a school book used in class", spanishDefinition: "un libro de texto; un libro escolar que se usa en clase", example: "The textbook is on the desk.", fillBlankSentence: "The _____ has fifteen chapters.", isConcrete: true },
        ...
        { term: "Board", englishDefinition: "the large surface in a classroom where a teacher writes", spanishDefinition: "pizarra o tablero; la superficie grande donde escribe el maestro", example: "The answer is on the board.", fillBlankSentence: "The teacher writes on the _____ with a marker.", isConcrete: true },
      ] },
      { label: "Other", terms: [
        { term: "Food", englishDefinition: "what people eat", spanishDefinition: "comida; cosas que la gente come", example: "My favorite food is rice.", fillBlankSentence: "Pizza is my favorite _____." },
  ...
  },
  {
    ...
    categories: [
      { label: "Days and Months", terms: [
        ...
        { term: "Thursday", englishDefinition: "the day before Friday", spanishDefinition: "El quinto día de la semana, que ocurre entre el miércoles y el viernes.", example: "The trash is collected on Thursday mornings.", fillBlankSentence: "_____ comes right before Friday." },
        ...
        { term: "April", englishDefinition: "the month when tax forms are due", spanishDefinition: "El cuarto mes del año, a menudo asociado con la lluvia y los impuestos.", example: "Federal income taxes are due in April.", fillBlankSentence: "Tax forms are due in _____." },
        ...
        { term: "Month", englishDefinition: "one of the twelve parts of a year", spanishDefinition: "Un período de unas cuatro semanas; hay doce meses en un año.", example: "Rent is due on the first day of every month.", fillBlankSentence: "February is the shortest _____ of the year." },
      ...
      { label: "Classroom", terms: [
        { term: "Paper", englishDefinition: "thin sheets you write or draw on", spanishDefinition: "Un material delgado producido en hojas y utilizado para escribir o dibujar.", example: "Please write your name and the date at the top of the paper.", fillBlankSentence: "Please take out a piece of _____ to write on.", isConcrete: true },
        { term: "Book", englishDefinition: "something you read with many pages", spanishDefinition: "Un trabajo escrito o impreso que consiste en páginas pegadas o cosidas juntas.", example: "I like to read a book in English for twenty minutes every night.", fillBlankSentence: "I borrowed a _____ from the library to read at home.", isConcrete: true },
        { term: "Pen", englishDefinition: "something you write with ink", spanishDefinition: "Un instrumento para escribir o dibujar con tinta.", example: "Can I borrow a pen to sign this registration form?", fillBlankSentence: "Can I borrow your _____ to sign this form.", isConcrete: true },
        ...
        { term: "Chair", englishDefinition: "a classroom seat for one person", spanishDefinition: "Un asiento separado para una persona, típicamente con un respaldo y cuatro patas.", example: "There are twenty chairs in the classroom for the students.", fillBlankSentence: "Please sit in your _____ and open your book." },
        ...
        { term: "Partner", englishDefinition: "a classmate you work with", spanishDefinition: "Una persona que participa en una tarea con otra.", example: "Please work with a partner to practice the conversation on page five.", fillBlankSentence: "Work with a _____ to practice the dialogue." },
        { term: "Group", englishDefinition: "a small class team working together", spanishDefinition: "Un número de personas o cosas que se encuentran cerca unas de otras o se consideran una unidad.", example: "We finished our project quickly because we worked well as a group.", fillBlankSentence: "Please work in a _____ of three people." },
      ] },
  ...
  },
  {
    ...
    categories: [
      ...
      { label: "Community Places", terms: ["Doctor's office", "Dentist's office", { term: "Hospital", isConcrete: true }, { term: "Hotel", isConcrete: true }, { term: "House", isConcrete: true }, { term: "Park", isConcrete: true }, { term: "Playground", isConcrete: true }, { term: "Supermarket", isConcrete: true }, { term: "Bank", isConcrete: true }, { term: "Library", isConcrete: true }, { term: "Post Office", isConcrete: true }, { term: "Fire Department", englishDefinition: "the place firefighters work from", isConcrete: true }, { term: "Police Station", isConcrete: true }, "RMV", { term: "Bus Stop", isConcrete: true }, "Station", { term: "Public Transportation", englishDefinition: "buses and trains people use to travel between home, work, and school" }, "City Hall", "Clinic", { term: "School", isConcrete: true }, { term: "Museum", isConcrete: true }, { term: "Restaurant", isConcrete: true }, { term: "Store", isConcrete: true }, { term: "Pharmacy", isConcrete: true }, { term: "Gym", isConcrete: true }, { term: "Airport", isConcrete: true }, { term: "Laundromat", isConcrete: true }] },
  ...
  },
  {
    ...
    categories: [
      ...
      { label: "Products", terms: ["Electronics", { term: "Computer", isConcrete: true }, { term: "Car", englishDefinition: "a car people buy and drive on roads", isConcrete: true }, { term: "Cellphone", isConcrete: true }] },
      { label: "Shopping & Finance", terms: ["Tax", "Price", "Cash", "Credit Card", "Debit Card", "Check", "Money Order", "ATM", "Withdraw", "Deposit", "Online", "Refund", { term: "Receipt", englishDefinition: "a store paper that shows what you bought" }, { term: "Signature", englishDefinition: "your written name on a store or bank form" }, { term: "Return", englishDefinition: "to take a product back to the store" }, { term: "Exchange", englishDefinition: "to trade one store product for another" }] },
  ...
  },
  {
    ...
    categories: [
      { label: "Housing & Rental", terms: [
        "Landlord",
        { term: "Manager", englishDefinition: "the person who is in charge of a building" },
        "Agent",
        "Real Estate",
        "Tenant",
        "Leak",
        "Broken Window",
        "Clogged Toilet",
        { term: "Complaint", englishDefinition: "words you say when there is a problem in your home" },
        "House",
        "Home",
        "Apartment",
        "Condominium",
        ...
        "Lease",
        { term: "Fee", englishDefinition: "extra money you pay with rent or for a housing service" },
        { term: "Security deposit", englishDefinition: "money you pay before moving into a home" },
        { term: "Laundry", englishDefinition: "clothes in the home that you need to wash" },
        "Mortgage",
        { term: "Down payment", englishDefinition: "money you pay first when buying a home" },
        "Utilities",
        { term: "Gas", englishDefinition: "fuel used for cooking or heat in a home" },
        { term: "Water", englishDefinition: "the water service in a home" },
        "Electric",
        "Heat"
      ] },
      ...
      { label: "Domestic Things", terms: [
        ...
        { term: "Plant", englishDefinition: "a house plant that grows in a pot or soil" },
        { term: "Lamp", englishDefinition: "a small home light you can move", isConcrete: true },
        "Light",
        { term: "Painting", englishDefinition: "wall art made with paint for a home" },
        "Rug",
        "Carpet",
        { term: "Bathtub", englishDefinition: "a bathroom tub you wash your body in" },
        "Sink",
        { term: "Toilet", isConcrete: true },
        "Curtain",
        { term: "Bed", englishDefinition: "the bedroom furniture where you sleep", isConcrete: true },
        "Closet",
        { term: "Bedtable", englishDefinition: "a small bedroom table next to a bed" },
        { term: "Car", englishDefinition: "a home or travel vehicle that people drive" },
        { term: "Chair", englishDefinition: "a chair for one person to sit on", isConcrete: true },
        ...
        { term: "Oven", englishDefinition: "the kitchen part of a stove where you bake food", isConcrete: true },
        "Counter",
        "Cabinet",
        ...
        { term: "TV", englishDefinition: "a screen where you watch TV shows", isConcrete: true },
        "Fireplace",
        { term: "Washer", englishDefinition: "a laundry machine that washes clothes" },
        { term: "Dryer", englishDefinition: "a laundry machine that dries clothes" }
      ] },
  ...
  },
  {
    ...
    categories: [
      { label: "Occupations", terms: ["Homemaker", "Mechanic", "Office assistant", "Administrative assistant", "Secretary", { term: "Receptionist", englishDefinition: "a worker who welcomes people and answers phones" }, { term: "Manager", englishDefinition: "a worker who is in charge of other workers" }, { term: "Server", englishDefinition: "a restaurant worker who brings food to customers" }, "Busser", "Cook", "Prep Cook", "Chef", { term: "Dishwasher", englishDefinition: "a worker who washes dishes" }, "Host", "Custodian", "Cashier", "Principal", { term: "Doctor", englishDefinition: "a medical worker who treats sick people" }, "Nurse", { term: "Dentist", englishDefinition: "a doctor who cares for teeth" }, "Teacher", "Painter", "Plumber", "Electrician", "Construction worker", "Housekeeper", "Driver", "Landscaper", { term: "Salesperson", englishDefinition: "a store worker who sells things" }, "Business owner"] },
      { label: "Workforce Terminology", terms: ["Pay", "Salary", "Benefits", "Full-time", "Part-time", "Title", "Experience", "Break", "Hired", "Fired", "Laid off", { term: "Job", englishDefinition: "work you do to earn money" }, "Employee", "Paycheck", "Uniform", "Boss", "Interview", "Employer", "Taxes", "Application", { term: "Schedule", englishDefinition: "a work plan with days and times" }, "Vacation", "Sick leave", "Insurance", "Resume", "Raise"] },
  ...
  },
  {
    ...
    categories: [
      { label: "Body Parts", terms: [{ term: "Head", isConcrete: true }, { term: "Arms", isConcrete: true }, "Chest", { term: "Hands", isConcrete: true }, { term: "Stomach", isConcrete: true }, { term: "Back", englishDefinition: "the body part behind your chest and stomach", isConcrete: true }, { term: "Fingers", isConcrete: true }, { term: "Legs", isConcrete: true }, { term: "Foot", isConcrete: true }, { term: "Feet", isConcrete: true }, { term: "Toes", englishDefinition: "the small body parts on your feet", isConcrete: true }, { term: "Neck", isConcrete: true }, { term: "Eyes", englishDefinition: "the body parts you use to see", isConcrete: true }, { term: "Ears", isConcrete: true }, { term: "Mouth", englishDefinition: "the body opening you use to eat and speak", isConcrete: true }, { term: "Nose", isConcrete: true }, { term: "Tooth", isConcrete: true }, { term: "Teeth", englishDefinition: "the hard white parts in your mouth", isConcrete: true }, { term: "Throat", englishDefinition: "the body part inside your neck" }] },
      { label: "Symptoms", terms: ["Pain", "Cut", { term: "Dry cough", englishDefinition: "a health symptom when you cough without mucus" }, "Fever", "Headache", "Runny nose", "Sore Throat", "Sneezing", "Backache", "Toothache", "Chills", "Sweats", "Fatigue", "Dizziness", "Itch", "Rash", "Swelling", "Nausea", "Stress"] },
      ...
      { label: "Other Medical", terms: [{ term: "Appointment", englishDefinition: "a time to meet the doctor or another person" }, "Checkup", { term: "Insurance", englishDefinition: "a plan that helps pay medical costs" }, "Physical", "Surgery"] },
      { label: "Exercise", terms: ["Muscles", { term: "Weight", englishDefinition: "how heavy your body is" }, "Heart"] },
    ],
  },
  {
    slug: "unit-9",
    ...
    categories: [
      ...
      { label: "Grains & Breakfast", terms: ["Cereal", { term: "Bread", isConcrete: true }, "Toast", "Nuts", { term: "Walnuts", englishDefinition: "brown nuts people eat as a snack" }, { term: "Peanuts", englishDefinition: "small nuts people eat as a snack" }, { term: "Almonds", englishDefinition: "long light-brown nuts people eat" }] },
      ...
      { label: "Meats & Proteins", terms: [{ term: "Chicken", isConcrete: true }, { term: "Beef", isConcrete: true }, "Pork", "Turkey", { term: "Fish", isConcrete: true }, { term: "Tuna", englishDefinition: "a fish people eat" }] },
      { label: "Staples", terms: [{ term: "Rice", isConcrete: true }, { term: "Beans", isConcrete: true }, { term: "Soup", isConcrete: true }] },
      { label: "Vegetables", terms: [
        { term: "Tomatoes", englishDefinition: "red vegetables used in salads or cooking", isConcrete: true },
        { term: "Carrots", englishDefinition: "long orange vegetables", isConcrete: true },
        { term: "Avocados", englishDefinition: "soft green fruit often used in salads or guacamole" },
        { term: "Broccoli", englishDefinition: "a green vegetable with small flowers" },
        { term: "Cucumber", englishDefinition: "a long green vegetable with a lot of water" },
        { term: "Corn", englishDefinition: "a yellow vegetable with many kernels", isConcrete: true },
        ...
        { term: "Spinach", englishDefinition: "dark green leaves that people eat" },
        { term: "Salad", englishDefinition: "a cold dish with vegetables mixed together" },
      ] },
      { label: "Condiments & Seasoning", terms: ["Oil", "Salt", "Pepper", "Garlic", { term: "Ketchup", englishDefinition: "a red sauce people eat with food" }, "Mustard", "Jam", "Jelly", "Peanut butter"] },
      { label: "Fruits", terms: [
        ...
        { term: "Bananas", englishDefinition: "long yellow fruits with soft fruit inside", isConcrete: true },
        { term: "Pears", englishDefinition: "sweet fruits with a narrow top and round bottom", isConcrete: true },
        { term: "Watermelon", englishDefinition: "a large green fruit with red fruit inside", isConcrete: true },
        { term: "Melon", englishDefinition: "a large round fruit with soft fruit inside" },
        { term: "Strawberry", englishDefinition: "a small red fruit with seeds on the outside" },
        { term: "Pineapple", englishDefinition: "a large yellow fruit with a rough brown skin", isConcrete: true },
      ...
      { label: "Prepared Foods", terms: [
        ...
        { term: "Hamburger", englishDefinition: "a sandwich with meat inside a bun" },
        { term: "Pasta", englishDefinition: "food made from noodles" },
        { term: "Sandwich", englishDefinition: "food with meat, cheese, or other food between bread" },
        { term: "Crackers", englishDefinition: "thin dry snacks you can eat with cheese" },
      ] },
      ...
      { label: "Drinks", terms: [
        ...
        { term: "Juice", englishDefinition: "a drink made from fruit", isConcrete: true },
      ...
      { label: "Containers", terms: [
        ...
        { term: "Bag", englishDefinition: "a soft container for food or other things" },
        { term: "Box", englishDefinition: "a paper container for food or other things" },
        { term: "Package", englishDefinition: "a wrapped container for food or other things" }
      ] },
