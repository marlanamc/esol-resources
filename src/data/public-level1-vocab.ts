...
const RAW_LEVEL1_UNITS: RawUnit[] = [
  {
    ...
    categories: [
      { label: "Personal Information", terms: [
        ...
        { term: "Phone number", englishDefinition: "the set of numbers people use to call you", spanishDefinition: "número de teléfono", example: "My phone number is on the paper.", fillBlankSentence: "What is your phone _____?" },
        ...
        { term: "Zip code", englishDefinition: "the postal code used for mail in an area", spanishDefinition: "código postal", example: "The zip code for this address is 02118.", fillBlankSentence: "The zip _____ for this area is 02118." },
        { term: "Job", englishDefinition: "the work a person does to earn money", spanishDefinition: "trabajo", example: "My job is cleaning offices.", fillBlankSentence: "What is your _____?" },
        ...
        { term: "Years old", englishDefinition: "used to say a person's age in years", spanishDefinition: "años", example: "I am twenty-five years old.", fillBlankSentence: "My daughter is five years _____." },
      ...
      { label: "Time of Day", terms: [
        ...
        { term: "Night", englishDefinition: "the dark part of the day when people usually sleep", spanishDefinition: "la noche; la parte oscura del día", example: "The children sleep at night.", fillBlankSentence: "I sleep at _____." },
      ] },
      { label: "People", terms: [
        { term: "Man", englishDefinition: "an adult male person", spanishDefinition: "un hombre; una persona adulta de sexo masculino", example: "The man is my teacher.", fillBlankSentence: "The man in the blue shirt is my _____." },
        ...
        { term: "Woman", englishDefinition: "an adult female person", spanishDefinition: "una mujer; una persona adulta de sexo femenino", example: "The woman is my neighbor.", fillBlankSentence: "The woman at the desk is my _____." },
      ...
      { label: "Numbers", terms: [
        ...
        { term: "Three", englishDefinition: "the number 3", spanishDefinition: "tres; el número 3", example: "We need three chairs.", fillBlankSentence: "I have _____ children." },
        ...
        { term: "Five", englishDefinition: "the number 5", spanishDefinition: "cinco; el número 5", example: "Class starts in five minutes.", fillBlankSentence: "I work _____ days a week." },
      ...
      { label: "Classroom", terms: [
        ...
        { term: "Book", englishDefinition: "something with pages that you read", spanishDefinition: "un libro; algo con páginas que lees", example: "Open your book to page three.", fillBlankSentence: "The book is on the _____." },
  ...
  },
  {
    ...
    categories: [
      { label: "Days and Months", terms: [
        { term: "Sunday", englishDefinition: "The first day of the week, often a day for rest or family time.", spanishDefinition: "El primer día de la semana, a menudo un día de descanso o tiempo en familia.", example: "On Sunday, I go grocery shopping for the whole week.", fillBlankSentence: "I visit my parents every _____." },
        ...
        { term: "Tuesday", englishDefinition: "The third day of the week, following Monday.", spanishDefinition: "El tercer día de la semana, siguiendo al lunes.", example: "Our English class meets every Tuesday evening.", fillBlankSentence: "My doctor's appointment is on _____." },
        { term: "Wednesday", englishDefinition: "The fourth day of the week, often called 'hump day' because it is in the middle.", spanishDefinition: "El cuarto día de la semana, a menudo llamado el medio de la semana.", example: "I have a meeting with my supervisor on Wednesday.", fillBlankSentence: "English class meets on _____ evening." },
        { term: "Thursday", englishDefinition: "The fifth day of the week, occurring between Wednesday and Friday.", spanishDefinition: "El quinto día de la semana, que ocurre entre el miércoles y el viernes.", example: "The trash is collected on Thursday mornings.", fillBlankSentence: "We have a staff meeting every _____." },
        { term: "Friday", englishDefinition: "The sixth day of the week, often the last day of work for many people.", spanishDefinition: "El sexto día de la semana, a menudo el último día de trabajo para muchas personas.", example: "I usually get my paycheck on Friday afternoon.", fillBlankSentence: "Many people finish work early on _____." },
        { term: "Saturday", englishDefinition: "The seventh day of the week and part of the weekend.", spanishDefinition: "El séptimo día de la semana y parte del fin de semana.", example: "On Saturday, I take my children to the park.", fillBlankSentence: "The farmers market is open on _____." },
        ...
        { term: "July", englishDefinition: "The seventh month of the year, when Independence Day is celebrated.", spanishDefinition: "El séptimo mes del año, cuando se celebra el Día de la Independencia.", example: "Independence Day is on July 4th in the United States.", fillBlankSentence: "It is very hot in _____." },
        { term: "August", englishDefinition: "The eighth month of the year and the last full month of summer.", spanishDefinition: "El octavo mes del año y el último mes completo de verano.", example: "Many families go on vacation in August.", fillBlankSentence: "The weather is very hot in _____." },
        ...
        { term: "October", englishDefinition: "The tenth month of the year, known for fall colors and Halloween.", spanishDefinition: "El décimo mes del año, conocido por los colores de otoño y Halloween.", example: "The leaves change color in October.", fillBlankSentence: "Halloween is on October 31st, in _____." },
        ...
        { term: "Tomorrow", englishDefinition: "The day after today.", spanishDefinition: "El día después de hoy.", example: "I have a dentist appointment tomorrow morning.", fillBlankSentence: "My dentist appointment is _____ at 10 a.m." },
      ...
      { label: "Routines", terms: [
        ...
        { term: "Schedule", englishDefinition: "A plan that shows when activities or work shifts will happen.", spanishDefinition: "Un plan que muestra cuándo sucederán las actividades o los turnos de trabajo.", example: "My work schedule changes every two weeks.", fillBlankSentence: "The doctor's office sent me a new _____ for my appointments." },
      ...
      { label: "Family", terms: [
        { term: "Father", englishDefinition: "A male parent; can also be called dad or papa.", spanishDefinition: "padre", example: "My father works as a mechanic in my home country.", fillBlankSentence: "His _____ taught him how to drive." },
        { term: "Mother", englishDefinition: "A female parent; can also be called mom or mama.", spanishDefinition: "madre", example: "My mother is visiting us for two weeks next month.", fillBlankSentence: "Her _____ makes the best tamales." },
        ...
        { term: "Brother", englishDefinition: "A male person who has the same parents as another person.", spanishDefinition: "hermano", example: "My brother is looking for a new job in construction.", fillBlankSentence: "My _____ is two years older than me." },
        { term: "Son", englishDefinition: "A male child of a parent.", spanishDefinition: "hijo", example: "My son is in the first grade at the local elementary school.", fillBlankSentence: "Their _____ is seven years old." },
        { term: "Daughter", englishDefinition: "A female child of a parent.", spanishDefinition: "hija", example: "My daughter wants to study nursing when she finishes high school.", fillBlankSentence: "Their _____ just started college." },
        { term: "Cousin", englishDefinition: "The child of your aunt or uncle.", spanishDefinition: "primo o prima", example: "My cousin and I live in the same apartment building.", fillBlankSentence: "My _____ and I grew up in the same city." },
        ...
        { term: "Aunt", englishDefinition: "The sister of your mother or father, or the wife of your uncle.", spanishDefinition: "tía", example: "My aunt takes care of my children while I am at work.", fillBlankSentence: "My _____ brings tamales to every family party." },
        ...
        { term: "Grandmother", englishDefinition: "The mother of your father or mother.", spanishDefinition: "abuela", example: "My grandmother lives with us and helps with the cooking.", fillBlankSentence: "My _____ helps take care of the children." },
        { term: "Grandfather", englishDefinition: "The father of your father or mother.", spanishDefinition: "abuelo", example: "My grandfather tells beautiful stories about his life in the mountains.", fillBlankSentence: "My _____ is seventy years old." },
        { term: "Husband", englishDefinition: "A married man; the male partner in a marriage.", spanishDefinition: "esposo", example: "My husband works a late shift at the warehouse.", fillBlankSentence: "My _____ works at the hospital." },
        { term: "Wife", englishDefinition: "A married woman; the female partner in a marriage.", spanishDefinition: "esposa", example: "His wife is a teacher at the adult education center.", fillBlankSentence: "His _____ is a talented artist." },
        ...
        { term: "Child", englishDefinition: "A young human being below the age of adulthood.", spanishDefinition: "niño o niña", example: "I have one child in elementary school and one in high school.", fillBlankSentence: "Every _____ in the class has a backpack." },
      ...
      { label: "Classroom", terms: [
        ...
        { term: "Notebook", englishDefinition: "A book with blank or ruled pages for writing notes in.", spanishDefinition: "Un libro con páginas en blanco o rayadas para escribir notas.", example: "I write new vocabulary words in my notebook during every class.", fillBlankSentence: "Write the new words in your _____." },
        { term: "Textbook", englishDefinition: "A book used as a standard work for the study of a particular subject.", spanishDefinition: "Un libro utilizado como un trabajo estándar para el estudio de un tema en particular.", example: "The English textbook has many helpful grammar exercises.", fillBlankSentence: "Please bring your _____ to every class." },
        { term: "Workbook", englishDefinition: "A student's book containing instruction and exercises.", spanishDefinition: "Un libro del estudiante que contiene instrucciones y ejercicios.", example: "We need to complete page ten in the workbook for homework tonight.", fillBlankSentence: "Complete page 5 in your _____ for homework." },
        ...
        { term: "Classmate", englishDefinition: "A student who is in the same class as another.", spanishDefinition: "Un estudiante que está en la misma clase que otro.", example: "My classmate helped me understand the instructions for the project.", fillBlankSentence: "My _____ helped me understand the homework." },
      ...
      { label: "Adjectives", terms: [
        { term: "Short", englishDefinition: "Measuring a small distance from end to end; not long or tall.", spanishDefinition: "Midiendo una pequeña distancia de un extremo a otro; no largo ni alto.", example: "He decided to cut his hair short for the summer.", fillBlankSentence: "The commute to work is very _____." },
        { term: "Long", englishDefinition: "Measuring a great distance from end to end; not short.", spanishDefinition: "Midiendo una gran distancia de un extremo a otro; largo.", example: "She has long hair that reaches down to her waist.", fillBlankSentence: "It is a _____ walk to the bus stop." },
        { term: "Straight", englishDefinition: "Moving or continuing in one direction without curving or bending.", spanishDefinition: "Moviéndose o continuando en una dirección sin curvarse ni doblarse; lacio o derecho.", example: "She has straight hair that is very easy to brush.", fillBlankSentence: "The road to the hospital is _____." },
        { term: "Wavy", englishDefinition: "Having a series of curves; not straight or curly.", spanishDefinition: "Teniendo una serie de curvas; ni lacio ni rizado.", example: "Her wavy hair looks beautiful in the sunlight.", fillBlankSentence: "She has beautiful _____ hair." },
        { term: "Curly", englishDefinition: "Forming or full of curls; not straight or wavy.", spanishDefinition: "Formando o lleno de rizos; ni lacio ni ondulado.", example: "He was born with very curly hair that is hard to manage.", fillBlankSentence: "The little girl has _____ hair." },
        { term: "Bald", englishDefinition: "Having little or no hair on the head.", spanishDefinition: "Teniendo poco o nada de cabello en la cabeza; calvo.", example: "My grandfather is bald, so he always wears a hat outside.", fillBlankSentence: "He is _____ and wears a hat." },
        { term: "Brown", englishDefinition: "The color of earth or wood.", spanishDefinition: "El color de la tierra o la madera; café o marrón.", example: "Most of the students in the class have brown eyes.", fillBlankSentence: "The table in the kitchen is _____." },
        ...
        { term: "Black", englishDefinition: "The darkest color; the color of coal or night.", spanishDefinition: "El color más oscuro; el color del carbón o de la noche; negro.", example: "He has black hair and a very friendly smile.", fillBlankSentence: "I wear _____ shoes to work." },
        { term: "Blond", englishDefinition: "A pale yellow or golden color, especially of hair.", spanishDefinition: "Un color amarillo pálido o dorado, especialmente del cabello; rubio.", example: "The little boy has blond hair and blue eyes.", fillBlankSentence: "She has long _____ hair." },
        ...
        { term: "Tall", englishDefinition: "Of great or more than average height.", spanishDefinition: "De gran altura o superior a la media; alto.", example: "My older brother is very tall and plays basketball on weekends.", fillBlankSentence: "The building downtown is very _____." },
        { term: "Young", englishDefinition: "Having lived or existed for only a short time; not old.", spanishDefinition: "Habiendo vivido o existido por poco tiempo; joven.", example: "The young children are learning to speak two languages.", fillBlankSentence: "The _____ man is looking for a job." },
        { term: "Old", englishDefinition: "Having lived or existed for a long time; not young.", spanishDefinition: "Habiendo vivido o existido por mucho tiempo; viejo o mayor.", example: "The old library building is being renovated this year.", fillBlankSentence: "My grandfather is _____, but very strong." },
        { term: "Thin", englishDefinition: "Having little, or too little, flesh or fat on the body.", spanishDefinition: "Teniendo poca, o muy poca, carne o grasa en el cuerpo; delgado.", example: "He has become very thin because he exercises every morning.", fillBlankSentence: "The new textbook is very _____." },
