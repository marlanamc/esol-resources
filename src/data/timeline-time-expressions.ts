...
const TIME_SIGNAL_GROUPS_RAW: TimeSignalGroup[] = [
  {
    ...
    expressions: [
      ...
      },
      {
        ...
        notes: '"Lately" points toward the present. With an ongoing activity like "haven\'t been sleeping," the timeline stretches from the recent past up to NOW.',
        quizDistractors: [
...

  {
    ...
    expressions: [
      ...
      },
      {
        ...
        timelineElements: [{ id: 'e1', type: 'solid-to-now', zone: 'past', position: 30 }],
        notes: '"Since" answers "Since when?" with a starting point, so the timeline begins in the past and reaches NOW: since Monday, since 2020.',
        quizDistractors: [
          [{ id: 'e1', type: 'single-dot', zone: 'past', position: 30 }],
          [{ id: 'e1', type: 'arc', zone: 'past', position: 30 }],
          [{ id: 'e1', type: 'arc-dashed', zone: 'future', position: 60 }],
...

  {
    ...
    expressions: [
      ...
      {
        word: 'next week / next month / next year',
        ...
        timelineElements: [{ id: 'e1', type: 'solid-line', zone: 'future', position: 45 }],
        notes: 'With an arranged visit like "She is visiting...", the future action is taught as a planned future pattern rather than a simple future point.',
        quizDistractors: [
          [{ id: 'e1', type: 'arc-dashed', zone: 'future', position: 60 }],
          [{ id: 'e1', type: 'multiple-dots', zone: 'present', position: 50 }],
          [{ id: 'e1', type: 'single-dot', zone: 'future', position: 45 }],
      ...
      },
      {
        ...
        commonExamples: [
          ...
          { sentence: "It's going to rain later.", verbPhrase: 'is going to rain' },
        ],
        timelineElements: [{ id: 'e1', type: 'solid-line', zone: 'future', position: 35 }],
        notes: '"Going to" shows a future plan, intention, or evidence-based prediction that was already visible before the moment of speaking, so it follows the planned-future timeline pattern. Contrast with "will," which often shows a decision made at the moment of speaking: "It\'s cold — I\'ll close the window."',
        quizDistractors: [
          [{ id: 'e1', type: 'arc-dashed', zone: 'future', position: 55 }, { id: 'e2', type: 'single-dot', zone: 'future', position: 75 }],
          [{ id: 'e1', type: 'multiple-dots', zone: 'present', position: 50 }],
          [{ id: 'e1', type: 'single-dot', zone: 'future', position: 35 }],
      ...
      },
      {
        ...
        notes: 'When the example is an arranged meeting later today, the timeline uses the planned-future pattern. Future Simple can still work in other sentences with "tonight," but this card is teaching the arranged-plan reading.',
        quizDistractors: [
          [{ id: 'e1', type: 'arc-dashed', zone: 'future', position: 60 }],
          [{ id: 'e1', type: 'multiple-dots', zone: 'present', position: 50 }],
