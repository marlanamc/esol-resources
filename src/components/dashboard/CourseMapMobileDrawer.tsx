...
import { Check, ChevronDown, Map as MapIcon, MapPin, X } from "lucide-react";
...
export function CourseMapMobileDrawer({ units, unitProgress, weekProgress, currentWeek }: Props) {
        ...
        <>
            ...
            >
                <span className="inline-flex items-center gap-2.5 min-w-0">
                    <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-bg border border-border-subtle text-primary">
                ...
                <ChevronDown size={18} className="shrink-0 text-text-muted -rotate-90" aria-hidden />
            </button>
