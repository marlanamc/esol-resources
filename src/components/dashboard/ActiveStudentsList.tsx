  ...
  return (
    <div className="space-y-3">
      {[1, 2, 3, 4, 5].map((i) => (
        <div
          key={i}
          className="flex items-center gap-3 p-3 rounded-xl bg-surface-subtle animate-pulse"
        >
      ...
      {students.map((student, idx) => {
        ...
        return (
          <Link
            ...
            className="dashboard-soft-button flex items-center gap-3 p-3 rounded-xl bg-surface-elevated/80 border border-border/40 hover:bg-surface-elevated hover:shadow-md hover:scale-[1.02] transition-all duration-200"
          >
            {/* Rank Badge */}
