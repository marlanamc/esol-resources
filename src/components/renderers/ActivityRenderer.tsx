...
const FlashcardCarousel = dynamic(() => import("../games/FlashcardCarousel"), { loading: ActivityLoadingFallback });
const FillInBlankGame = dynamic(() => import("../games/FillInBlankGame"), { loading: ActivityLoadingFallback });
const MatchingGame = dynamic(() => import("../games/MatchingGame"), { loading: ActivityLoadingFallback });
const NumbersGame = dynamic(() => import("../games/NumbersGame"), { loading: ActivityLoadingFallback });
...
export default function ActivityRenderer({ activity, assignmentId, existingSubmission, userRole }: Props) {
    ...
    return <div className="space-y-6">{renderActivityContent()}</div>;
}
