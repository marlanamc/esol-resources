        ...
        >
            ...
            <div className="space-y-3">
                {examples.map((example, index) => (
                    ...
                    >
                        <div
                            className="example-item relative px-4 py-3.5 rounded-xl border-l-4 border-success shadow-sm hover:shadow-md transition-[box-shadow,transform] duration-300 hover:-translate-y-0.5"
