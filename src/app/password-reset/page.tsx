...
function PasswordResetContent() {
    ...
    return (
        <div className="auth-page min-h-screen flex items-center justify-center py-8 px-4 sm:py-12 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-6 sm:space-y-8">
                ...
                {!success ? (
                    <form onSubmit={handleSubmit} className="space-y-6 w-full">
                        <div className="auth-card border rounded-2xl p-5 sm:p-6 space-y-5 sm:space-y-6" style={{ backgroundColor: '#ffffff', borderColor: '#d9cfc0', boxShadow: '0 4px 12px rgba(43, 58, 74, 0.1), 0 2px 4px rgba(43, 58, 74, 0.06)' }}>
                            <div>
                    ...
                    <div className="auth-card border rounded-2xl p-5 sm:p-6 space-y-5" style={{ backgroundColor: '#ffffff', borderColor: '#cddfcf', boxShadow: '0 4px 12px rgba(43, 58, 74, 0.1), 0 2px 4px rgba(43, 58, 74, 0.06)' }}>
