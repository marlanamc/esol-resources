                        ...
                        <div className="flex items-center justify-between mb-4">
                            ...
                            {isTeacher && (
                                <div className="flex items-center gap-2">
                                    <Link
                                        href={`/dashboard/classes/new?sourceClassId=${classItem.id}`}
                                        className="px-3 py-1 text-sm font-semibold rounded-full bg-emerald-100 text-emerald-800 hover:bg-emerald-200"
                                    >
                                        + New Section
                                    </Link>
                                    <Link
                                        href={`/dashboard/classes/${classItem.id}/edit`}
                                        className="px-3 py-1 text-sm font-semibold rounded-full bg-amber-100 text-amber-800 hover:bg-amber-200"
                                    >
                                        Edit Class
                                    </Link>
