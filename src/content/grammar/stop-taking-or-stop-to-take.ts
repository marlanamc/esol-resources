...
export const stopTakingOrStopToTakeContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    ...
    {
      id: "sti-q3",
      question: "The label says: 'Try ___ the tablet with a full glass of water to reduce nausea.' (experiment, see if it helps)",
      options: [
        { value: "a", label: "to take" },
        { value: "b", label: "taking" },
        { value: "c", label: "took" },
      ...
      correctAnswer: "b",
      explanation: "'Try taking' = experiment. Try this and see if it helps. Low effort, worth trying.",
      topic: "gerunds-infinitives-meaning-change",
      skill: "usage",
      skillTag: "try-plus-gerund",
      difficulty: "easy",
    },
    {
      id: "sti-q4",
      question: "Marisol tried ___ the name-brand medication covered by insurance, but they said no.",
      options: [
        { value: "a", label: "getting" },
        { value: "b", label: "to get" },
        { value: "c", label: "get" },
      ],
      correctAnswer: "b",
      explanation: "'Try to get' = make an effort to do something difficult. She tried but it didn't work.",
      topic: "gerunds-infinitives-meaning-change",
      skill: "usage",
      skillTag: "try-plus-infinitive",
      difficulty: "easy",
    },
    {
      id: "sti-q5",
      question: "The doctor's note says: 'Remember ___ the pill every morning with food.' This is a daily task. Don't forget.",
      options: [
      ...
      correctAnswer: "b",
      explanation: "'Remember to take' = a future task. Don't forget to do it. Looking forward.",
      topic: "gerunds-infinitives-meaning-change",
      skill: "usage",
      skillTag: "remember-plus-infinitive",
      difficulty: "medium",
    },
    {
      id: "sti-q6",
      question: "Carlos asks: 'Did you take your pill?' Marisol says: 'Yes, I remember ___ it at 7 AM with my coffee.'",
      options: [
        { value: "a", label: "to take" },
        { value: "b", label: "taking" },
        { value: "c", label: "took" },
      ...
      correctAnswer: "b",
      explanation: "'Remember taking' = recalling a past event. She is describing a memory of something that already happened.",
      topic: "gerunds-infinitives-meaning-change",
      skill: "usage",
    ...
    },
    {
      ...
      question: "Which sentence has an error?",
      options: [
        { value: "a", label: "Remember to pick up the refill before Friday." },
        { value: "b", label: "I remember filling out the intake form at the clinic." },
        { value: "c", label: "Remember taking your prescription. The pharmacy closes at 6." },
      ],
      correctAnswer: "c",
      explanation: "This is a reminder about a future task, so 'remember to take' is needed, not 'remember taking'. 'Remember taking' = recalling a past memory.",
      topic: "gerunds-infinitives-meaning-change",
      skill: "error-detection",
      skillTag: "remember-meaning-confusion",
      difficulty: "medium",
    },
    {
      id: "sti-q9",
      question: "Fatuma reads her prescription label: 'Try ___ this medication at bedtime if daytime drowsiness is a problem.' What form fits? (It's a suggestion to experiment.)",
      options: [
        { value: "a", label: "to take" },
        { value: "b", label: "taking" },
        { value: "c", label: "took" },
      ...
      correctAnswer: "b",
      explanation: "'Try taking' = experiment, see if it works. It's a suggestion: try this approach and observe the results.",
      topic: "gerunds-infinitives-meaning-change",
      skill: "usage",
      skillTag: "try-plus-gerund",
      difficulty: "medium",
    ...
    {
      id: "sti-q10",
      question: "Marisol wants to say two things in one sentence: she ended the habit of taking ibuprofen, AND she now pauses her lunch to take her new pill. Which sentence is correct?",
      options: [
        { value: "a", label: "She stopped taking ibuprofen and stops to take her new pill at lunch." },
        { value: "b", label: "She stopped to take ibuprofen and stops taking her new pill at lunch." },
        { value: "c", label: "She stopped taking ibuprofen and stopped to take her new pill at lunch." },
      ],
      correctAnswer: "a",
      explanation: "'Stopped taking ibuprofen' = ended the habit. 'Stops to take her new pill' = pauses her lunch to take it. Both meanings used correctly in one sentence.",
      topic: "gerunds-infinitives-meaning-change",
      skill: "usage",
      skillTag: "both-stop-forms",
      difficulty: "hard",
    },
  ],
};
