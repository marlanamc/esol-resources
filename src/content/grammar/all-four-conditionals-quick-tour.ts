  ...
  miniQuiz: [
    {
      ...
      options: [
        { value: "a", label: "A real future plan" },
        { value: "b", label: "A fact or rule that is always true" },
    ...
    },
    {
      ...
      options: [
        { value: "a", label: "First conditional" },
        { value: "b", label: "Zero conditional" },
    ...
    },
    {
      ...
      options: [
        { value: "a", label: "Zero: If the clinic opens at 8, I'll go. / First: If I lift wrong, my back hurts." },
        { value: "b", label: "Zero: If I lift wrong, my back hurts. / First: If the clinic opens at 8, I'll go." },
    ...
    },
    {
      ...
      options: [
        { value: "a", label: "Second: If I had gone sooner, I would have paid less. / Third: If I had day shifts, I would sleep more." },
        { value: "b", label: "Second: If I lift wrong, my back hurts. / Third: If the clinic opens at 8, I'll go." },
        { value: "c", label: "Second: If I had day shifts, I would sleep more. / Third: If I had gone sooner, I would have paid less." },
    ...
    },
    {
      ...
      options: [
        { value: "a", label: "If I lift wrong, my back will hurt. If the clinic opened at 8, I would go. If I had day shifts, I would have slept more. If I go sooner, I pay less." },
        { value: "b", label: "If I lift wrong, my back hurts. If the clinic opens at 8, I'll go. If I had day shifts, I would sleep more. If I had gone sooner, I would have paid less." },
