...
export const allFourConditionalsQuickTourContent: InteractiveGuideContent = {
          ...
          items: [
            {
              ...
              options: [
                { value: "a", label: "If you lift with your back, you hurt yourself." },
                { value: "b", label: "If you lift with your back, you will hurt yourself." },
          ...
          items: [
            {
              ...
              options: [
                { value: "a", label: "If I had called last week, I wouldn't have missed three shifts." },
                { value: "b", label: "If I called last week, I won't miss three shifts." },
          ...
          items: [
            {
              ...
              options: [
                ...
                { value: "b", label: "If I lifted wrong, my back would hurt." },
            ...
            },
            {
              ...
              options: [
                { value: "a", label: "If the clinic opens at 8, I'll go." },
                { value: "b", label: "If the clinic opened at 8, I would go." },
                { value: "c", label: "If the clinic opens at 8, I go." },
            ...
            },
            {
              ...
              options: [
                { value: "a", label: "If I had day shifts, I would sleep more." },
                { value: "b", label: "If I have day shifts, I'll sleep more." },
                { value: "c", label: "If I had had day shifts, I would have slept more." },
            ...
            },
            {
              ...
              options: [
                { value: "a", label: "If I had gone sooner, I would have paid less." },
                { value: "b", label: "If I go sooner, I will pay less." },
                { value: "c", label: "If I had day shifts, I would sleep more." },
                { value: "d", label: "If I go sooner, I pay less." },
              ],
              expectedAnswer: "a",
            },
          ],
  ...
  miniQuiz: [
    {
      id: "afc-q1",
      question: "What does the zero conditional describe?",
      options: [
        { value: "a", label: "A fact or rule that is always true" },
        { value: "b", label: "A real future plan" },
        { value: "c", label: "An imaginary situation now" },
        { value: "d", label: "A past regret" },
      ],
      correctAnswer: "a",
      explanation: "Zero conditional: if + present, present. Always true.",
    ...
    {
      id: "afc-q2",
      question: "Brian's lifting rule: \"If you lift with your back, you hurt yourself.\" Which type is this?",
      options: [
        { value: "a", label: "Zero conditional" },
        { value: "b", label: "First conditional" },
        { value: "c", label: "Second conditional" },
        { value: "d", label: "Third conditional" },
      ],
      correctAnswer: "a",
      explanation: "Both verbs are present simple. It is a rule that is always true.",
      topic: "zero-conditional",
      skill: "usage",
      skillTag: "lifting-rule-context",
      difficulty: "easy",
    },
    {
      id: "afc-q3",
      ...
      options: [
        { value: "a", label: "If the clinic opens at 8, I'll go before work." },
    ...
    {
      id: "afc-q4",
      question: "Find the error: \"If the clinic will open at 8, I'll go.\"",
      options: [
        { value: "a", label: "No error." },
        { value: "b", label: "Error: no will in the if-clause." },
        { value: "c", label: "Error: should be past tense in the if-clause." },
        { value: "d", label: "Error: should be would have in the result." },
      ],
      correctAnswer: "b",
      explanation: "First conditional: if + present (opens), not will open.",
      topic: "first-conditional",
    ...
    },
    {
      ...
      options: [
        { value: "a", label: "If I had called last week, I wouldn't have missed three shifts." },
        { value: "b", label: "If I call last week, I won't miss three shifts." },
        { value: "c", label: "If I had day shifts, I would sleep more." },
    ...
    {
      id: "afc-q7",
      question: "Find the error: \"If I would have gone sooner, I would have paid less.\"",
      options: [
        { value: "a", label: "No error." },
        { value: "b", label: "Error: if-clause should be \"If I had gone sooner.\"" },
        { value: "c", label: "Error: should be first conditional with will." },
        { value: "d", label: "Error: should be zero conditional." },
      ],
      correctAnswer: "b",
      explanation: "Never use would in the if-clause. Third: If I had gone...",
      topic: "third-conditional",
      skill: "error-detection",
      skillTag: "error-would-in-if-clause-third",
      difficulty: "medium",
    },
    {
      id: "afc-q8",
      question: "Which pair shows zero vs. first correctly?",
      options: [
        { value: "a", label: "Zero: If I lift wrong, my back hurts. / First: If the clinic opens at 8, I'll go." },
        { value: "b", label: "Zero: If the clinic opens at 8, I'll go. / First: If I lift wrong, my back hurts." },
        { value: "c", label: "Zero: If I had gone sooner, I would have paid less. / First: If I had day shifts, I would sleep more." },
        { value: "d", label: "Zero: If I had day shifts, I would sleep more. / First: If I lift wrong, my back hurts." },
      ],
      correctAnswer: "a",
      explanation: "Zero = present/present (rule). First = present/will (real plan).",
      topic: "conditional-contrast",
      skill: "usage",
      skillTag: "zero-vs-first-pair",
      difficulty: "medium",
    },
    {
      id: "afc-q9",
      question: "Which pair shows second vs. third correctly?",
      options: [
        { value: "a", label: "Second: If I had day shifts, I would sleep more. / Third: If I had gone sooner, I would have paid less." },
        { value: "b", label: "Second: If I had gone sooner, I would have paid less. / Third: If I had day shifts, I would sleep more." },
        { value: "c", label: "Second: If I lift wrong, my back hurts. / Third: If the clinic opens at 8, I'll go." },
        { value: "d", label: "Second: If the clinic opens at 8, I'll go. / Third: If I lift wrong, my back hurts." },
      ],
      correctAnswer: "a",
      explanation: "Second = imaginary now (had + base). Third = imaginary past (had gone, would have paid).",
      topic: "conditional-contrast",
      skill: "usage",
      skillTag: "second-vs-third-pair",
      difficulty: "medium",
    },
    {
      id: "afc-q10",
      question: "Yemi's full bad week. Which summary uses all four conditionals correctly?",
      options: [
        { value: "a", label: "If I lift wrong, my back hurts. If the clinic opens at 8, I'll go. If I had day shifts, I would sleep more. If I had gone sooner, I would have paid less." },
        { value: "b", label: "If I lift wrong, my back will hurt. If the clinic opened at 8, I would go. If I had day shifts, I would have slept more. If I go sooner, I pay less." },
        { value: "c", label: "If I lifted wrong, my back would hurt. If the clinic opens at 8, I go. If I have day shifts, I'll sleep more. If I would have gone sooner, I would have paid less." },
      ],
      correctAnswer: "a",
      explanation: "All four forms correct: zero, first, second, third in order.",
      topic: "all-four-conditionals",
      skill: "usage",
