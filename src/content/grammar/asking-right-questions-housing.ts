...
export const askingRightQuestionsHousingContent: InteractiveGuideContent = {
      ...
      exercises: [
        {
          ...
          items: [
            {
              type: "radio",
              label: "You want to know about parking. Which question is correct?",
              options: [
                { value: "a", label: "Where the parking is?" },
                { value: "b", label: "Where is the parking?" },
                { value: "c", label: "The parking where is?" },
              ],
              expectedAnswer: "b",
            },
            {
              type: "radio",
              label: "You want to know the number of closets. Which question is correct?",
              options: [
                { value: "a", label: "How many closets it has?" },
                { value: "b", label: "How many closets does it have?" },
                { value: "c", label: "It has how many closets?" },
              ],
              expectedAnswer: "b",
            },
            {
          ...
          items: [
            {
              type: "word-scramble",
              label: "Unscramble:",
              words: ["How", "much", "is", "the", "application", "fee"],
              correctAnswer: "How much is the application fee",
            },
            {
              type: "word-scramble",
              label: "Unscramble:",
          ...
          items: [
            {
              type: "word-scramble",
              label: "Unscramble:",
              words: ["Can", "you", "tell", "me", "where", "the", "mailbox", "is"],
              correctAnswer: "Can you tell me where the mailbox is",
            },
            {
              type: "word-scramble",
              label: "Unscramble:",
              words: ["Do", "you", "know", "if", "hot", "water", "is", "included"],
              correctAnswer: "Do you know if hot water is included",
            },
          ],
        },
        {
      ...
      exercises: [
          ...
          items: [
            {
              ...
              options: [
                { value: "a", label: "Can you tell me what the parking fee is?" },
                { value: "b", label: "How much is the parking fee?" },
              ],
              expectedAnswer: "b",
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            {
              type: "radio",
              label: "Direct: \"When can I move in?\" Indirect version:",
              options: [
                { value: "a", label: "Do you know when can I move in?" },
                { value: "b", label: "Do you know when I can move in?" },
                { value: "c", label: "Can you tell me when I in can move?" },
              ],
              expectedAnswer: "b",
            },
          ],
          ...
          items: [
            {
              type: "word-scramble",
              label: "Unscramble:",
              words: ["Can", "you", "tell", "me", "whether", "smoking", "is", "allowed"],
              correctAnswer: "Can you tell me whether smoking is allowed",
            },
            {
              type: "word-scramble",
              label: "Unscramble:",
              words: ["Do", "you", "know", "when", "I", "can", "sign", "the", "papers"],
              correctAnswer: "Do you know when I can sign the papers",
            },
          ],
        },
        {
  ...
  miniQuiz: [
    {
      id: "arqh-q1",
      question: "Rosa wants to ask the landlord about the nearest bus stop. Which question is correct?",
      options: [
        { value: "a", label: "Where the bus stop is?" },
        { value: "b", label: "Where is the bus stop?" },
        { value: "c", label: "The bus stop is where?" },
      ],
      correctAnswer: "b",
      explanation: "Information questions need inversion: question word + verb + subject. 'Where is the bus stop?' is correct.",
    ...
    },
    {
      ...
      question: "Rosa calls about an apartment listing. Put the words in order to ask about the water bill.",
      words: ["How", "much", "is", "the", "water", "bill"],
      correctAnswer: "How much is the water bill",
