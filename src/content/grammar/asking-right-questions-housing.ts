...
export const askingRightQuestionsHousingContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    ...
    {
      id: "arqh-q2",
      question: "Rosa asks: \"How many bedrooms does it have?\" Her friend says: \"It has how many bedrooms?\" Which one is correct English?",
      options: [
        { value: "a", label: "Both are correct." },
        { value: "b", label: "Rosa's question is correct. Her friend's version is not a proper question in English." },
        { value: "c", label: "Her friend's version is correct." },
      ],
      correctAnswer: "b",
      explanation: "English questions invert the subject and verb. 'It has how many bedrooms?' sounds like a statement, not a real question.",
      topic: "information-questions",
      skill: "error-detection",
      skillTag: "inversion-error",
      difficulty: "easy",
    },
    {
      id: "arqh-q3",
    ...
    {
      id: "arqh-q4",
      question: "Nadine calls the property management office. She says: \"Can you tell me what the rent is?\" Is this correct?",
      options: [
        { value: "a", label: "No. She should say: Can you tell me what is the rent?" },
        { value: "b", label: "Yes. After 'Can you tell me,' use statement order: the rent is." },
        { value: "c", label: "No. She should say: Can you tell me the rent?" },
      ],
      correctAnswer: "b",
      explanation: "Indirect questions use statement word order. After 'Can you tell me,' the subject comes before the verb: 'what the rent is,' not 'what is the rent.'",
      topic: "indirect-questions",
      skill: "usage",
      skillTag: "indirect-statement-order",
      difficulty: "medium",
    },
    {
      id: "arqh-q5",
    ...
    {
      id: "arqh-q6",
      question: "Rosa is at a formal property management office. She wants to ask about the lease length. Which question sounds more appropriate?",
      options: [
        { value: "a", label: "How long is the lease?" },
        { value: "b", label: "Can you tell me how long the lease is?" },
      ],
      correctAnswer: "b",
      explanation: "Indirect questions sound more formal and polite, which is better when calling an office. Both are grammatically correct, but indirect is more appropriate here.",
      topic: "indirect-questions",
      skill: "usage",
      skillTag: "register-formal-indirect",
      difficulty: "medium",
    },
    {
      id: "arqh-q7",
      question: "Rosa wants to know if pets are allowed. She uses an indirect question. Which is correct?",
      options: [
        { value: "a", label: "Do you know if are pets allowed?" },
        { value: "b", label: "Do you know if pets are allowed?" },
        { value: "c", label: "Do you know are pets allowed?" },
      ],
      correctAnswer: "b",
      explanation: "After 'Do you know if,' use statement word order: 'pets are allowed,' not 'are pets allowed.'",
      topic: "indirect-questions",
      skill: "usage",
    ...
    {
      id: "arqh-q8",
      question: "Which two sentences are both correct?",
      options: [
        { value: "a", label: "1. Is there laundry in the building?  2. Can you tell me if there is laundry in the building?" },
        { value: "b", label: "1. There is laundry in the building?  2. Can you tell me if is there laundry?" },
        { value: "c", label: "1. Is there laundry in the building?  2. Can you tell me if is there laundry?" },
      ],
      correctAnswer: "a",
      explanation: "Option A has a correct direct question ('Is there...?') and a correct indirect question ('if there is...'). Both use the right word order for their type.",
      topic: "direct-vs-indirect",
      skill: "error-detection",
      skillTag: "direct-indirect-both-correct",
      difficulty: "medium",
    },
    {
      id: "arqh-q9",
      question: "Nadine wants to ask what floor the apartment is on. She uses an indirect question. Which is correct?",
      options: [
        { value: "a", label: "Can you tell me what floor is the apartment on?" },
        { value: "b", label: "Can you tell me what floor the apartment is on?" },
        { value: "c", label: "Can you tell me the floor what the apartment is?" },
      ],
      correctAnswer: "b",
      explanation: "In indirect questions, the subject comes before the verb. 'What floor the apartment is on' uses statement order correctly.",
      topic: "indirect-questions",
      skill: "usage",
      skillTag: "indirect-what-statement-order",
      difficulty: "hard",
    },
    {
      id: "arqh-q10",
      question: "Rosa is on a quick call before her shift. The landlord asks: \"Do you have any questions?\" Which response uses both direct and indirect questions correctly?",
      options: [
        { value: "a", label: "Yes. How much is the rent, and can you tell me if children are allowed?" },
        { value: "b", label: "Yes. The rent is how much, and can you tell me if are children allowed?" },
        { value: "c", label: "Yes. How much the rent is, and do you know if allowed are children?" },
      ],
      correctAnswer: "a",
      explanation: "Option A uses correct inversion in the direct question ('How much is the rent?') and correct statement order in the indirect question ('if children are allowed').",
      topic: "direct-vs-indirect",
      skill: "usage",
      skillTag: "mixed-direct-indirect",
      difficulty: "hard",
    },
  ],
};
