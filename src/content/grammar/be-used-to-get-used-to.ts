...
export const beUsedToGetUsedToContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    ...
    },
    {
      ...
      options: [
        { value: "a", label: "I used to read school emails in English." },
        { value: "b", label: "I'm used to read school emails in English." },
        { value: "c", label: "I'm getting used to reading school emails in English." },
      ],
      correctAnswer: "c",
    ...
    },
    {
      ...
      options: [
        { value: "a", label: "I'm used to work only days." },
        { value: "b", label: "I'm getting used to work only days." },
        { value: "c", label: "I used to work only days." },
      ],
      correctAnswer: "c",
    ...
    },
    {
      ...
      options: [
        { value: "a", label: "I'm used to work overtime. I'm getting used to work nights. I used to reading school emails. I am used to work only days." },
        { value: "b", label: "I'm used to working overtime. I'm getting used to the night shift. I'm not used to reading every school email yet. I used to work only days." },
