...
export const beUsedToGetUsedToContent: InteractiveGuideContent = {
      ...
      exercises: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              options: [
                { value: "a", label: "I used to walk to work." },
                { value: "b", label: "I'm used to walk to work." },
  ...
  miniQuiz: [
    {
      id: "but-q1",
      question: "What does \"be used to + -ing\" describe?",
      options: [
        { value: "a", label: "A past habit that stopped" },
        { value: "b", label: "Something that feels familiar or normal now" },
        { value: "c", label: "A future plan" },
      ],
      correctAnswer: "b",
      explanation: "Be used to + gerund means you are accustomed to something now.",
      topic: "be-used-to",
      skill: "usage",
      skillTag: "meaning-familiar-now",
      difficulty: "easy",
    },
    {
      id: "but-q2",
      ...
      options: [
        { value: "a", label: "I'm used to finishing at midnight." },
        { value: "b", label: "I'm used to finish at midnight." },
    ...
    {
      id: "but-q3",
      question: "Priya still finds the cold bus stop hard. Which sentence is correct?",
      options: [
        { value: "a", label: "I'm not used to waiting outside in January." },
        { value: "b", label: "I'm not used to wait outside in January." },
        { value: "c", label: "I didn't use to waiting outside in January." },
      ],
      correctAnswer: "a",
      explanation: "Negative: am/is/are not used to + gerund.",
      topic: "be-used-to",
      skill: "usage",
    ...
    {
      id: "but-q5",
      question: "Fabienne is learning to read school emails in English. Which sentence fits?",
      options: [
        { value: "a", label: "I'm getting used to reading school emails in English." },
        { value: "b", label: "I used to read school emails in English." },
        { value: "c", label: "I'm used to read school emails in English." },
      ...
      correctAnswer: "a",
      explanation: "She is still adapting, so getting used to is the best fit.",
      topic: "get-used-to",
      skill: "usage",
      skillTag: "school-email-context",
      difficulty: "medium",
    },
    {
      id: "but-q6",
      question: "Jean worked days before. He works nights now. Which sentence is correct?",
      options: [
        { value: "a", label: "I used to work only days." },
        { value: "b", label: "I'm used to work only days." },
        { value: "c", label: "I'm getting used to work only days." },
      ...
      correctAnswer: "a",
      explanation: "Past habit that changed = used to + base verb.",
      topic: "used-to-contrast",
      skill: "usage",
      skillTag: "past-habit-vs-be-used-to",
      difficulty: "medium",
    },
    {
      id: "but-q7",
    ...
    {
      id: "but-q8",
      question: "Find the error: \"I used to packing rice in lunchboxes.\"",
      options: [
        { value: "a", label: "No error." },
        { value: "b", label: "Error: past habit should be \"used to pack\" (base verb)." },
        { value: "c", label: "Error: should be \"am used to packing\"." },
      ],
      correctAnswer: "b",
      explanation: "Used to (past habit) takes the base verb, not -ing.",
      topic: "used-to-contrast",
      skill: "error-detection",
      skillTag: "error-ing-after-used-to",
      difficulty: "medium",
    },
    {
      id: "but-q9",
      question: "Claudette has two jobs. That feels normal to her. Which sentence is correct?",
      options: [
        { value: "a", label: "She is used to working two jobs." },
        { value: "b", label: "She used to working two jobs." },
        { value: "c", label: "She is getting used to work two jobs." },
      ],
      correctAnswer: "a",
      explanation: "Familiar now = be used to + gerund.",
      topic: "be-used-to",
      skill: "usage",
      skillTag: "two-jobs-haitian-context",
      difficulty: "medium",
    },
    {
      id: "but-q10",
      question: "Fabienne's hard week: overtime feels normal, night shift is still new, school emails are hard. Which summary is correct throughout?",
      options: [
        { value: "a", label: "I'm used to working overtime. I'm getting used to the night shift. I'm not used to reading every school email yet. I used to work only days." },
        { value: "b", label: "I'm used to work overtime. I'm getting used to work nights. I used to reading school emails. I am used to work only days." },
        { value: "c", label: "I used to working overtime. I'm used to the night shift already. I'm getting used to read school emails. I didn't use to work days." },
      ],
      correctAnswer: "a",
      explanation: "All four patterns used correctly: be used to + -ing, getting used to + -ing, not used to + -ing, and used to + base verb.",
      topic: "be-used-to",
      skill: "usage",
