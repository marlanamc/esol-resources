...
export const moreLessTheMostContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    ...
    {
      id: "mlm-q3",
      question: "Amara says the cooking oil is ___ at Market Basket. Which word fits? (expensive. long adjective)",
      options: [
        { value: "a", label: "more expensive" },
        { value: "b", label: "expensiver" },
        { value: "c", label: "the most expensive" },
      ],
      correctAnswer: "a",
      explanation: "Long adjectives use 'more' for comparatives. Never add -er to a long adjective.",
    ...
    {
      id: "mlm-q4",
      question: "The Maverick apartment has less noise than the Bremen one. What does this tell you?",
      options: [
        { value: "a", label: "The Maverick apartment has no noise at all." },
        { value: "b", label: "Noise in the Maverick apartment is lower than in the Bremen apartment." },
        { value: "c", label: "The Maverick apartment has fewer noises." },
      ],
      correctAnswer: "b",
      explanation: "'Less' compares uncountable things like noise. It means a smaller amount, not zero.",
      topic: "less-uncountable",
      skill: "recognition",
      skillTag: "less-meaning-comparison",
      difficulty: "easy",
    },
    {
      id: "mlm-q5",
    ...
    },
    {
      ...
      options: [
        { value: "a", label: "The marigolds are more expensive than last year." },
        { value: "b", label: "This is the most convenient plan of the three." },
        { value: "c", label: "That apartment is the most smallest on the list." },
      ],
      correctAnswer: "c",
      explanation: "'Smallest' is already a superlative. Never add 'most' to an -est form. Correct: 'the smallest'.",
      topic: "superlative-form",
      skill: "error-detection",
      skillTag: "double-superlative-error",
      difficulty: "medium",
    ...
    {
      id: "mlm-q7",
      question: "Rosa found an apartment that is the cheapest near the 111 bus. She is comparing it to one other apartment. Which sentence should she use?",
      options: [
        { value: "a", label: "This apartment is cheaper than the other one." },
        { value: "b", label: "This apartment is the cheapest." },
        { value: "c", label: "This apartment is more cheap than the other one." },
      ],
      correctAnswer: "a",
      explanation: "When comparing two things, use the comparative (cheaper than). Superlatives (the cheapest) compare three or more.",
      topic: "comparative-vs-superlative",
      skill: "usage",
      skillTag: "comparative-two-not-superlative",
      difficulty: "medium",
    },
    {
      id: "mlm-q8",
      question: "The vendor says: \"It is the better deal today.\" Is this correct?",
      options: [
        { value: "a", label: "Yes, 'better' is always correct." },
        { value: "b", label: "No. 'Better' is comparative. He means the best deal (superlative). Should be: 'It is the best deal today.'" },
        { value: "c", label: "No. Should be: 'It is the most good deal today.'" },
      ],
      correctAnswer: "b",
      explanation: "'Better' compares two things. When ranking one above all others, use 'the best'. 'The most good' is never correct.",
      topic: "irregular-superlative",
      skill: "error-detection",
      skillTag: "better-vs-best-error",
      difficulty: "medium",
    },
    {
      id: "mlm-q9",
      question: "Fernanda says: \"This listing has more rooms but less closets.\" What needs to change?",
      options: [
        { value: "a", label: "Nothing. Both are correct." },
        { value: "b", label: "'less closets' should be 'fewer closets' because closets are countable." },
        { value: "c", label: "'more rooms' should be 'most rooms'." },
      ],
      correctAnswer: "b",
      explanation: "Closets are countable (one closet, two closets), so use 'fewer'. 'Less' is for uncountable things like space or noise.",
      topic: "fewer-vs-less",
      skill: "error-detection",
      skillTag: "less-vs-fewer-countable-error",
      difficulty: "medium",
    },
    {
      id: "mlm-q10",
      question: "An apartment ad says: 'More space, less rent, the best location near the 111 bus.' Which part of this ad uses a superlative?",
      options: [
        { value: "a", label: "'more space' and 'less rent'" },
        { value: "b", label: "'the best location'" },
        { value: "c", label: "All three parts use superlatives." },
      ],
      correctAnswer: "b",
      explanation: "'More' and 'less' are comparatives. 'The best' is the superlative of 'good' and compares the location to all others.",
      topic: "comparative-vs-superlative",
      skill: "recognition",
      skillTag: "identify-superlative-in-context",
      difficulty: "hard",
    },
  ],
};
