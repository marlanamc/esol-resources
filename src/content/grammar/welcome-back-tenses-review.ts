...
export const welcomeBackTensesReviewContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    ...
    {
      id: "wbtr-q4",
      question: "A classmate writes: \"I cooking dinner when my phone rang.\" What is wrong with this sentence?",
      options: [
        { value: "a", label: "Nothing is wrong." },
        { value: "b", label: "It should be 'I was cooking' because past continuous needs was/were before the -ing verb." },
        { value: "c", label: "It should be 'I cook dinner' because cooking is a routine." },
      ],
      correctAnswer: "b",
      explanation: "Past continuous = was/were + verb-ing. The background action needs 'was': \"I was cooking dinner when my phone rang.\"",
