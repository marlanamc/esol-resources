...
export const welcomeBackTensesReviewContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    {
      id: "wbtr-q1",
      question: "Your neighbor asks: \"What do you do?\" You want to tell her about your regular job. Which answer fits best?",
      options: [
        { value: "a", label: "I am working at a clinic on Meridian Street." },
        { value: "b", label: "I work at a clinic on Meridian Street." },
        { value: "c", label: "I worked at a clinic on Meridian Street." },
      ],
      correctAnswer: "b",
      explanation: "Present simple for regular jobs and facts that don't change day to day.",
    ...
    {
      id: "wbtr-q2",
      question: "You call your friend from the bus. She asks \"Where are you?\" What do you say?",
      options: [
        { value: "a", label: "I ride the 121 bus." },
        { value: "b", label: "I rode the 121 bus." },
        { value: "c", label: "I am riding the 121 bus right now." },
      ],
      correctAnswer: "c",
      explanation: "Present continuous for what is happening at this exact moment.",
      topic: "present-continuous",
      skill: "usage",
      skillTag: "meaning-right-now",
      difficulty: "easy",
    },
    {
      id: "wbtr-q3",
      question: "Rosa's landlord sent a message last Tuesday. Which sentence describes that correctly?",
      options: [
        { value: "a", label: "The landlord is sending a message last Tuesday." },
        { value: "b", label: "The landlord sends a message last Tuesday." },
        { value: "c", label: "The landlord sent a message last Tuesday." },
      ],
      correctAnswer: "c",
    ...
    {
      id: "wbtr-q5",
      question: "A friend is apartment hunting. She usually rents in Eastie but right now she has a temporary place in JP. Which sentence is correct?",
      options: [
        { value: "a", label: "She lives in Jamaica Plain." },
        { value: "b", label: "She is living in Jamaica Plain for now." },
        { value: "c", label: "She lived in Jamaica Plain." },
      ],
      correctAnswer: "b",
      explanation: "Present continuous for temporary situations. \"For now\" tells you it is not permanent.",
      topic: "present-continuous",
      skill: "usage",
      skillTag: "meaning-temporary",
      difficulty: "medium",
    },
    {
      id: "wbtr-q6",
      question: "The doctor's office called Rosa at 2 PM. Rosa was in a meeting at that time. Which sentence tells the story correctly?",
      options: [
        { value: "a", label: "Rosa had a meeting when the doctor called." },
        { value: "b", label: "Rosa was having a meeting when the doctor called." },
        { value: "c", label: "Rosa is having a meeting when the doctor called." },
      ],
      correctAnswer: "b",
      explanation: "Past continuous (was having) for the action in progress + past simple (called) for the interruption.",
      topic: "past-continuous",
      skill: "usage",
      skillTag: "meaning-interrupted-action",
      difficulty: "medium",
    },
    {
      id: "wbtr-q7",
      question: "You are filling out a form. It asks for your current neighborhood. You write:",
      options: [
        { value: "a", label: "I am living in East Boston." },
        { value: "b", label: "I lived in East Boston." },
    ...
    {
      id: "wbtr-q8",
      question: "Someone at class says: \"I have worked at that restaurant for five years.\" What does the bold word tell you about 'worked'?",
      options: [
    ...
    {
      id: "wbtr-q9",
      question: "Three people describe their commute. Which one uses the wrong tense?",
      options: [
        { value: "a", label: "\"I take the Orange Line every day.\"" },
        { value: "b", label: "\"Right now I am waiting for the 121.\"" },
        { value: "c", label: "\"I am taking the bus every morning to work.\"" },
      ...
      correctAnswer: "c",
      explanation: "\"Every morning\" is a routine. Use present simple: \"I take the bus every morning.\" Present continuous is for right now, not regular habits.",
      topic: "present-simple",
      skill: "error-detection",
      skillTag: "form-simple-vs-continuous-routine",
      difficulty: "medium",
    },
    {
      id: "wbtr-q10",
      question: "Your teacher asks you to say one thing that was happening in your life when you first came to Boston. Which answer is correct?",
      options: [
        { value: "a", label: "\"I looked for work and I learned English.\"" },
        { value: "b", label: "\"I was looking for work and trying to learn English.\"" },
        { value: "c", label: "\"I am looking for work and learning English.\"" },
      ],
      correctAnswer: "b",
      explanation: "Past continuous for ongoing situations that were in progress during a period of time in the past.",
      topic: "past-continuous",
      skill: "usage",
      skillTag: "meaning-ongoing-past-situation",
      difficulty: "medium",
    },
  ],
};
