...
export const allTheTensesYearInReviewContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    {
      id: "atyr-q1",
      question: "Rosa goes to ESOL class every Tuesday and Thursday. Which sentence fits?",
      options: [
        { value: "a", label: "She is taking class every Tuesday and Thursday." },
        { value: "b", label: "She takes class every Tuesday and Thursday." },
        { value: "c", label: "She took class every Tuesday and Thursday." },
    ...
    {
      id: "atyr-q3",
      question: "Water came through the ceiling while Rosa was cooking. Which verb fits the burst?",
      options: [
        { value: "a", label: "came" },
        { value: "b", label: "was coming" },
        { value: "c", label: "had come" },
      ],
      correctAnswer: "a",
      explanation: "Past simple for the finished event that interrupted her cooking.",
      topic: "past-simple",
      skill: "usage",
      skillTag: "interrupted-action",
      difficulty: "easy",
    },
    {
      id: "atyr-q4",
    ...
    {
      id: "atyr-q5",
      question: "Since March Rosa takes two buses every day. Which correction fits?",
      options: [
        { value: "a", label: "Since March Rosa has been taking two buses every day." },
        { value: "b", label: "Since March Rosa took two buses every day." },
        { value: "c", label: "Since March Rosa is taking two buses every day." },
      ],
      correctAnswer: "a",
      explanation: "Present perfect continuous for an ongoing action from a past start until now.",
      topic: "present-perfect-continuous",
      skill: "error-detection",
      skillTag: "since-ongoing-action",
      difficulty: "medium",
    },
    {
      id: "atyr-q6",
    ...
    {
      id: "atyr-q7",
      question: "Rosa plans to start Level 4 in September. Which sentence fits?",
      options: [
        { value: "a", label: "She will enroll in Level 4 in September." },
        { value: "b", label: "She will be enrolling in Level 4 in September." },
        { value: "c", label: "She will have enrolled in Level 4 in September." },
      ],
      correctAnswer: "a",
      explanation: "Future simple for a plan or decision.",
      topic: "future-simple",
      skill: "usage",
      skillTag: "future-plan",
      difficulty: "medium",
    },
    {
      id: "atyr-q8",
      question: "In September Rosa will take class twice a week while she still works. Which sentence fits?",
      options: [
        { value: "a", label: "She will take class twice a week." },
        { value: "b", label: "She will be taking class twice a week." },
        { value: "c", label: "She will have taken class twice a week." },
      ],
      correctAnswer: "b",
      explanation: "Future continuous for an action in progress at a future time.",
      topic: "future-continuous",
      skill: "usage",
      skillTag: "future-in-progress",
      difficulty: "medium",
    },
    {
      id: "atyr-q9",
      question: "Find the error: \"By August I will finish Level 3.\"",
      options: [
        { value: "a", label: "No error." },
        { value: "b", label: "Error: should be 'will have finished'." },
        { value: "c", label: "Error: should be 'will be finishing'." },
      ],
      correctAnswer: "b",
      explanation: "Future perfect with 'by' means done before that future date.",
      topic: "future-perfect",
      skill: "error-detection",
      skillTag: "by-future-perfect",
      difficulty: "medium",
    },
    {
      id: "atyr-q10",
      question: "By the last class tonight, Rosa studied in evening ESOL for a full year. Which correction fits all the meaning?",
      options: [
        { value: "a", label: "By the last class tonight, Rosa will have been studying in evening ESOL for a full year." },
        { value: "b", label: "By the last class tonight, Rosa will study in evening ESOL for a full year." },
        { value: "c", label: "By the last class tonight, Rosa has been studying in evening ESOL for a full year." },
      ],
      correctAnswer: "a",
      explanation: "Future perfect continuous for duration that will be complete by a future point.",
      topic: "future-perfect-continuous",
      skill: "usage",
      skillTag: "duration-by-future-date",
      difficulty: "hard",
    },
  ],
};
