  ...
  miniQuiz: [
    {
      ...
      options: [
        { value: "a", label: "5 forms" },
        { value: "b", label: "3 forms" },
    ...
    },
    {
      ...
      options: [
        ...
        { value: "b", label: "Nadine worked right now." },
        { value: "c", label: "Nadine is working right now." },
      ],
      correctAnswer: "c",
    ...
    },
    {
      ...
      options: [
        { value: "a", label: "I have finished my form." },
        { value: "b", label: "I have finish my form." },
