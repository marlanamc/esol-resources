...
export const enjoyDoingWantToDoContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    ...
    },
    {
      ...
      options: [
        { value: "a", label: "She keeps thinking about a new job." },
        { value: "b", label: "She keeps to think about a new job." },
        { value: "c", label: "She keeps looking for better hours." },
      ],
      correctAnswer: "b",
      explanation: "Keep always takes a gerund. 'Keeps to think' is not correct. It should be 'keeps thinking'.",
      topic: "gerunds-after-verbs",
      skill: "error-detection",
      skillTag: "keep-gerund-error",
      difficulty: "easy",
    },
    {
      id: "edw-q4",
    ...
    {
      id: "edw-q5",
      question: "Amara has a bad shoulder. She ___ the heavy laundry carts.",
      options: [
        { value: "a", label: "avoids to lift" },
        { value: "b", label: "avoids lifting" },
        { value: "c", label: "avoids lift" },
      ],
      correctAnswer: "b",
      explanation: "Avoid always takes a gerund. 'Avoids to lift' is not correct.",
      topic: "gerunds-after-verbs",
      skill: "usage",
    ...
    {
      id: "edw-q6",
      question: "Elena has been at her job a long time. She is thinking about quitting. Which sentence is correct?",
      options: [
        { value: "a", label: "She is considering to leave housekeeping." },
        { value: "b", label: "She is considering leaving housekeeping." },
        { value: "c", label: "She is considering leave housekeeping." },
      ],
      correctAnswer: "b",
      explanation: "Consider takes a gerund. 'Considering to leave' is a common mistake but incorrect.",
      topic: "gerunds-after-verbs",
      skill: "usage",
      skillTag: "consider-gerund",
      difficulty: "medium",
    },
    {
      id: "edw-q7",
      question: "Kevin says: 'I hate ___ past 5.' Which option is correct?",
      options: [
        { value: "a", label: "Only 'staying' is correct." },
        { value: "b", label: "Only 'to stay' is correct." },
        { value: "c", label: "Both 'staying' and 'to stay' are correct." },
      ],
      correctAnswer: "c",
      explanation: "Hate can take either a gerund or an infinitive with no change in meaning. Both 'hate staying' and 'hate to stay' are correct.",
      topic: "both-forms",
      skill: "usage",
      skillTag: "hate-both-forms",
      difficulty: "medium",
    },
    {
      id: "edw-q8",
      question: "Elena tells Ms. Patel: 'I ___ to stay through May and ___ new jobs after that.' Choose the correct pair.",
      options: [
        { value: "a", label: "decided / planning to look" },
        { value: "b", label: "decided to stay / plan to look" },
        { value: "c", label: "deciding staying / plan looking" },
      ],
      correctAnswer: "b",
      explanation: "Decide and plan both take infinitives. 'Decided to stay' and 'plan to look' are the correct forms.",
      topic: "infinitives-after-verbs",
      skill: "usage",
      skillTag: "decide-plan-infinitive",
      difficulty: "medium",
    },
    {
      id: "edw-q9",
      question: "Which sentence uses gerund and infinitive correctly in the same sentence?",
      options: [
        { value: "a", label: "She enjoys to work mornings and wants working fewer weekends." },
        { value: "b", label: "She enjoys working mornings and wants to work fewer weekends." },
        { value: "c", label: "She enjoys working mornings and wants working fewer weekends." },
      ],
      correctAnswer: "b",
      explanation: "Enjoy takes a gerund (enjoying working) and want takes an infinitive (wants to work). This sentence uses both correctly.",
    ...
    {
      id: "edw-q10",
      question: "Elena says: 'I avoid to lift heavy things because of my back.' What is wrong and what is the correct sentence?",
      options: [
        { value: "a", label: "Nothing is wrong." },
        { value: "b", label: "'To lift' should be 'lifting'. Correct: I avoid lifting heavy things because of my back." },
        { value: "c", label: "'Avoid' should be 'avoids'. Correct: I avoids lifting heavy things." },
      ],
      correctAnswer: "b",
      explanation: "Avoid always takes a gerund. 'Avoid to lift' is a common error. The correct form is 'avoid lifting'.",
      topic: "gerunds-after-verbs",
      skill: "error-detection",
      skillTag: "avoid-gerund-correction",
      difficulty: "hard",
    },
  ],
};
