...
export const haveToDontHaveToCantContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    {
      id: "have-to-dont-have-to-cant-q1",
      question: "The heat in Rosa's building stopped working. What does the law say?",
      options: [
        { value: "a", label: "The landlord doesn't have to fix it right away." },
        { value: "b", label: "The landlord has to fix it within 24 hours in winter." },
        { value: "c", label: "The landlord can't fix it without a city permit." },
      ],
      correctAnswer: "b",
      explanation: "Have to = required by law. In Massachusetts, landlords must provide heat in winter within 24 hours.",
      topic: "have-to",
      skill: "usage",
      skillTag: "obligation-legal-context",
      difficulty: "easy",
    },
    {
      id: "have-to-dont-have-to-cant-q2",
      question: "\"She don't have to renew the lease.\" What is wrong with this sentence?",
      options: [
        { value: "a", label: "Nothing, it is correct." },
        { value: "b", label: "Should be 'doesn't have to' because she = third person singular." },
        { value: "c", label: "Should be 'can't renew' because it is not allowed." },
      ],
      correctAnswer: "b",
      explanation: "With he/she/it, use doesn't have to, not don't have to.",
      topic: "dont-have-to",
    ...
    {
      id: "have-to-dont-have-to-cant-q4",
      question: "The landlord wants to show your apartment to a new renter tomorrow morning. He did not call you first. Which rule applies?",
      options: [
        { value: "a", label: "The landlord doesn't have to call first." },
        { value: "b", label: "The landlord has to give 24 hours notice." },
        { value: "c", label: "The tenant has to let him in anytime." },
      ],
      correctAnswer: "b",
      explanation: "Landlords are required (have to) to give advance notice before entering.",
      topic: "have-to",
      skill: "usage",
    ...
    {
      id: "have-to-dont-have-to-cant-q5",
      question: "Which sentence correctly uses 'can't'?",
      options: [
        { value: "a", label: "The landlord can't fix the heater." },
        { value: "b", label: "The landlord can't evict you without a court order." },
        { value: "c", label: "The landlord can't give you 24 hours notice." },
      ],
      correctAnswer: "b",
      explanation: "Can't = not allowed. Evicting without a court order is illegal.",
      topic: "cant",
      skill: "usage",
      skillTag: "prohibition-legal",
      difficulty: "medium",
    },
    {
    ...
    {
      id: "have-to-dont-have-to-cant-q7",
      question: "Javier tells Rosa: \"You ___ repaint the walls. That's the landlord's job.\" What word fits?",
      options: [
      ...
      correctAnswer: "b",
      explanation: "Don't have to = it is not your responsibility. Repainting for normal wear is not required from the tenant.",
      topic: "dont-have-to",
      skill: "usage",
    ...
    {
      id: "have-to-dont-have-to-cant-q9",
      question: "A landlord added a new fee to Rosa's bill that is not in the lease. What is true?",
      options: [
        { value: "a", label: "Rosa has to pay it because the landlord said so." },
        { value: "b", label: "Rosa doesn't have to pay fees that are not in the lease." },
        { value: "c", label: "Rosa can't talk to the landlord about it." },
      ],
      correctAnswer: "b",
      explanation: "Tenants are not required to pay fees that were not agreed to in the lease.",
      topic: "dont-have-to",
      skill: "usage",
      skillTag: "tenant-rights-application",
      difficulty: "hard",
    },
    {
      id: "have-to-dont-have-to-cant-q10",
      question: "\"The landlord <strong>has to</strong> give notice, <strong>can't</strong> add illegal fees, and Rosa <strong>doesn't have to</strong> accept them.\" Which is true about this sentence?",
      options: [
        { value: "a", label: "It uses all three modals correctly." },
        { value: "b", label: "Has to is wrong here." },
        { value: "c", label: "Can't and doesn't have to mean the same thing in this sentence." },
      ],
      correctAnswer: "a",
      explanation: "Has to = required, can't = prohibited, doesn't have to = not required. All three are used correctly.",
      topic: "have-to-cant-dont-have-to",
      skill: "usage",
      skillTag: "three-modal-contrast",
      difficulty: "hard",
    },
  ],
};
