...
export const canShouldMustContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    ...
    },
    {
      ...
      question: "Fill in the blank: \"You ___ not click on suspicious links. This is a strong rule, not just advice.\" (must / should / can)",
      correctAnswer: "must",
      explanation: "'Must not' is the strongest prohibition. 'Should not' is advice; 'can not' is about ability.",
      topic: "must",
      skill: "usage",
