...
export const secondConditionalWhatWouldYouDoContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    ...
    {
      id: "sc-q2",
      question: "Carmen works nights. Which sentence matches her situation?",
      options: [
        { value: "a", label: "If I work days, I will see my kids after school." },
        { value: "b", label: "If I worked days, I would see my kids after school." },
        { value: "c", label: "If I worked days, I will see my kids after school." },
      ],
      correctAnswer: "b",
      explanation: "Carmen works nights, so the day shift is imaginary. Second conditional with 'would' is correct.",
      topic: "second-conditional",
      skill: "usage",
      skillTag: "meaning-imaginary-situation",
      difficulty: "easy",
    },
    {
      id: "sc-q3",
      question: "You want to give Beatriz advice. Which sentence is correct?",
      options: [
        { value: "a", label: "If I am you, I would call the agency." },
        { value: "b", label: "If I were you, I would call the agency." },
        { value: "c", label: "If I was you, I will call the agency." },
      ],
      correctAnswer: "b",
      explanation: "Standard English uses 'were' for all subjects in the if-clause when giving advice with 'If I were you...'",
      topic: "second-conditional",
      skill: "usage",
    ...
    {
      id: "sc-q6",
      question: "Sofia can't go in Saturday because of her son's birthday. Which sentence is correct?",
      options: [
        { value: "a", label: "If I am free on Saturday, I would come in." },
        { value: "b", label: "If I am free on Saturday, I will come in." },
        { value: "c", label: "If I were free on Saturday, I would come in." },
      ],
      correctAnswer: "c",
      explanation: "Sofia is NOT free, so the situation is imaginary. Use 'were' and 'would' for the second conditional.",
      topic: "second-conditional",
      skill: "usage",
      skillTag: "meaning-imaginary-vs-real",
      difficulty: "medium",
    },
    {
      id: "sc-q7",
      question: "Which sentence has an error?",
      options: [
        { value: "a", label: "If the pay were better, I wouldn't work two jobs." },
        { value: "b", label: "If the pay were better, I won't work two jobs." },
        { value: "c", label: "I wouldn't work two jobs if the pay were better." },
      ],
      correctAnswer: "b",
      explanation: "The main clause of a second conditional uses 'would/wouldn't', not 'will/won't'.",
      topic: "second-conditional",
      skill: "error-detection",
      skillTag: "error-will-in-main-clause",
      difficulty: "medium",
    },
    {
      id: "sc-q8",
      question: "Milagros is thinking about a promotion she doesn't have yet. Which word completes her sentence? \"If the company ___ me team lead, I would train the new workers better.\"",
      options: [
        { value: "a", label: "promotes" },
        { value: "b", label: "promoted" },
        { value: "c", label: "will promote" },
      ],
      correctAnswer: "b",
      explanation: "The if-clause in a second conditional uses past simple. The situation (getting a promotion) is not real yet.",
      topic: "second-conditional",
      skill: "usage",
      skillTag: "form-if-past-simple",
      difficulty: "easy",
    },
    {
      id: "sc-q9",
      question: "Jennifer says: \"If I ___ in charge, I would give everyone the same schedule.\" She is not in charge. Which word fits?",
      options: [
        { value: "a", label: "am" },
        { value: "b", label: "were" },
        { value: "c", label: "will be" },
      ],
      correctAnswer: "b",
      explanation: "For imaginary situations with 'be', use 'were' for all subjects in the second conditional if-clause.",
      topic: "second-conditional",
      skill: "usage",
      skillTag: "were-all-subjects",
      difficulty: "medium",
    },
    {
      id: "sc-q10",
      question: "Ramon says: \"If the new site is close to the bus, I'll take the transfer.\" Then he says: \"If the new site were far, I wouldn't take it.\" What is the difference?",
      options: [
        { value: "a", label: "Both sentences mean the same thing." },
        { value: "b", label: "The first is a real possibility. The second is imaginary." },
        { value: "c", label: "The first is imaginary. The second is a real plan." },
      ],
      correctAnswer: "b",
      explanation: "First conditional (if + present, will) = real future. Second conditional (if + past, would) = imaginary or unlikely.",
      topic: "second-conditional",
      skill: "recognition",
      skillTag: "contrast-first-vs-second-meaning",
      difficulty: "hard",
    },
  ],
};
