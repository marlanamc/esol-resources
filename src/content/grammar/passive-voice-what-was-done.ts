...
export const passiveVoiceWhatWasDoneContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    ...
    {
      id: "pvwwd-q2",
      question: "A job ad says: 'Steel-toe boots ___ required.' Which word completes the present passive correctly?",
      options: [
        { value: "a", label: "is" },
        { value: "b", label: "are" },
        { value: "c", label: "were" },
      ...
      correctAnswer: "b",
      explanation: "'Boots' is plural, so the present passive uses 'are required'.",
      topic: "passive-voice",
      skill: "usage",
      skillTag: "present-passive-plural",
      difficulty: "easy",
    },
    {
      id: "pvwwd-q3",
    ...
    {
      id: "pvwwd-q4",
      question: "Gloria wants to say she didn't get paid for extra hours. Which sentence is correct?",
      options: [
        { value: "a", label: "I didn't pay for extra hours." },
        { value: "b", label: "I wasn't paid for extra hours." },
        { value: "c", label: "I wasn't paying for extra hours." },
      ],
      correctAnswer: "b",
      explanation: "To say she received no payment, use the past passive: 'I wasn't paid.'",
      topic: "passive-voice",
      skill: "usage",
      skillTag: "negative-past-passive",
      difficulty: "easy",
    },
    {
      id: "pvwwd-q5",
    ...
    {
      id: "pvwwd-q6",
      question: "A hotel handbook says: 'All uniforms ___ cleaned by the hotel.' Which word fits?",
      options: [
        { value: "a", label: "is" },
        { value: "b", label: "was" },
        { value: "c", label: "are" },
      ...
      correctAnswer: "c",
      explanation: "'Uniforms' is plural, so the present passive uses 'are cleaned.'",
      topic: "passive-voice",
      skill: "usage",
      skillTag: "present-passive-agreement",
      difficulty: "medium",
    },
    {
      id: "pvwwd-q7",
      question: "You don't know who changed the break schedule. Which sentence is better?",
      options: [
        { value: "a", label: "Someone changed the break schedule." },
        { value: "b", label: "The break schedule was changed." },
        { value: "c", label: "The break schedule is changing." },
      ],
      correctAnswer: "b",
      explanation: "Passive voice is better when the doer is unknown or not important.",
      topic: "passive-voice",
      skill: "usage",
      skillTag: "choosing-passive-over-active",
      difficulty: "medium",
    },
    {
      id: "pvwwd-q8",
      question: "Which sentence has an error?",
      options: [
        { value: "a", label: "Gloria was told to bring her ID on Monday." },
        { value: "b", label: "All new workers were given a locker." },
        { value: "c", label: "She was gave a uniform on the first day." },
      ],
      correctAnswer: "c",
      explanation: "'Gave' is simple past, not V3. The correct form is 'was given.'",
      topic: "passive-voice",
      skill: "error-detection",
      skillTag: "v3-form-error",
      difficulty: "medium",
    },
    {
      id: "pvwwd-q9",
      question: "Gloria says: 'I ___ not told about the schedule change.' Which word completes the negative past passive?",
      options: [
        { value: "a", label: "am" },
        { value: "b", label: "was" },
        { value: "c", label: "did" },
      ...
      correctAnswer: "b",
      explanation: "Negative past passive uses 'was not' + V3: 'I was not told.'",
      topic: "passive-voice",
      skill: "usage",
      skillTag: "negative-past-passive",
      difficulty: "medium",
    ...
    {
      id: "pvwwd-q10",
      question: "The supervisor tells Gloria: 'Time off requests must be submitted two weeks early.' Gloria tells Jennifer the same rule using passive voice. Which is correct?",
      options: [
        { value: "a", label: "She said time off requests must submit two weeks early." },
        { value: "b", label: "She said time off requests must be submitted two weeks early." },
        { value: "c", label: "She said time off requests are submitting two weeks early." },
      ],
      correctAnswer: "b",
      explanation: "Modal passive uses 'must be' + V3: 'must be submitted.'",
      topic: "passive-voice",
      skill: "usage",
      skillTag: "modal-passive",
      difficulty: "hard",
    },
  ],
};
