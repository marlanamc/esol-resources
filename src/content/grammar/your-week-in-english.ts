...
export const yourWeekInEnglishContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    ...
    {
      id: "your-week-q2",
      question: "Carlos ___ class on Tuesday and Thursday. (come) Which form is correct?",
      options: [
        { value: "a", label: "come" },
        { value: "b", label: "comes" },
        { value: "c", label: "is coming" },
      ],
      correctAnswer: "b",
      explanation: "Carlos is third person singular, so the verb needs -s: comes.",
    ...
    {
      id: "your-week-q4",
      question: "Which sentence means Fatima takes the bus about 80% of the time?",
      options: [
        { value: "a", label: "Fatima always takes the bus." },
        { value: "b", label: "Fatima usually takes the bus." },
        { value: "c", label: "Fatima rarely takes the bus." },
      ],
      correctAnswer: "b",
      explanation: "'Usually' means most of the time, roughly 80%. 'Always' is 100%, 'rarely' is almost never.",
      topic: "adverbs-of-frequency",
      skill: "recognition",
    ...
    {
      id: "your-week-q5",
      question: "Linh volunteers ___ at the food pantry. She goes one time per month. Which phrase fits?",
      options: [
        { value: "a", label: "every day" },
        { value: "b", label: "twice a week" },
        { value: "c", label: "once a month" },
      ],
      correctAnswer: "c",
      explanation: "'Once a month' means one time per month.",
      topic: "time-expressions",
      skill: "usage",
      skillTag: "frequency-phrases",
      difficulty: "easy",
    },
    {
      id: "your-week-q6",
      question: "Jean ___ already worked three ten-hour shifts this week. Which word completes the sentence?",
      options: [
        { value: "a", label: "have" },
        { value: "b", label: "has" },
        { value: "c", label: "is" },
      ...
      correctAnswer: "b",
      explanation: "Jean is third person singular (he), so use 'has' in the present perfect.",
    ...
    {
      id: "your-week-q7",
      question: "\"I have already went to class today.\" What is wrong?",
      options: [
        { value: "a", label: "Nothing is wrong." },
        { value: "b", label: "'Went' should be 'gone'. The present perfect uses V3." },
        { value: "c", label: "'Have' should be 'has' here." },
      ],
      correctAnswer: "b",
      explanation: "In the present perfect, you need V3. The V3 of 'go' is 'gone', not 'went'.",
      topic: "present-perfect-already",
      skill: "error-detection",
      skillTag: "v3-form",
      difficulty: "medium",
    ...
    {
      id: "your-week-q8",
      question: "Your neighbor asks about your schedule. Which sentence is most natural?",
      options: [
        { value: "a", label: "I on Tuesdays and Thursdays go to class." },
        { value: "b", label: "I go to class on Tuesdays and Thursdays." },
        { value: "c", label: "On Tuesdays and Thursdays I am going to class." },
      ],
      correctAnswer: "b",
      explanation: "Present simple for a regular weekly schedule, with the time expression at the end.",
      topic: "present-simple",
      skill: "usage",
      skillTag: "word-order",
      difficulty: "medium",
    ...
    {
      id: "your-week-q10",
      question: "Valentina says: 'I go to class twice a week. This week I have already gone once.' Why does she switch from present simple to present perfect?",
      options: [
        { value: "a", label: "She uses present simple for her routine and present perfect to say something is already done this week." },
        { value: "b", label: "She made a grammar mistake. Both sentences should use present simple." },
        { value: "c", label: "She uses present perfect because the action happened a long time ago." },
      ],
      correctAnswer: "a",
      explanation: "Present simple describes her regular routine. Present perfect with 'already' shows one of those visits is completed this week.",
      topic: "present-perfect-already",
      skill: "usage",
      skillTag: "routine-vs-already-done",
      difficulty: "hard",
    },
  ],
};
