...
export const thirdConditionalWhatWouldHaveHappenedContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    ...
    {
      id: "tc-q3",
      question: "Yemi missed three shifts. Which sentence is correct?",
      options: [
        { value: "a", label: "If I had gone to the clinic sooner, I wouldn't have missed three shifts." },
        { value: "b", label: "If I went to the clinic sooner, I wouldn't miss three shifts." },
        { value: "c", label: "If I had gone to the clinic sooner, I won't have missed three shifts." },
      ],
      correctAnswer: "a",
      explanation: "Past regret needs had + V3 in the if-clause and wouldn't have + V3 in the result.",
      topic: "third-conditional",
      skill: "usage",
      skillTag: "negative-wouldnt-have",
      difficulty: "easy",
    },
    {
      id: "tc-q4",
      question: "Jennifer can still call the clinic today. Which sentence fits?",
      options: [
        { value: "a", label: "If I called the clinic, they would help me." },
        { value: "b", label: "If I had called the clinic, they would have helped me." },
        { value: "c", label: "If I had called the clinic, they would help me." },
      ],
      correctAnswer: "a",
      explanation: "Calling today is still possible. That is second conditional (would), not third (would have).",
      topic: "third-conditional",
      skill: "usage",
      skillTag: "second-vs-third-now",
      difficulty: "easy",
    },
    {
      id: "tc-q5",
      question: "Yemi's copay was $80. She wishes she had rested early. Complete: \"If I had rested when it started, I ___ this much.\"",
      options: [
        { value: "a", label: "wouldn't pay" },
        { value: "b", label: "wouldn't have paid" },
        { value: "c", label: "won't have paid" },
      ],
      correctAnswer: "b",
      explanation: "A different past result uses wouldn't have + past participle.",
      topic: "third-conditional",
      skill: "usage",
    ...
    {
      id: "tc-q7",
      question: "Find the error: \"If I had rested my knee, I would save $400.\"",
      options: [
        { value: "a", label: "No error." },
        { value: "b", label: "Error: should be \"would have saved\" for a past result." },
        { value: "c", label: "Error: should be \"If I rested\" without had." },
      ],
      correctAnswer: "b",
      explanation: "Saving $400 is a past result that did not happen. Use would have + V3.",
      topic: "third-conditional",
      skill: "error-detection",
      skillTag: "error-would-vs-would-have",
      difficulty: "medium",
    },
    {
      id: "tc-q8",
      question: "Workers Memorial Day poster: \"If the site had followed the rules, he ___ injured.\" Which fits?",
      options: [
        { value: "a", label: "wouldn't be" },
        { value: "b", label: "wouldn't have been" },
        { value: "c", label: "won't have been" },
      ],
      correctAnswer: "b",
      explanation: "A past accident that did happen: the different past result is wouldn't have been + V3.",
      topic: "third-conditional",
      skill: "usage",
      skillTag: "workers-memorial-context",
      difficulty: "medium",
    },
    {
      id: "tc-q9",
      question: "Which sentence mixes second and third conditional incorrectly?",
      options: [
        { value: "a", label: "If I had called last month, I would have saved three shifts." },
        { value: "b", label: "If I called the clinic now, they would help me." },
        { value: "c", label: "If I had called last month, they would help me now." },
      ],
      correctAnswer: "c",
      explanation: "Had called (past) cannot pair with would help (present). Past if-clause needs would have + V3.",
      topic: "third-conditional",
      skill: "error-detection",
      skillTag: "error-mixed-tenses",
      difficulty: "hard",
    },
    {
      id: "tc-q10",
      question: "Yemi tells Jennifer the full story. Which summary uses third conditional correctly throughout?",
      options: [
        { value: "a", label: "If I had rested my knee, I wouldn't have missed shifts, and I wouldn't have paid $80." },
        { value: "b", label: "If I rested my knee, I wouldn't miss shifts, and I wouldn't pay $80." },
        { value: "c", label: "If I had rested my knee, I wouldn't miss shifts, and I wouldn't have paid $80." },
      ],
      correctAnswer: "a",
      explanation: "Both results are about the past: wouldn't have missed and wouldn't have paid.",
      topic: "third-conditional",
      skill: "usage",
