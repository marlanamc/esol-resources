...
export const haveYouEverContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    ...
    {
      id: "hye-q2",
      question: "Claudette asks Jean: \"Did you go to the Haitian festival last Saturday?\" Why does she use Past Simple?",
      options: [
        { value: "a", label: "Because she is asking about Jean's whole life." },
        { value: "b", label: "Because she mentions a specific time: last Saturday." },
        { value: "c", label: "Because festivals are in the past." },
      ],
      correctAnswer: "b",
      explanation: "Past Simple is used when a specific time is mentioned.",
      topic: "past-simple-vs-present-perfect",
      skill: "recognition",
      skillTag: "specific-time-triggers-past-simple",
      difficulty: "easy",
    },
    {
      id: "hye-q3",
      question: "Your friend says: \"Have you ever took the Blue Line?\" What is wrong?",
      options: [
        { value: "a", label: "Should be: Did you ever took the Blue Line?" },
        { value: "b", label: "Should be: Have you ever taken the Blue Line? (V3 = taken)" },
        { value: "c", label: "Nothing is wrong." },
      ],
      correctAnswer: "b",
      explanation: "Have you ever needs V3 (past participle). Take → taken, not took.",
    ...
    {
      id: "hye-q4",
      question: "\"Have you ever been to a city council meeting?\" Which answer is correct?",
      options: [
        { value: "a", label: "Yes, I went." },
        { value: "b", label: "Yes, I was." },
        { value: "c", label: "Yes, I have. I went to one in October." },
      ],
      correctAnswer: "c",
      explanation: "Short answer: Yes, I have. Then use Past Simple for the specific detail.",
      topic: "present-perfect-short-answers",
      skill: "usage",
      skillTag: "short-answer-then-past-simple",
      difficulty: "medium",
    },
    {
      id: "hye-q5",
      ...
      options: [
        { value: "a", label: "Have you ever went to a volunteering event?" },
        { value: "b", label: "Have you ever gone to a volunteering event?" },
        { value: "c", label: "Have you ever going to a volunteering event?" },
      ],
      correctAnswer: "b",
      explanation: "After have you ever, always use V3 (past participle). Go → gone.",
      topic: "present-perfect-form",
      skill: "error-detection",
      skillTag: "v3-form-after-have",
      difficulty: "medium",
    ...
    {
      id: "hye-q6",
      question: "Amara is asking Diego about a specific event last month. Which question is correct?",
      options: [
        { value: "a", label: "Have you ever attended the neighborhood meeting last month?" },
        { value: "b", label: "Did you attend the neighborhood meeting last month?" },
        { value: "c", label: "Have you attended the neighborhood meeting?" },
      ],
      correctAnswer: "b",
      explanation: "A specific past time (last month) needs Past Simple, not present perfect.",
      topic: "past-simple-vs-present-perfect",
      skill: "usage",
      skillTag: "specific-time-triggers-past-simple",
      difficulty: "medium",
    ...
    {
      id: "hye-q9",
      question: "The coordinator asks: \"Have you ever done any translation work?\" Fatima says yes. She translated for a health clinic in 2023. What should Fatima say?",
      options: [
        { value: "a", label: "Yes, I have done. I translate for a clinic in 2023." },
        { value: "b", label: "Yes, I have. I translated for a health clinic in 2023." },
        { value: "c", label: "Yes, I did. I have translated for a clinic in 2023." },
      ],
      correctAnswer: "b",
      explanation: "Start with Yes, I have. Then use Past Simple (translated) for the specific memory.",
      topic: "present-perfect-short-answers",
      skill: "usage",
      skillTag: "short-answer-then-past-simple",
      difficulty: "medium",
    },
    {
      ...
      options: [
        { value: "a", label: "1. Have you ever been to a health fair? 2. Did you go to the health fair last June?" },
        { value: "b", label: "1. Have you ever went to a health fair? 2. Did you go to the health fair last June?" },
        { value: "c", label: "1. Have you ever been to a health fair? 2. Have you gone to the health fair last June?" },
      ],
      correctAnswer: "a",
      explanation: "Option A uses present perfect correctly for life experience and past simple correctly for a specific time.",
      topic: "past-simple-vs-present-perfect",
      skill: "usage",
      skillTag: "ever-vs-specific-time",
      difficulty: "hard",
    },
  ],
};
