  ...
  miniQuiz: [
    {
      id: "mq-should-basic",
        ...
        {
          id: "mq-shouldnt-basic",
          question: "Yolanda's back hurts. She ___ lift heavy boxes today.",
          options: [
            { value: "a", label: "should" },
            { value: "b", label: "shouldn't" },
            { value: "c", label: "had better" },
          ],
          correctAnswer: "b",
        ...
        {
          id: "mq-ought-to",
          question: "What does 'ought to' mean in this sentence: \"You ought to take the medicine with food.\"",
          options: [
            { value: "a", label: "You are required to. There is no choice." },
            { value: "b", label: "This is a good idea. It's advice." },
            { value: "c", label: "You are allowed to if you want." },
          ],
          correctAnswer: "b",
          explanation: "Ought to is similar to should. It gives advice, not a requirement.",
          topic: "should-advice",
          skill: "usage",
          skillTag: "ought-to-meaning",
          difficulty: "easy",
        },
        {
        ...
        {
          id: "mq-question-form",
          question: "Yolanda wants to ask the nurse if she can take a bath. Which question is correct?",
          options: [
            { value: "a", label: "\"Should I to take a bath?\"" },
            { value: "b", label: "\"Should I take a bath?\"" },
            { value: "c", label: "\"I should take a bath?\"" },
          ],
          correctAnswer: "b",
          explanation: "Should I + base verb (no 'to'). Option a adds 'to' incorrectly. Option c is not a proper question form.",
          topic: "should-advice",
          skill: "usage",
          skillTag: "should-question-form",
          difficulty: "easy",
        },
        {
        ...
        {
          id: "mq-error-detection-1",
          question: "Find the error: \"You should to rest for two days.\"",
          options: [
            { value: "a", label: "No error." },
            { value: "b", label: "Error: remove 'to'. Write: \"You should rest for two days.\"" },
            { value: "c", label: "Error: change 'should' to 'must'." },
          ],
          correctAnswer: "b",
          explanation: "After should (and all modals), use the base verb without 'to'.",
          topic: "should-advice",
          skill: "error-detection",
          skillTag: "error-detection-should-to",
          difficulty: "medium",
        },
        {
          id: "mq-error-detection-2",
          question: "Find the error: \"You had better to keep your follow-up appointment.\"",
          options: [
            { value: "a", label: "No error." },
            { value: "b", label: "Error: remove 'to'. Write: \"You had better keep your follow-up appointment.\"" },
            { value: "c", label: "Error: change 'had better' to 'should'." },
          ],
          correctAnswer: "b",
          explanation: "Had better is followed directly by the base verb, without 'to'.",
          topic: "should-advice",
          skill: "error-detection",
          skillTag: "error-detection-had-better-to",
          difficulty: "medium",
        },
        {
          id: "mq-strength-contrast",
          question: "Which sentence is the strongest warning?",
          options: [
            { value: "a", label: "\"You ought to rest today.\"" },
            { value: "b", label: "\"You should rest today.\"" },
            { value: "c", label: "\"You had better rest today, or the pain will get much worse.\"" },
          ],
          correctAnswer: "c",
          explanation: "Had better is the strongest. It includes a warning about a bad consequence. Should and ought to are similar, softer advice.",
          topic: "should-advice",
          skill: "usage",
          skillTag: "modal-strength-contrast",
          difficulty: "hard",
        },
        {
          id: "mq-real-context",
          question: "Rami texts Yolanda: \"The doctor said don't ignore the pain. You ___ call back if it gets worse tonight.\" Which modal fits?",
          options: [
            { value: "a", label: "must not" },
            { value: "b", label: "had better not" },
            { value: "c", label: "should" },
          ],
          correctAnswer: "c",
          explanation: "Should fits best here. It's a sensible piece of advice. Must not means 'do not do this' (negative). Had better not is also negative.",
          topic: "should-advice",
          skill: "usage",
          skillTag: "should-real-context",
          difficulty: "medium",
        },
  ],
};
