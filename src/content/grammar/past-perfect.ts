...
export const pastPerfectContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    ...
    },
    {
      ...
      options: [
        { value: "a", label: "By the time she had left, she trained two new workers." },
        { value: "b", label: "By the time she left, she had trained two new workers." },
    ...
    },
    {
      ...
      options: [
        { value: "a", label: "Before I came here, I have done home care for four years." },
        { value: "b", label: "Before I came here, I had done home care for four years." },
