...
export const zeroFirstConditionalContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    {
      id: "zero-first-conditional-q1",
      question: "The manager says: 'If you clock in late, I write you up.' What kind of conditional is this?",
      options: [
        { value: "a", label: "First Conditional. It is about the future." },
        { value: "b", label: "Zero Conditional. It is an always-true rule at this job." },
        { value: "c", label: "It is not a conditional sentence." },
      ],
      correctAnswer: "b",
      explanation: "Zero Conditional uses If + present, present. It describes rules and facts that are always true.",
    ...
    {
      id: "zero-first-conditional-q3",
      question: "Rosa needs to ask for a day off. The rule at the restaurant is clear. Which sentence is Zero Conditional?",
      options: [
        { value: "a", label: "If Rosa asks two weeks early, she will get the day off." },
        { value: "b", label: "If Rosa needs a day off, she asks two weeks early." },
        { value: "c", label: "If Rosa needed a day off, she would ask two weeks early." },
      ],
      correctAnswer: "b",
      explanation: "Zero Conditional: If + present, present. It describes the rule that always applies at this restaurant.",
      topic: "zero-conditional",
      skill: "usage",
    ...
    {
      id: "zero-first-conditional-q5",
      question: "Jennifer says: 'I won't be available ___ my days off get changed back.' Which word fits?",
      options: [
        { value: "a", label: "if" },
        { value: "b", label: "unless" },
        { value: "c", label: "when" },
      ],
      correctAnswer: "b",
      explanation: "'Unless' means 'if not.' Jennifer will be unavailable if her days off are NOT changed back.",
      topic: "unless",
      skill: "usage",
      skillTag: "meaning-unless-if-not",
      difficulty: "medium",
    },
    {
      id: "zero-first-conditional-q6",
      question: "Claudette says: '___ Miguel gets here, I'll ask him.' Which word makes the correct sentence?",
      options: [
        { value: "a", label: "As soon as Miguel gets here, I'll ask him." },
        { value: "b", label: "As soon as Miguel will get here, I'll ask him." },
        { value: "c", label: "As soon as Miguel got here, I'll ask him." },
      ],
      correctAnswer: "a",
      explanation: "After 'as soon as,' use present simple, not 'will.' Same rule as the First Conditional if-clause.",
      topic: "as-soon-as",
      skill: "usage",
      skillTag: "as-soon-as-present-not-will",
      difficulty: "medium",
    },
    {
    ...
    {
      id: "zero-first-conditional-q8",
      question: "Which sentence has an error?",
      options: [
        { value: "a", label: "When the bonus comes in, I'll treat you to lunch." },
        { value: "b", label: "I won't ask unless you talk to Scott first." },
        { value: "c", label: "As soon as the schedule will post, text me." },
      ],
      correctAnswer: "c",
      explanation: "After 'as soon as,' use present simple. 'Will post' should be 'posts.'",
      topic: "as-soon-as",
      skill: "error-detection",
      skillTag: "as-soon-as-no-will",
      difficulty: "medium",
    },
    {
      id: "zero-first-conditional-q9",
      question: "Linh says her mother-in-law comes every Christmas. Which conditional fits this fact?",
      options: [
        { value: "a", label: "First Conditional. It might happen this year." },
        { value: "b", label: "Zero Conditional. It happens every year without exception." },
        { value: "c", label: "It is not a conditional because there is no 'if' in the sentence." },
      ],
      correctAnswer: "b",
      explanation: "A fact that happens every time (every year, every Christmas) is Zero Conditional, even without 'if.'",
      topic: "zero-conditional",
      skill: "recognition",
      skillTag: "meaning-always-true-no-if",
      difficulty: "hard",
    },
    {
      id: "zero-first-conditional-q10",
      question: "Linh needs to decide about overtime. Her childcare depends on whether her mother-in-law comes. Which sentence uses First Conditional correctly AND makes sense in this situation?",
      options: [
        { value: "a", label: "If she doesn't come, I won't be able to take the overtime." },
        { value: "b", label: "If she doesn't come, I don't take the overtime." },
        { value: "c", label: "If she won't come, I won't be able to take the overtime." },
      ],
      correctAnswer: "a",
      explanation: "First Conditional: If + present simple, will + base verb. Option B is Zero Conditional. Option C has 'will' in the if-part, which is incorrect.",
      topic: "first-conditional",
      skill: "usage",
      skillTag: "first-conditional-real-situation",
      difficulty: "hard",
    },
  ],
};
