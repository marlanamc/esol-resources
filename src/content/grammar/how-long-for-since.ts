...
export const howLongForSinceContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    {
      id: "hlfs-q1",
      question: "Claudette says: \"I have worked at this hotel for two years.\" What does this mean?",
      options: [
        { value: "a", label: "She worked there two years ago and stopped." },
        { value: "b", label: "She started two years ago and still works there now." },
        { value: "c", label: "She will work there for two years." },
      ],
      correctAnswer: "b",
      explanation: "Present perfect with 'for' means the situation started in the past and is still true now.",
      topic: "present-perfect-duration",
      skill: "recognition",
      skillTag: "for-since-still-true-now",
      difficulty: "easy",
    },
    {
      id: "hlfs-q2",
    ...
    {
      id: "hlfs-q4",
      question: "Kevin asks Rosa: \"How long ___ you ___ this plan?\" Choose the correct question.",
      options: [
        { value: "a", label: "How long did you have this plan?" },
        { value: "b", label: "How long have you had this plan?" },
        { value: "c", label: "How long are you having this plan?" },
      ],
      correctAnswer: "b",
      explanation: "For ongoing duration questions, use 'How long have/has + V3?'",
    ...
    {
      id: "hlfs-q5",
      question: "Javier says: \"I worked here for two years ago.\" What is wrong?",
      options: [
        { value: "a", label: "Should be: I have worked here for two years. (No 'ago' with present perfect + for)" },
        { value: "b", label: "Should be: I worked here since two years." },
        { value: "c", label: "Nothing is wrong." },
      ],
      correctAnswer: "a",
      explanation: "Never use 'ago' with present perfect. Use 'I have worked here for two years' (still working now) or 'I worked here two years ago' (finished).",
      topic: "present-perfect-duration",
      skill: "error-detection",
      skillTag: "no-ago-with-present-perfect",
      difficulty: "medium",
    },
    {
      id: "hlfs-q6",
      question: "Gloria has lived in East Boston since she moved from Chelsea. She still lives there. Which sentence is also correct?",
      options: [
        { value: "a", label: "Gloria lived in East Boston since she moved from Chelsea." },
        { value: "b", label: "Gloria has lived in East Boston for several years." },
        { value: "c", label: "Gloria was living in East Boston since she moved from Chelsea." },
      ],
      correctAnswer: "b",
      explanation: "Both 'since [starting point]' and 'for [length]' are correct with present perfect when the situation is still true.",
      topic: "for-vs-since",
      skill: "usage",
      skillTag: "for-since-both-correct",
      difficulty: "medium",
    },
    {
      id: "hlfs-q7",
    ...
    },
    {
      ...
      options: [
        { value: "a", label: "1. I have lived here for five years.  2. I have lived here since 2019." },
        { value: "b", label: "1. I have lived here since five years.  2. I have lived here for 2019." },
        { value: "c", label: "1. I lived here for five years.  2. I have lived here since 2019." },
      ],
      correctAnswer: "a",
      explanation: "Option A correctly uses 'for' with a length of time and 'since' with a starting year.",
      topic: "for-vs-since",
      skill: "error-detection",
      skillTag: "for-length-since-startpoint",
      difficulty: "medium",
    },
    {
      id: "hlfs-q9",
      question: "Rosa says: \"My manager posted the Christmas Eve hours. I have worked that shift for three years.\" A coworker asks: \"Really? How long has it been since you had a holiday off?\" What does the coworker want to know?",
      options: [
        { value: "a", label: "When is Rosa's next holiday?" },
        { value: "b", label: "How many years since Rosa last had a holiday off work." },
        { value: "c", label: "What Rosa's holiday plans are." },
      ],
      correctAnswer: "b",
      explanation: "'How long has it been since...' asks about the duration since the last time something happened.",
      topic: "how-long-since",
      skill: "recognition",
      skillTag: "how-long-since-last-time",
      difficulty: "medium",
    },
    {
      id: "hlfs-q10",
      question: "Teresa says: \"We have lived here for five years.\" Her neighbor asks when they moved in. What should Teresa say?",
      options: [
        { value: "a", label: "We have moved in five years ago." },
        { value: "b", label: "We moved in five years ago. (Past simple for the specific past action)" },
        { value: "c", label: "We have been moving here for five years." },
      ],
      correctAnswer: "b",
      explanation: "When talking about the specific action of moving (finished), use past simple. 'We moved in five years ago.' Present perfect describes the ongoing state, past simple describes the starting action.",
      topic: "present-perfect-vs-past-simple",
      skill: "usage",
      skillTag: "state-vs-action-tense-switch",
      difficulty: "hard",
    },
  ],
};
