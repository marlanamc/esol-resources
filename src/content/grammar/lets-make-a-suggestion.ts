          ...
          items: [
            {
              ...
              options: [
                { value: "a", label: "We could call the landlord tonight." },
                { value: "b", label: "Let's call the landlord tonight." },
                { value: "c", label: "Let's to call the landlord tonight." },
              ],
              expectedAnswer: "b",
            },
            {
              ...
              options: [
                { value: "a", label: "Let's ask the other tenants." },
                { value: "b", label: "We could asks the other tenants." },
                { value: "c", label: "We could ask the other tenants." },
              ],
              expectedAnswer: "c",
            },
            {
      ...
      exercises: [
        {
          ...
          items: [
            {
              type: "radio",
              label: "Kevin thinks a written complaint is the right and necessary step. Which fits?",
              options: [
                { value: "a", label: "You could send a written complaint." },
                { value: "b", label: "You should send a written complaint." },
                { value: "c", label: "You should to send a written complaint." },
              ],
              expectedAnswer: "b",
            },
            {
              ...
              options: [
                { value: "a", label: "You should call Inspectional Services." },
                { value: "b", label: "You could calls Inspectional Services." },
                { value: "c", label: "You could call Inspectional Services." },
              ],
              expectedAnswer: "c",
            },
            {
      ...
      exercises: [
        {
          ...
          items: [
            {
              type: "radio",
              label: "Diego wants to propose a polite option to split the shift. Which fits?",
              options: [
                { value: "a", label: "Could we split the shift between two people?" },
                { value: "b", label: "Could we splitting the shift between two people?" },
                { value: "c", label: "Let's to split the shift between two people." },
              ],
              expectedAnswer: "a",
            },
            {
              type: "radio",
              label: "Brian wants to check if calling Luis is a good idea. Which fits?",
              options: [
                { value: "a", label: "Why don't we called Luis?" },
                { value: "b", label: "Should we call Luis?" },
                { value: "c", label: "Should we to call Luis?" },
              ],
              expectedAnswer: "b",
            },
            {
          ...
          items: [
            {
              ...
              options: [
                { value: "a", label: "You could decide together." },
                { value: "b", label: "Let's decide what to do." },
                { value: "c", label: "Why don't you decide?" },
              ],
              expectedAnswer: "b",
            },
            {
            ...
            },
            {
              ...
              options: [
                { value: "a", label: "Let's split the shift." },
                { value: "b", label: "You must split the shift." },
                { value: "c", label: "Could we split the shift between two people?" },
              ],
              expectedAnswer: "c",
            },
            {
  ...
  miniQuiz: [
    {
      ...
      options: [
        { value: "a", label: "Let's call the landlord tonight." },
        { value: "b", label: "Let's to call the landlord tonight." },
        { value: "c", label: "Let's calling the landlord tonight." },
      ],
      correctAnswer: "a",
    ...
    {
      id: "lets-make-a-suggestion-q2",
      question: "Jean wants to give a soft option, not a command. Which fits?",
      options: [
        { value: "a", label: "Let's ask the other tenants." },
        { value: "b", label: "We could ask the other tenants." },
        { value: "c", label: "We should ask the other tenants." },
      ],
      correctAnswer: "b",
      explanation: "'We could' offers a soft option. 'Let's' is more direct and 'we should' is stronger advice.",
      topic: "we-could",
      skill: "usage",
    ...
    },
    {
      ...
      question: "Kevin tells Marta that sending a written complaint is the right and necessary step. Which fits?",
      options: [
        { value: "a", label: "You could send a written complaint." },
        { value: "b", label: "You should send a written complaint." },
        { value: "c", label: "Let's send a written complaint." },
      ],
      correctAnswer: "b",
    ...
    {
      id: "lets-make-a-suggestion-q4",
      question: "Which sentence has an error?",
      options: [
        { value: "a", label: "We could wait one more day." },
        { value: "b", label: "Let's to send the complaint now." },
        { value: "c", label: "You should call Inspectional Services." },
      ],
      correctAnswer: "b",
      explanation: "'Let's' is followed by the base verb directly. 'To send' should be 'send'.",
      topic: "lets",
    ...
    {
      id: "lets-make-a-suggestion-q5",
      question: "Diego wants to politely ask his manager if the group can split the Saturday shift. Which fits?",
      options: [
        { value: "a", label: "Let's split the shift." },
        { value: "b", label: "Could we split the shift?" },
        { value: "c", label: "You must split the shift." },
      ],
      correctAnswer: "b",
      explanation: "'Could we...?' is a polite question suggestion. 'Let's' is a statement, and 'must' is an obligation.",
      topic: "could-we",
      skill: "usage",
      skillTag: "suggestion-question-form",
      difficulty: "medium",
    },
    {
      id: "lets-make-a-suggestion-q6",
      question: "Brian is checking if calling Luis is a good idea. Which fits?",
      options: [
        { value: "a", label: "Should we call Luis?" },
        { value: "b", label: "Should we to call Luis?" },
        { value: "c", label: "Should we calling Luis?" },
      ],
      correctAnswer: "a",
      explanation: "'Should we + base verb' is the correct form for a group suggestion question.",
      topic: "should-we",
      skill: "usage",
      skillTag: "suggestion-base-verb-form",
      difficulty: "medium",
    ...
    {
      id: "lets-make-a-suggestion-q8",
      question: "The landlord has not fixed the heat for three days. What is the difference between these two sentences? A: 'You should call the city.' B: 'The landlord must keep the heat at 68 degrees.'",
      options: [
        { value: "a", label: "Both are suggestions. There is no difference." },
        { value: "b", label: "'Should' is advice for Marta. 'Must' is the law for the landlord." },
        { value: "c", label: "'Must' is softer than 'should' here." },
      ],
      correctAnswer: "b",
      explanation: "'Should' gives personal advice. 'Must' states a legal obligation. They are not the same strength.",
      topic: "should-vs-must",
      skill: "recognition",
      skillTag: "meaning-advice-vs-obligation",
      difficulty: "medium",
    },
    {
      id: "lets-make-a-suggestion-q9",
      question: "Amara's childcare fell through. Diego wants to suggest a soft option for covering the shift. Which fits best?",
      options: [
        { value: "a", label: "Let's cover the whole shift alone." },
        { value: "b", label: "We could split the shift between two people." },
        { value: "c", label: "You must find someone to cover." },
      ],
      correctAnswer: "b",
      explanation: "'We could' offers a practical option without pressure. It fits when you want to help, not give orders.",
      topic: "we-could",
      skill: "usage",
      skillTag: "meaning-soft-option-work",
      difficulty: "medium",
    },
    {
      id: "lets-make-a-suggestion-q10",
      question: "The tenants need to decide together what to do about the heat tonight. Gloria says it is urgent. Which response uses suggestion language correctly AND matches the urgency?",
      options: [
        { value: "a", label: "We could think about it and decide later." },
        { value: "b", label: "Let's decide right now and send the complaint tonight." },
        { value: "c", label: "Why don't we waiting until tomorrow?" },
      ],
      correctAnswer: "b",
      explanation: "'Let's' is direct and urgent, which fits the situation. Option A delays and option C has a grammar error ('waiting' should be 'wait').",
      topic: "lets",
      skill: "usage",
      skillTag: "meaning-real-world-urgency",
      difficulty: "hard",
    },
  ],
};
