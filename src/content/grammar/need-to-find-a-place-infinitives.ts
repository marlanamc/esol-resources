...
export const needToFindAPlaceInfinitivesContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    {
      id: "infinitives-q1",
      question: "Rosa's lease ends soon and she has no choice. Which sentence fits?",
      options: [
        { value: "a", label: "She wants to find a new place." },
        { value: "b", label: "She needs to find a new place." },
        { value: "c", label: "She hopes to find a new place." },
      ],
      correctAnswer: "b",
      explanation: "'Need to' means necessary. She has no choice with the lease ending.",
      topic: "infinitives",
      skill: "usage",
      skillTag: "need-to-necessity",
      difficulty: "easy",
    },
    {
      id: "infinitives-q2",
    ...
    {
      id: "infinitives-q3",
      question: "Carlos has decided he will see the apartment on Saturday. He has a plan. Which fits?",
      options: [
        { value: "a", label: "He hopes to see the apartment on Saturday." },
        { value: "b", label: "He plans to see the apartment on Saturday." },
        { value: "c", label: "He would like to see the apartment on Saturday." },
      ],
      correctAnswer: "b",
      explanation: "'Plan to' shows a decided intention. 'Hope to' means you want it but are unsure.",
      topic: "infinitives",
      skill: "usage",
      skillTag: "plan-vs-hope-meaning",
      difficulty: "medium",
    },
    {
      id: "infinitives-q4",
    ...
    {
      id: "infinitives-q5",
      question: "Amara is not sure she will find an apartment before February, but she is trying. Which fits?",
      options: [
        { value: "a", label: "She plans to find one before February." },
        { value: "b", label: "She needs to find one before February." },
        { value: "c", label: "She hopes to find one before February." },
      ],
      correctAnswer: "c",
      explanation: "'Hope to' means you want something but are not certain it will happen.",
      topic: "infinitives",
      skill: "usage",
    ...
    {
      id: "infinitives-q7",
      question: "Which sentence uses 'plan to' correctly?",
      options: [
        { value: "a", label: "I plan calling the landlord later." },
        { value: "b", label: "I plan to call the landlord later." },
        { value: "c", label: "I planning to call the landlord later." },
      ],
      correctAnswer: "b",
      explanation: "'Plan to' is followed by a base verb: 'plan to call', not 'plan calling' or 'planning to call'.",
      topic: "infinitives",
      skill: "error-detection",
      skillTag: "plan-to-base-verb",
      difficulty: "medium",
    },
    {
      id: "infinitives-q8",
      question: "\"I would like to ask about the deposit.\" Is this correct?",
      options: [
        { value: "a", label: "Yes, this is correct." },
        { value: "b", label: "No, should be 'I would like asking about the deposit.'" },
        { value: "c", label: "No, should be 'I like to ask about the deposit.'" },
      ],
      correctAnswer: "a",
      explanation: "'Would like to' + base verb is the correct form for polite requests.",
      topic: "infinitives",
      skill: "usage",
      skillTag: "would-like-to-correct",
      difficulty: "easy",
    },
    {
      id: "infinitives-q9",
      question: "Lucia says: \"I ___ pay less than $1,500, but the landlord won't lower it.\" Which word fits?",
      options: [
        { value: "a", label: "would like to" },
        { value: "b", label: "plan to" },
        { value: "c", label: "need to" },
      ],
      correctAnswer: "a",
      explanation: "'Would like to' = polite wish that may not happen. 'Plan to' would mean she already decided. 'Need to' means it is necessary.",
      topic: "infinitives",
      skill: "usage",
      skillTag: "would-like-vs-plan-vs-need",
      difficulty: "hard",
    },
    {
      id: "infinitives-q10",
      question: "\"She hopes finding a place near the school.\" What is wrong?",
      options: [
        { value: "a", label: "Nothing is wrong." },
        { value: "b", label: "'finding' should be 'to find'. Use hope to + base verb" },
        { value: "c", label: "'near' should be 'close to'" },
      ],
      correctAnswer: "b",
      explanation: "After 'hope', use 'to' + base verb: 'hopes to find', not 'hopes finding'.",
      topic: "infinitives",
      skill: "error-detection",
      skillTag: "hope-to-base-verb",
      difficulty: "hard",
    },
  ],
};
