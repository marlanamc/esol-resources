...
export const pastPerfectFamilyContent: InteractiveGuideContent = {
    ...
    sections: [
        ...
        // -------------------------------------------------------------------------
        {
            ...
            icon: "🧠",
            explanation: `
                <div class="gc-callout-amber" style="background: linear-gradient(135deg, rgba(245, 158, 11, 0.1) 0%, rgba(16, 185, 129, 0.1) 100%); padding: 1rem; border-radius: 0.5rem; ">
        ...
        // -------------------------------------------------------------------------
        {
            ...
            explanation: `
                ...
                <div class="gc-bg-slate gc-bg-slate" style="padding: 1rem; border-radius: 0.5rem; margin: 1rem 0">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin: 1.5rem 0">
                    <!-- Order Timeline -->
                    <div class="gc-bg-white gc-bg-white" style="border: 2px solid #f59e0b; border-radius: 0.75rem; padding: 1.25rem">
                        ...
                        <div style="position: relative; height: 80px; margin: 1rem 0">
                            ...
                            <div style="position: absolute; left: 15%; top: 50%; transform: translate(-50%, -50%)">
                                ...
                                <div class="gc-text-amber" style="position: absolute; top: 55px; left: 50%; transform: translateX(-50%); white-space: nowrap; font-size: 0.7rem; ; font-weight: 600">had left</div>
                            </div>
                            <!-- 2nd action -->
                    ...
                    <!-- Duration Timeline -->
                    <div class="gc-bg-white gc-bg-white" style="border: 2px solid #8b5cf6; border-radius: 0.75rem; padding: 1.25rem">
                ...
                <table style="width: 100%; border-collapse: collapse; margin: 1rem 0">
                    <tr class="gc-bg-slate gc-bg-slate">
                    ...
                    <tr>
                        ...
                        <td style="padding: 0.75rem; border-bottom: 1px solid #e2e8f0">"...but I <strong>had already seen</strong> it."<br><span class="gc-text-muted" style="font-size: 0.8rem; ">→ I saw it before (sequence)</span></td>
                        <td style="padding: 0.75rem; border-bottom: 1px solid #e2e8f0">"I <strong>had been waiting</strong> for 30 minutes."<br><span class="gc-text-muted" style="font-size: 0.8rem; ">→ The waiting time (duration)</span></td>
                    </tr>
                    <tr>
                        <td style="padding: 0.75rem; border-bottom: 1px solid #e2e8f0">She got the job...</td>
                        <td style="padding: 0.75rem; border-bottom: 1px solid #e2e8f0">"...because she <strong>had studied</strong> hard."<br><span class="gc-text-muted" style="font-size: 0.8rem; ">→ Completed preparation</span></td>
                        <td style="padding: 0.75rem; border-bottom: 1px solid #e2e8f0">"...after she <strong>had been applying</strong> for months."<br><span class="gc-text-muted" style="font-size: 0.8rem; ">→ Long process (duration)</span></td>
                    </tr>
                    <tr>
                        <td style="padding: 0.75rem; border-bottom: 1px solid #e2e8f0">When I met him...</td>
                        <td style="padding: 0.75rem; border-bottom: 1px solid #e2e8f0">"...he <strong>had just arrived</strong> from Spain."<br><span class="gc-text-muted" style="font-size: 0.8rem; ">→ Recent completed action</span></td>
                        <td style="padding: 0.75rem; border-bottom: 1px solid #e2e8f0">"...he <strong>had been living</strong> in Spain for 5 years."<br><span class="gc-text-muted" style="font-size: 0.8rem; ">→ How long before our meeting</span></td>
                    </tr>
                </table>

                <div class="gc-bg-yellow" style="padding: 1rem; border-radius: 0.5rem; border-left: 4px solid #eab308; margin-top: 1.5rem">
                    ...
                    <div style="margin-top: 0.75rem; display: flex; gap: 1rem; flex-wrap: wrap">
                        <div style="flex: 1; min-width: 200px">
                            <p class="gc-text-red" style="margin: 0; ; font-size: 0.9rem">❌ "I had eaten breakfast." (Alone - unclear)</p>
                        </div>
                        <div style="flex: 1; min-width: 200px">
        ...
        // -------------------------------------------------------------------------
        {
            ...
            explanation: `
                ...
                <div class="gc-bg-white gc-bg-white" style="border: 2px solid #f59e0b; border-radius: 0.75rem; padding: 1.5rem; margin: 1.5rem 0">
                    ...
                    <div style="display: flex; gap: 1rem; margin-top: 1rem; flex-wrap: wrap">
                        <div class="gc-bg-amber gc-callout-amber" style="flex: 1; min-width: 180px; ; padding: 0.75rem; border-radius: 0.5rem; ">
                ...
                <ul style="margin: 0; padding-left: 1.5rem">
                    <li><strong>When</strong> + Past Simple, Past Perfect → "When I <span style="color: #14b8a6">arrived</span>, she <span class="gc-text-amber">had left</span>."</li>
                    <li>Past Perfect + <strong>before</strong> + Past Simple → "She <span class="gc-text-amber">had finished</span> before she <span style="color: #14b8a6">went</span> home."</li>
                    <li><strong>After</strong> + Past Perfect, Past Simple → "After he <span class="gc-text-amber">had eaten</span>, he <span style="color: #14b8a6">watched</span> TV."</li>
                    <li><strong>By the time</strong> + Past Simple, Past Perfect → "By the time we <span style="color: #14b8a6">arrived</span>, the show <span class="gc-text-amber">had ended</span>."</li>
                </ul>

                <h4>More Example Sentences</h4>
                <div class="gc-bg-slate gc-bg-slate" style="padding: 1rem; border-radius: 0.5rem; margin: 1rem 0">
                    <ul style="margin: 0; padding-left: 1.2rem; font-size: 0.95rem">
                        <li>"The streets were wet because it <strong>had rained</strong> earlier." <span class="gc-text-muted">(Rain → wet streets)</span></li>
                        <li>"She knew the answer because she <strong>had studied</strong> hard." <span class="gc-text-muted">(Study → knew)</span></li>
                        <li>"I wasn't hungry because I <strong>had just eaten</strong>." <span class="gc-text-muted">(Eat → not hungry)</span></li>
                        <li>"He couldn't enter because he <strong>had forgotten</strong> his key." <span class="gc-text-muted">(Forget → couldn't enter)</span></li>
                        <li>"They were happy because they <strong>had won</strong> the game." <span class="gc-text-muted">(Win → happy)</span></li>
                    </ul>
                </div>
            ...
            explanation: `
                ...
                <div class="gc-bg-white gc-bg-white" style="border: 2px solid #8b5cf6; border-radius: 0.75rem; padding: 1.5rem; margin: 1.5rem 0">
                    ...
                    <div style="position: relative; margin: 1.5rem auto; max-width: 450px">
                        ...
                        <!-- Labels -->
                        <div class="gc-text-muted" style="display: flex; justify-content: space-between; margin-top: 0.5rem; font-size: 0.75rem; ">
                            <span>Started waiting</span>
                            <span class="gc-text-purple" style="font-weight: 600">→ bus arrived</span>
                        </div>
                    </div>
                ...
                <div style="display: grid; gap: 1rem; margin: 1rem 0">
                    <div class="gc-bg-violet gc-callout-purple" style="padding: 1rem; border-radius: 0.5rem; ">
        ...
        // -------------------------------------------------------------------------
        {
            ...
            explanation: `
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin: 1.5rem 0">
                    <div class="gc-bg-amber gc-callout-top gc-callout-amber" style="padding: 1rem; border-radius: 0.5rem; ">
                        <h4 style="margin: 0 0 0.75rem 0; color: #b45309">Order</h4>
                        <div style="display: flex; align-items: center; gap: 0.5rem; flex-wrap: wrap; margin-bottom: 0.75rem">
                            <span class="gc-bg-blue" style="padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-weight: 600">Subject</span>
                            <span>+</span>
                            <span class="gc-bg-amber" style="padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-weight: 600; border: 1px solid #f59e0b">had</span>
                            <span>+</span>
                    ...
                    <div class="gc-bg-violet" style="padding: 1rem; border-radius: 0.5rem; border-top: 4px solid #8b5cf6">
            ...
            explanation: `
                ...
                <div class="gc-bg-slate gc-bg-slate" style="padding: 1rem; border-radius: 0.5rem; margin: 1rem 0">
                    <div style="margin-bottom: 0.75rem; padding-bottom: 0.75rem; border-bottom: 1px solid #e2e8f0">
                        ...
                        <p class="gc-text-muted" style="margin: 0.25rem 0 0 0; font-size: 0.85rem; ">→ Zero flying experience before that moment</p>
                    </div>
                    <div style="margin-bottom: 0.75rem; padding-bottom: 0.75rem; border-bottom: 1px solid #e2e8f0">
                        ...
                        <p class="gc-text-muted" style="margin: 0.25rem 0 0 0; font-size: 0.85rem; ">→ Studying wasn't happening before the test</p>
                    </div>
                    <div>
                        ...
                        <p class="gc-text-muted" style="margin: 0.25rem 0 0 0; font-size: 0.85rem; ">→ We were strangers before that night</p>
                    </div>
                </div>
            `,
            exercises: [
            ...
            explanation: `
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin: 1.5rem 0">
                    ...
                    <div class="gc-bg-violet" style="padding: 1rem; border-radius: 0.5rem; border-top: 4px solid #8b5cf6">
                        ...
                        <div style="display: flex; align-items: center; gap: 0.5rem; flex-wrap: wrap; margin-bottom: 0.75rem">
                            <span class="gc-bg-violet" style="padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-weight: 600; border: 1px solid #8b5cf6">Had</span>
                            <span>+</span>
                            <span class="gc-bg-blue" style="padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-weight: 600">subject</span>
                            <span>+</span>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin: 1rem 0">
                    <div class="gc-bg-amber" style="padding: 1rem; border-radius: 0.5rem">
                    ...
                    <div class="gc-bg-violet" style="padding: 1rem; border-radius: 0.5rem">
        ...
        // -------------------------------------------------------------------------
        {
            ...
            explanation: `
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin: 1.5rem 0">
                    <div class="gc-bg-amber gc-callout-amber" style="padding: 1rem; border-radius: 0.5rem; ">
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 0.5rem">
                            <span class="gc-bg-white" style="padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-weight: 500">already</span>
                            <span class="gc-bg-white" style="padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-weight: 500">just</span>
                            <span class="gc-bg-white" style="padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-weight: 500">never</span>
                            <span class="gc-bg-white" style="padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-weight: 500">before</span>
                            <span class="gc-bg-white" style="padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-weight: 500">after</span>
                            <span class="gc-bg-white" style="padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-weight: 500">by the time</span>
                            <span class="gc-bg-white" style="padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-weight: 500">when</span>
                        </div>
                    </div>
                    ...
                    <div class="gc-bg-violet gc-callout-purple" style="padding: 1rem; border-radius: 0.5rem; ">
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 0.5rem">
                            <span class="gc-bg-white" style="padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-weight: 500">for + duration</span>
                            <span class="gc-bg-white" style="padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-weight: 500">since</span>
                            <span class="gc-bg-white" style="padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-weight: 500">all day/morning</span>
                            <span class="gc-bg-white" style="padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-weight: 500">how long</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="gc-bg-green gc-callout-green" style="padding: 1rem; border-radius: 0.5rem; ; margin-top: 1rem">
        ...
        // -------------------------------------------------------------------------
        {
            ...
            explanation: `
                ...
                <div class="gc-bg-slate gc-bg-slate" style="padding: 1rem; border-radius: 0.5rem; margin: 1rem 0">
                    <div style="margin-bottom: 0.75rem; padding-bottom: 0.75rem; border-bottom: 1px solid #e2e8f0">
                        <p class="gc-text-red" style="margin: 0; ">❌ "I went to the cinema after I had been finishing work."</p>
                        <p style="margin: 0; color: #16a34a">✓ "I went to the cinema after I had finished work." <span class="gc-text-muted" style="font-size: 0.85rem; ">(finish = completion)</span></p>
                    </div>
                    <div style="margin-bottom: 0.75rem; padding-bottom: 0.75rem; border-bottom: 1px solid #e2e8f0">
                        <p class="gc-text-red" style="margin: 0; ">❌ "She had been owning that car for 5 years."</p>
                        <p style="margin: 0; color: #16a34a">✓ "She had owned that car for 5 years." <span class="gc-text-muted" style="font-size: 0.85rem; ">(own = state verb)</span></p>
                    </div>
                    <div>
                        <p class="gc-text-red" style="margin: 0; ">❌ "When I arrived, she had left already."</p>
                        <p style="margin: 0; color: #16a34a">✓ "When I arrived, she had already left." <span class="gc-text-muted" style="font-size: 0.85rem; ">(already goes before the main verb)</span></p>
                    </div>
                </div>
            `,
            comparison: {
        ...
        // -------------------------------------------------------------------------
        {
            ...
            explanation: `
                ...
                <div class="gc-bg-slate" style="padding: 1rem; border-radius: 0.5rem; margin: 1rem 0; border-left: 4px solid #64748b">
                    ...
                    <p style="margin: 0; line-height: 1.8">
                        ...
                        she was nervous. She <span class="gc-text-purple" style="font-weight: 600">had been preparing</span> for weeks,
                        but she <span class="gc-text-amber" style="font-weight: 600">had never done</span> an interview in English before.
                        Luckily, she <span class="gc-text-amber" style="font-weight: 600">had practiced</span> her answers with a friend."
                    </p>
                </div>
                ...
                <div style="background: linear-gradient(135deg, #fef3c7 0%, #ede9fe 100%); padding: 1.25rem; border-radius: 0.5rem; margin: 1rem 0">
                    ...
                    <p style="margin: 0; font-size: 1.05rem; line-height: 1.8">
                        ...
                        we <span class="gc-text-amber" style="font-weight: 600">had already packed</span> most of the boxes <span class="gc-text-muted">(completed first)</span>.
                        We were exhausted because we <span class="gc-text-purple" style="font-weight: 600">had been packing</span> since 6am <span class="gc-text-muted">(duration)</span>.
                        Luckily, we <span class="gc-text-amber" style="font-weight: 600">had hired</span> professionals <span class="gc-text-muted">(prior decision)</span>,
                        so we <span class="gc-text-amber" style="font-weight: 600">hadn't had to</span> worry about the heavy furniture <span class="gc-text-muted">(no prior worry)</span>."
                    </p>
                </div>
                ...
                <div style="background: linear-gradient(135deg, #fef3c7 0%, #ede9fe 100%); padding: 1.25rem; border-radius: 0.5rem; margin: 1rem 0">
                    ...
                    <p style="margin: 0; font-size: 1.05rem; line-height: 1.8">
                        ...
                        I <span class="gc-text-purple" style="font-weight: 600">had been working</span> toward this moment for four years <span class="gc-text-muted">(duration)</span>.
                        I <span class="gc-text-amber" style="font-weight: 600">had passed</span> all my exams <span class="gc-text-muted">(completed first)</span>,
                        and I <span class="gc-text-amber" style="font-weight: 600">had made</span> so many friends along the way <span class="gc-text-muted">(completed first)</span>."
                    </p>
                </div>
            `,
            exercises: [
        ...
        // -------------------------------------------------------------------------
        {
            ...
            explanation: `
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin: 1rem 0">
                    <div class="gc-bg-amber gc-callout-top gc-bg-amber gc-callout-top gc-callout-amber" style="padding: 1rem; border-radius: 0.5rem; ">
                ...
                <div style="background: linear-gradient(135deg, #fef3c7 0%, #ede9fe 100%); padding: 1.25rem; border-radius: 0.5rem; margin: 1rem 0">
                    <p style="margin: 0; font-style: italic; font-size: 1.05rem; line-height: 1.7">
                        "When I <strong style="color: #14b8a6">met</strong> my wife <span class="gc-text-muted">(Past Simple - reference point)</span>,
                        she <strong class="gc-text-purple">had been living</strong> in London for 3 years <span class="gc-text-muted">(duration)</span>.
                        She <strong class="gc-text-amber">had already finished</strong> her degree <span class="gc-text-muted">(completed before)</span>,
                        and she <strong class="gc-text-amber">had just started</strong> her first job <span class="gc-text-muted">(recent completion)</span>.
                        I <strong class="gc-text-amber">had known</strong> her name for a while <span class="gc-text-muted">(state verb = Simple)</span>,
                        but we <strong class="gc-text-amber">had never spoken</strong> before that day <span class="gc-text-muted">(never = Simple)</span>."
                    </p>
                </div>
            `,
            tipBox: {
