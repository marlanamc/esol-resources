...
export const howMuchHowManyContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    ...
    {
      id: "how-much-how-many-q3",
      question: "Kevin has a small amount of money left. Which sentence is correct?",
      options: [
        { value: "a", label: "He has a few money." },
        { value: "b", label: "He has a little money." },
        { value: "c", label: "He has a little moneys." },
    ...
    {
      id: "how-much-how-many-q4",
      question: "Ana bought some apples at the store. Which sentence is correct?",
      options: [
        { value: "a", label: "She bought a little apples." },
        { value: "b", label: "She bought a few apple." },
        { value: "c", label: "She bought a few apples." },
      ],
      correctAnswer: "c",
      explanation: "Apples are countable, so use 'a few' with the plural form 'apples.'",
      topic: "a-little-a-few",
      skill: "usage",
      skillTag: "a-few-countable",
      difficulty: "easy",
    },
    {
      id: "how-much-how-many-q5",
      question: "Claudette checks the label on a can of beans. Which sentence is correct?",
      options: [
        { value: "a", label: "There isn't many sodium in this." },
        { value: "b", label: "There isn't much sodium in this." },
        { value: "c", label: "There aren't much sodium in this." },
      ],
      correctAnswer: "b",
      explanation: "Sodium is uncountable. In negative sentences, use 'much' with uncountable nouns.",
      topic: "much-many-negatives",
      skill: "usage",
      skillTag: "much-negative-uncountable",
      difficulty: "medium",
    },
    {
      id: "how-much-how-many-q6",
      question: "The store didn't have a lot of choices. Which sentence is correct?",
      options: [
        { value: "a", label: "There weren't many options." },
        { value: "b", label: "There wasn't many options." },
        { value: "c", label: "There weren't much options." },
      ],
      correctAnswer: "a",
      explanation: "Options are countable. In negative sentences, use 'many' with countable nouns and 'weren't' because options is plural.",
      topic: "much-many-negatives",
      skill: "usage",
      skillTag: "many-negative-countable",
      difficulty: "medium",
    },
    {
      id: "how-much-how-many-q7",
      question: "Beatriz bought 10 bags of rice but only needed 2. Which sentence is correct?",
      options: [
        { value: "a", label: "She bought too much bags." },
        { value: "b", label: "She bought enough bags." },
        { value: "c", label: "She bought too many bags." },
      ],
      correctAnswer: "c",
      explanation: "Bags are countable. Use 'too many' when there is more than you need of a countable noun.",
      topic: "enough-too-much-too-many",
      skill: "usage",
      skillTag: "too-many-countable",
      difficulty: "medium",
    },
    {
    ...
    {
      id: "how-much-how-many-q9",
      question: "Which sentence has an error?",
      options: [
        { value: "a", label: "How many cans did you buy?" },
        { value: "b", label: "How much milks do we need?" },
        { value: "c", label: "There isn't much bread left." },
      ],
      correctAnswer: "b",
      explanation: "Milk is uncountable and has no plural form. Say 'How much milk,' not 'milks.'",
      topic: "how-much",
      skill: "error-detection",
      skillTag: "error-uncountable-plural",
      difficulty: "medium",
    },
    {
      id: "how-much-how-many-q10",
      question: "Jorge has exactly enough plates for the people coming. Luisa still has food she doesn't need. Which pair is correct?",
      options: [
        { value: "a", label: "Jorge has enough plates. Luisa has too much food." },
        { value: "b", label: "Jorge has enough plates. Luisa has too many food." },
        { value: "c", label: "Jorge has too many plates. Luisa has too much food." },
      ],
      correctAnswer: "a",
      explanation: "Plates = countable, right amount = 'enough.' Food = uncountable, more than needed = 'too much.'",
      topic: "enough-too-much-too-many",
      skill: "usage",
      skillTag: "enough-vs-too-much",
      difficulty: "hard",
    },
  ],
};
