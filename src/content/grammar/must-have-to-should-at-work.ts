...
export const mustHaveToShouldAtWorkContent: InteractiveGuideContent = {
  ...
  miniQuiz: [
    {
      id: "must-have-to-should-at-work-q1",
      question: "Kevin the foreman says: 'You ___ wear steel-toe boots. It's an OSHA safety rule.' Which word fits?",
      options: [
        { value: "a", label: "should" },
        { value: "b", label: "must" },
        { value: "c", label: "have to" },
      ],
      correctAnswer: "b",
      explanation: "OSHA rules are federal safety regulations. 'Must' signals a non-negotiable legal requirement.",
      topic: "must",
      skill: "usage",
    ...
    {
      id: "must-have-to-should-at-work-q2",
      question: "Amara is the new line cook. Which sentence is correct?",
      options: [
        { value: "a", label: "She have to wear her uniform every shift." },
        { value: "b", label: "She has to wear her uniform every shift." },
        { value: "c", label: "She has to wears her uniform every shift." },
      ],
      correctAnswer: "b",
      explanation: "Use 'has to' with he, she, or it. After 'has to,' the base verb has no -s: 'has to wear,' not 'has to wears.'",
      topic: "have-to",
      skill: "error-detection",
      skillTag: "has-to-third-person",
      difficulty: "easy",
    },
    {
    ...
    {
      id: "must-have-to-should-at-work-q4",
      question: "The health inspector is coming. Jennifer says: 'Rosa ___ be here by 10. No exceptions.' Which word fits?",
      options: [
        { value: "a", label: "should" },
        { value: "b", label: "must" },
        { value: "c", label: "had to" },
      ],
      correctAnswer: "b",
      explanation: "A city inspection with serious consequences is non-negotiable. 'Must' is correct for official, non-optional requirements.",
      topic: "must",
      skill: "usage",
      skillTag: "must-vs-should-high-stakes",
      difficulty: "medium",
    },
    {
    ...
    {
      id: "must-have-to-should-at-work-q7",
      question: "Rosa's manager texts: 'You don't have to come in Saturday.' What does this mean?",
      options: [
        { value: "a", label: "She is not allowed to come in Saturday." },
        { value: "b", label: "It is not required, but she can if she wants." },
        { value: "c", label: "She must not work Saturday." },
      ],
      correctAnswer: "b",
      explanation: "'Don't have to' means something is not required, but the person can still choose to do it. It is not the same as 'must not.'",
      topic: "dont-have-to",
      skill: "recognition",
      skillTag: "dont-have-to-meaning",
      difficulty: "medium",
    },
    {
      id: "must-have-to-should-at-work-q8",
      question: "Diego's first day on a construction site. Which sentence uses the best modal?",
      options: [
        { value: "a", label: "You should wear steel-toe boots. It's a good idea." },
        { value: "b", label: "You must wear steel-toe boots. OSHA requires it." },
        { value: "c", label: "You have to wear steel-toe boots if you feel like it." },
      ],
      correctAnswer: "b",
      explanation: "OSHA is a federal safety law. 'Must' is correct because there is no choice. 'Should' makes a safety requirement sound optional.",
      topic: "must",
      skill: "usage",
      skillTag: "must-not-should-for-safety",
      difficulty: "medium",
    },
    {
      id: "must-have-to-should-at-work-q9",
      question: "Which sentence has an error?",
      options: [
        { value: "a", label: "You must not use your phone near heavy equipment." },
        { value: "b", label: "She should to tell her supervisor before she leaves." },
        { value: "c", label: "He has to clock in before his shift starts." },
      ],
      correctAnswer: "b",
      explanation: "After 'should,' use the base verb without 'to.' The correct form is 'should tell,' not 'should to tell.'",
      topic: "should",
      skill: "error-detection",
      skillTag: "no-to-after-modal",
      difficulty: "hard",
    },
    {
      id: "must-have-to-should-at-work-q10",
      question: "Claudette tells Linh: 'You ___ ask the manager before swapping rooms. She gets upset if you don't.' Which modal fits best?",
      options: [
        { value: "a", label: "must" },
      ...
      correctAnswer: "b",
      explanation: "The manager gets upset, but this is not a written rule or safety law. 'Should' fits because it's strong advice based on experience, not a formal requirement.",
      topic: "should",
      skill: "usage",
      skillTag: "should-vs-must-judgment-call",
      difficulty: "hard",
    },
  ],
};
