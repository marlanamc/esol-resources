...
export const wellnessBasicsDailyWarmup: SpeakingActivityContent = {
  ...
  description: "Practice talking about wellness changes using 'used to' (past habits), 'be used to' (be accustomed to), and 'get used to' (become accustomed to)",

  keyPhrases: [
    { phrase: "I used to... (past habit)", example: "I used to eat junk food every day. I used to stay up late." },
    { phrase: "I'm (not) used to... (accustomed)", example: "I'm not used to exercising regularly. I'm used to drinking coffee in the morning." },
