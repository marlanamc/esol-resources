...
> = {
    ...
    "conditionals-review": () => import("@/content/grammar/conditionals-review"),
    "conditionals-second": () => import("@/content/grammar/conditionals-second"),
    "conditionals-zero-first": () => import("@/content/grammar/conditionals-zero-first"),
    "conditionals-continuum": () => import("@/content/grammar/conditionals-continuum"),
    "continuous-tenses-review": () => import("@/content/grammar/continuous-tenses-review"),
    "future-conditional": () => import("@/content/grammar/future-conditional"),
    ...
    "gerunds-prepositions": () => import("@/content/grammar/gerunds-prepositions"),
    "gerunds-infinitives-patterns": () => import("@/content/grammar/gerunds-infinitives-patterns"),
    "imperatives-declaratives": () => import("@/content/grammar/imperatives-declaratives"),
    "infinitives-vs-gerunds": () => import("@/content/grammar/infinitives-vs-gerunds"),
    ...
    "past-perfect": () => import("@/content/grammar/past-perfect"),
